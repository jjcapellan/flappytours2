...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/libs/phaser.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e() : "function" == typeof define && define.amd ? define("Phaser", [], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.Phaser = e() : t.Phaser = e();
}(window, function () {
  return function (t) {
    var e = {};
    ...
    function i(t, e, i) {
      ...
      return !i && n.value && "object" == _typeof(n.value) && (n = n.value), !(!n || !function (t) {
    ...
    function n(t, e) {
      ...
      return !!i && (i.value && "object" == _typeof(i.value) && (i = i.value), !1 === i.configurable);
    }
    ...
    function o(t) {
      ...
      var o = null;
      return t.Mixins && (o = t.Mixins, delete t.Mixins), r(e, o), s(e, t, !0, i), e;
    }

    o.extend = s, o.mixin = r, o.ignoreFinals = !1, t.exports = o;
  }, function (t, e) {
    ...
    t.exports = function (t) {
      if ("object" != _typeof(t) || t.nodeType || t === t.window) return !1;
    ...
    Object.create && (r.prototype = Object.create(null), new r().__proto__ || (s = !1)), h.prototype.eventNames = function () {
      var t,
          e,
          i = [];
      ...
      for (e in t = this._events) {
        n.call(t, e) && i.push(s ? e.slice(1) : e);
      }
      ...
      for (var n = 0, r = i.length, o = new Array(r); n < r; n++) {
        o[n] = i[n].fn;
      }
    ...
    }, h.prototype.emit = function (t, e, i, n, r, o) {
      var a = s ? s + t : t;
      ...
      if (o.fn) o.fn !== e || n && !o.once || i && o.context !== i || a(this, r);else {
        for (var h = 0, u = [], l = o.length; h < l; h++) {
          (o[h].fn !== e || n && !o[h].once || i && o[h].context !== i) && u.push(o[h]);
        }
      ...
      var e;
      return t ? (e = s ? s + t : t, this._events[e] && a(this, e)) : (this._events = new r(), this._eventsCount = 0), this;
    }, h.prototype.off = h.prototype.removeListener, h.prototype.addListener = h.prototype.on, h.prefixed = s, h.EventEmitter = h, t.exports = h;
  }, function (t, e, i) {
    var n = new (i(0))({
      initialize: function initialize(t, e) {
        this.x = 0, this.y = 0, "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0) : (void 0 === e && (e = t), this.x = t || 0, this.y = e || 0);
      },
      ...
      setToPolar: function setToPolar(t, e) {
      ...
      distanceSq: function distanceSq(t) {
        var e = t.x - this.x,
            i = t.y - this.y;
        return e * e + i * i;
      },
      ...
      transformMat3: function transformMat3(t) {
        var e = this.x,
            i = this.y,
            n = t.val;
        return this.x = n[0] * e + n[3] * i + n[6], this.y = n[1] * e + n[4] * i + n[7], this;
      },
      transformMat4: function transformMat4(t) {
        var e = this.x,
            i = this.y,
            n = t.val;
    ...
    n.ZERO = new n(), n.RIGHT = new n(1, 0), n.LEFT = new n(-1, 0), n.UP = new n(0, -1), n.DOWN = new n(0, 1), n.ONE = new n(1, 1), t.exports = n;
  }, function (t, e) {
    t.exports = {
      LOADER_IDLE: 0,
      LOADER_LOADING: 1,
    ...
    var n = i(0),
      ...
      load: function load() {
        this.state === s.FILE_POPULATED ? this.loader.nextFile(this, !0) : (this.src = a(this, this.loader.baseURL), 0 === this.src.indexOf("data:") ? console.warn("Local data URIs are not supported: " + this.key) : this.xhrLoader = u(this, this.loader.xhr));
      },
      onLoad: function onLoad(t, e) {
        ...
        4 === t.readyState && t.status >= 400 && t.status <= 599 && (n = !1), this.resetXHR(), this.loader.nextFile(this, n);
      },
      ...
      pendingDestroy: function pendingDestroy(t) {
    ...
    c.createObjectURL = function (t, e, i) {
      if ("function" == typeof URL) t.src = URL.createObjectURL(e);else {
    ...
    var i = {},
        n = {},
        s = {
      register: function register(t, e, n, s) {
        void 0 === s && (s = !1), i[t] = {
          plugin: e,
          mapping: n,
          custom: s
      ...
      registerCustom: function registerCustom(t, e, i, s) {
        n[t] = {
          plugin: e,
          mapping: i,
          data: s
      ...
      hasCore: function hasCore(t) {
        return i.hasOwnProperty(t);
      },
      hasCustom: function hasCustom(t) {
        return n.hasOwnProperty(t);
      },
      getCore: function getCore(t) {
        return i[t];
      },
      getCustom: function getCustom(t) {
        return n[t];
      },
      getCustomClass: function getCustomClass(t) {
        return n.hasOwnProperty(t) ? n[t].plugin : null;
      },
      remove: function remove(t) {
        i.hasOwnProperty(t) && delete i[t];
      },
      removeCustom: function removeCustom(t) {
    ...
    t.exports = {
      ...
      SLEEP: i(520),
      START: i(521),
      TRANSITION_COMPLETE: i(522),
      TRANSITION_INIT: i(523),
      TRANSITION_OUT: i(524),
      TRANSITION_START: i(525),
      TRANSITION_WAKE: i(526),
      UPDATE: i(527),
      WAKE: i(528)
    };
  }, function (t, e, i) {
    var n = i(2),
      ...
      for ("boolean" == typeof h && (c = h, h = arguments[1] || {}, u = 2), l === u && (h = this, --u); u < l; u++) {
        if (null != (t = arguments[u])) for (e in t) {
          i = h[e], h !== (r = t[e]) && (c && r && (n(r) || (o = Array.isArray(r))) ? (o ? (o = !1, a = i && Array.isArray(i) ? i : []) : a = i && n(i) ? i : {}, h[e] = s(c, a, r)) : void 0 !== r && (h[e] = r));
        }
      }
    ...
    var n,
        ...
        u = !1;
    t.exports = {
      create2D: function create2D(t, e, i) {
        return n(t, e, i, o.CANVAS);
      },
      create: n = function n(t, e, i, _n, r) {
        var l;
        void 0 === e && (e = 1), void 0 === i && (i = 1), void 0 === _n && (_n = o.CANVAS), void 0 === r && (r = !1);
        var c = s(_n);
        return null === c ? (c = {
          parent: t,
          canvas: document.createElement("canvas"),
          type: _n
        }, _n === o.CANVAS && h.push(c), l = c.canvas) : (c.parent = t, l = c.canvas), r && (c.parent = l), l.width = e, l.height = i, u && _n === o.CANVAS && a.disable(l.getContext("2d")), l;
      },
      createWebGL: function createWebGL(t, e, i) {
        return n(t, e, i, o.WEBGL);
      },
      ...
      first: s = function s(t) {
        if (void 0 === t && (t = o.CANVAS), t === o.WEBGL) return null;
    ...
    var n = i(0),
      ...
      setTo: function setTo(t, e, i, n, s) {
      ...
      setFromHSV: function setFromHSV(t, e, i) {
        return o(t, e, i, this);
      },
      ...
      randomGray: function randomGray(t, e) {
        void 0 === t && (t = 0), void 0 === e && (e = 255);
        var i = Math.floor(t + Math.random() * (e - t));
      ...
      brighten: function brighten(t) {
        var e = this.r,
            i = this.g,
            n = this.b;
        return e = Math.max(0, Math.min(255, e - Math.round(-t / 100 * 255))), i = Math.max(0, Math.min(255, i - Math.round(-t / 100 * 255))), n = Math.max(0, Math.min(255, n - Math.round(-t / 100 * 255))), this.setTo(e, i, n);
      },
      color: {
        get: function get() {
          return this._color;
    ...
    var n = i(0),
        ...
        r = i(7),
        o = new n({
      initialize: function initialize(t, e, i, n, s, r) {
      ...
      rotationNormalized: {
        get: function get() {
          var t = this.matrix,
              ...
              n = t[2],
              r = t[3];
          return e || i ? i > 0 ? Math.acos(e / this.scaleX) : -Math.acos(e / this.scaleX) : n || r ? s.TAU - (r > 0 ? Math.acos(-n / this.scaleY) : -Math.acos(n / this.scaleY)) : 0;
        }
      },
      scaleX: {
        get: function get() {
      ...
      multiplyWithOffset: function multiplyWithOffset(t, e, i) {
        var n = this.matrix,
            s = t.matrix,
            r = n[0],
            o = n[1],
      ...
      transform: function transform(t, e, i, n, s, r) {
        var o = this.matrix,
            a = o[0],
            h = o[1],
            u = o[2],
      ...
      decomposeMatrix: function decomposeMatrix() {
        ...
        if (t.translateX = e[4], t.translateY = e[5], i || n) {
          ...
          t.rotation = n > 0 ? Math.acos(i / a) : -Math.acos(i / a), t.scaleX = a, t.scaleY = o / a;
        } else if (s || r) {
          var h = Math.sqrt(s * s + r * r);
          t.rotation = .5 * Math.PI - (r > 0 ? Math.acos(-s / h) : -Math.acos(s / h)), t.scaleX = o / h, t.scaleY = h;
        } else t.rotation = 0, t.scaleX = 0, t.scaleY = 0;

        return t;
      },
      applyITRS: function applyITRS(t, e, i, n, s) {
        var r = this.matrix,
            o = Math.sin(i),
            a = Math.cos(i);
        return r[4] = t, r[5] = e, r[0] = a * n, r[1] = o * n, r[2] = -o * s, r[3] = a * s, this;
      },
      applyInverse: function applyInverse(t, e, i) {
        void 0 === i && (i = new r());
        var n = this.matrix,
            s = n[0],
            o = n[1],
      ...
      getX: function getX(t, e) {
        return t * this.a + e * this.c + this.e;
      },
      getY: function getY(t, e) {
    ...
    t.exports = {
      DESTROY: i(450),
      FADE_IN_COMPLETE: i(451),
      FADE_IN_START: i(452),
      FADE_OUT_COMPLETE: i(453),
      FADE_OUT_START: i(454),
      FLASH_COMPLETE: i(455),
      FLASH_START: i(456),
      PAN_COMPLETE: i(457),
      PAN_START: i(458),
      POST_RENDER: i(459),
      PRE_RENDER: i(460),
      SHAKE_COMPLETE: i(461),
      SHAKE_START: i(462),
      ZOOM_COMPLETE: i(463),
      ZOOM_START: i(464)
    };
    ...
    var n = i(0),
      ...
      getPoints: function getPoints(t, e, i) {
        return o(this, t, e, i);
      },
      getRandomPoint: function getRandomPoint(t) {
        return u(this, t);
      },
    ...
    t.exports = {
      ...
      GAME_OUT: i(646),
      GAME_OVER: i(647),
      GAMEOBJECT_DOWN: i(648),
      GAMEOBJECT_DRAG_END: i(649),
      GAMEOBJECT_DRAG_ENTER: i(650),
      GAMEOBJECT_DRAG: i(651),
      GAMEOBJECT_DRAG_LEAVE: i(652),
      GAMEOBJECT_DRAG_OVER: i(653),
      GAMEOBJECT_DRAG_START: i(654),
      GAMEOBJECT_DROP: i(655),
      GAMEOBJECT_MOVE: i(656),
      GAMEOBJECT_OUT: i(657),
      GAMEOBJECT_OVER: i(658),
      GAMEOBJECT_POINTER_DOWN: i(659),
      GAMEOBJECT_POINTER_MOVE: i(660),
      GAMEOBJECT_POINTER_OUT: i(661),
      GAMEOBJECT_POINTER_OVER: i(662),
      GAMEOBJECT_POINTER_UP: i(663),
      GAMEOBJECT_POINTER_WHEEL: i(664),
      GAMEOBJECT_UP: i(665),
      GAMEOBJECT_WHEEL: i(666),
      MANAGER_BOOT: i(667),
      MANAGER_PROCESS: i(668),
      MANAGER_UPDATE: i(669),
      POINTER_DOWN: i(670),
      POINTER_DOWN_OUTSIDE: i(671),
      POINTER_MOVE: i(672),
      POINTER_OUT: i(673),
      POINTER_OVER: i(674),
      POINTER_UP: i(675),
      POINTER_UP_OUTSIDE: i(676),
      POINTER_WHEEL: i(677),
      POINTERLOCK_CHANGE: i(678),
      PRE_UPDATE: i(679),
      SHUTDOWN: i(680),
      START: i(681),
      UPDATE: i(682)
    ...
    var n = i(0),
        ...
        l = new n({
      Extends: r,
      initialize: function initialize(t, e, i, n, o) {
        var l = "json";

        if (u(e)) {
          var c = e;
          e = a(c, "key"), i = a(c, "url"), n = a(c, "xhrSettings"), l = a(c, "extension", l), o = a(c, "dataKey", o);
        }
      ...
      onProcess: function onProcess() {
        if (this.state !== s.FILE_POPULATED) {
    ...
    var n = new (i(0))({
      ...
      addToMultiFile: function addToMultiFile(t) {
        return this.files.push(t), t.multiFile = this, this.pending++, this.complete = !1, this;
      },
      onFileComplete: function onFileComplete(t) {
        -1 !== this.files.indexOf(t) && this.pending--;
      },
      onFileFailed: function onFileFailed(t) {
    ...
    var n = i(0),
      ...
      setInteractive: function setInteractive(t, e, i) {
      ...
      willRender: function willRender(t) {
        return !(h.RENDER_MASK !== this.renderFlags || 0 !== this.cameraFilter && this.cameraFilter & t.id);
      },
      getIndexList: function getIndexList() {
        for (var t = this, e = this.parentContainer, i = []; e && (i.unshift(e.getIndex(t)), t = e, e.parentContainer);) {
          e = e.parentContainer;
        }
    ...
    var n = i(0),
      ...
      initialize: function t(e, i, n, s, o) {
        ...
        if (h(i)) {
          var c = i;
          i = a(c, "key"), n = a(c, "url"), u = a(c, "normalMap"), s = a(c, "xhrSettings"), l = a(c, "extension", l), o = a(c, "frameConfig");
        }

        Array.isArray(n) && (u = n[1], n = n[0]);
        var d = {
          type: "image",
        ...
        if (r.call(this, e, d), u) {
          var f = new t(e, this.key, u, s, o);
    ...
    t.exports = {
      getTintFromFloats: function getTintFromFloats(t, e, i, n) {
        return ((255 & (255 * n | 0)) << 24 | (255 & (255 * t | 0)) << 16 | (255 & (255 * e | 0)) << 8 | 255 & (255 * i | 0)) >>> 0;
      },
      getTintAppendFloatAlpha: function getTintAppendFloatAlpha(t, e) {
        return ((255 & (255 * e | 0)) << 24 | t) >>> 0;
      },
      getTintAppendFloatAlphaAndSwap: function getTintAppendFloatAlphaAndSwap(t, e) {
        return ((255 & (255 * e | 0)) << 24 | (255 & (0 | t)) << 16 | (255 & (t >> 8 | 0)) << 8 | 255 & (t >> 16 | 0)) >>> 0;
      },
      getFloatsFromUintRGB: function getFloatsFromUintRGB(t) {
        return [(255 & (t >> 16 | 0)) / 255, (255 & (t >> 8 | 0)) / 255, (255 & (0 | t)) / 255];
      },
      getComponentCount: function getComponentCount(t, e) {
    ...
    t.exports = {
      ...
      COMPLETE: i(687),
      FILE_COMPLETE: i(688),
      FILE_KEY_COMPLETE: i(689),
      FILE_LOAD_ERROR: i(690),
      FILE_LOAD: i(691),
      FILE_PROGRESS: i(692),
      POST_PROCESS: i(693),
      PROGRESS: i(694),
    ...
    t.exports = {
      ENTER_FULLSCREEN: i(504),
      FULLSCREEN_FAILED: i(505),
      FULLSCREEN_UNSUPPORTED: i(506),
      LEAVE_FULLSCREEN: i(507),
      ORIENTATION_CHANGE: i(508),
      RESIZE: i(509)
    };
  }, function (t, e) {
    t.exports = function (t, e) {
    ...
    t.exports = function (t, e, i) {
      ...
      var h = s(i, "origin", null);
      if ("number" == typeof h) e.setOrigin(h);else if (null !== h) {
        var u = s(h, "x", .5),
            l = s(h, "y", .5);
        e.setOrigin(u, l);
      }
      return e.blendMode = s(i, "blendMode", n.NORMAL), e.visible = s(i, "visible", !0), s(i, "add", !0) && t.sys.displayList.add(e), e.preUpdate && t.sys.updateList.add(e), e;
    };
  }, function (t, e, i) {
    var n = i(0),
        s = i(33),
    ...
    t.exports = {
      ADD_ANIMATION: i(331),
      ANIMATION_COMPLETE: i(332),
      ANIMATION_REPEAT: i(333),
      ANIMATION_RESTART: i(334),
      ANIMATION_START: i(335),
      PAUSE_ALL: i(336),
      REMOVE_ANIMATION: i(337),
      RESUME_ALL: i(338),
      SPRITE_ANIMATION_COMPLETE: i(339),
      SPRITE_ANIMATION_KEY_COMPLETE: i(340),
      SPRITE_ANIMATION_KEY_REPEAT: i(341),
      SPRITE_ANIMATION_KEY_RESTART: i(342),
      SPRITE_ANIMATION_KEY_START: i(343),
      SPRITE_ANIMATION_KEY_UPDATE: i(344),
      SPRITE_ANIMATION_REPEAT: i(345),
      SPRITE_ANIMATION_RESTART: i(346),
      SPRITE_ANIMATION_START: i(347),
      SPRITE_ANIMATION_UPDATE: i(348)
    };
  }, function (t, e, i) {
    var n = i(18);
    ...
    var n = i(0),
      ...
      setValue: function setValue(t, e) {
        if (this._frozen) return this;
        if (this.has(t)) this.values[t] = e;else {
          var i = this,
              n = this.list,
              r = this.events,
              o = this.parent;
          Object.defineProperty(this.values, t, {
            ...
            set: function set(e) {
              if (!i._frozen) {
                var a = n[t];
                n[t] = e, r.emit(s.CHANGE_DATA, o, t, e, a), r.emit(s.CHANGE_DATA_KEY + t, o, e, a);
              }
            }
      ...
      removeValue: function removeValue(t) {
        if (this.has(t)) {
          var e = this.list[t];
          delete this.list[t], delete this.values[t], this.events.emit(s.REMOVE_DATA, this.parent, t, e);
        }
      ...
      setFreeze: function setFreeze(t) {
    ...
    var n = i(0),
      ...
      centerToBounds: function centerToBounds() {
        if (this.useBounds) {
          var t = this._bounds,
              e = .5 * this.width,
              i = .5 * this.height;
          this.midPoint.set(t.centerX, t.centerY), this.scrollX = t.centerX - e, this.scrollY = t.centerY - i;
        }
      ...
      cull: function cull(t) {
        ...
        for (var g = 0; g < p; ++g) {
          ...
          if (v.hasOwnProperty("width") && !v.parentContainer) {
            var m = v.width,
                y = v.height,
                x = v.x - u * v.scrollFactorX - m * v.originX,
                T = v.y - l * v.scrollFactorY - y * v.originY,
                w = x * i + T * s + a,
                E = x * n + T * r + h,
                S = (x + m) * i + (T + y) * s + a,
                _ = (x + m) * n + (T + y) * r + h,
            ...
            S > O && w < O + c && _ > A && E < b && f.push(v);
          } else f.push(v);
        }

        return f;
      },
      getWorldPoint: function getWorldPoint(t, e, i) {
        void 0 === i && (i = new c());
        ...
        return i.x = (_ * d + A * p) * w + v, i.y = (_ * f + A * g) * w + m, i;
      },
      ...
      preRender: function preRender(t) {
        var e = this.width,
            ...
            u = this.scrollX,
            l = this.scrollY;
        this.useBounds && (u = this.clampX(u), l = this.clampY(l)), this.roundPixels && (a = Math.round(a), h = Math.round(h)), this.scrollX = u, this.scrollY = l;
        var c = u + n,
            d = l + s;
      ...
      clampX: function clampX(t) {
        var e = this._bounds,
            i = this.displayWidth,
            n = e.x + (i - this.width) / 2,
            s = Math.max(n, n + e.width - i);
        return t < n ? t = n : t > s && (t = s), t;
      },
      clampY: function clampY(t) {
        var e = this._bounds,
      ...
      setBounds: function setBounds(t, e, i, n, s) {
      ...
      setRoundPixels: function setRoundPixels(t) {
        return this.roundPixels = t, this;
      },
      setScene: function setScene(t) {
        this.scene && this._customViewport && this.sceneManager.customViewports--, this.scene = t;
        var e = t.sys;
      ...
      updateSystem: function updateSystem() {
        if (this.scaleManager) {
          var t = 0 !== this._x || 0 !== this._y || this.scaleManager.width !== this._width || this.scaleManager.height !== this._height,
              e = this.sceneManager;
          t && !this._customViewport ? e.customViewports++ : !t && this._customViewport && e.customViewports--, this.dirty = !0, this._customViewport = t;
        }
      },
      destroy: function destroy() {
    ...
    (function (e) {
      ...
      t.exports = function () {
        ...
        var n = /Silk/.test(t);
        return (i.windows || i.macOS || i.linux && !n || i.chromeOS) && (i.desktop = !0), (i.windowsPhone || /Windows NT/i.test(t) && /Touch/i.test(t)) && (i.desktop = !1), navigator.standalone && (i.webApp = !0), void 0 !== window.cordova && (i.cordova = !0), void 0 !== e && e.versions && e.versions.node && (i.node = !0), i.node && "object" == _typeof(e.versions) && (i.nodeWebkit = !!e.versions["node-webkit"], i.electron = !!e.versions.electron), void 0 !== window.ejecta && (i.ejecta = !0), /Crosswalk/.test(t) && (i.crosswalk = !0), i.pixelRatio = window.devicePixelRatio || 1, i;
      }();
    }).call(this, i(530));
  }, function (t, e, i) {
    var n,
    ...
    var n = i(0),
        ...
        r = i(16),
        o = new n({
      initialize: function initialize(t, e, i, n, s, r, o) {
      ...
      setSize: function setSize(t, e, i, n) {
      ...
      setTrim: function setTrim(t, e, i, n, s, r) {
        var o = this.data,
      ...
      setCropUVs: function setCropUVs(t, e, i, n, r, o, a) {
        var h = this.cutX,
            u = this.cutY,
            l = this.cutWidth,
            c = this.cutHeight,
        ...
        if (y.trim) {
          var x = y.spriteSourceSize,
              T = e + (n = s(n, 0, l - e)),
              w = i + (r = s(r, 0, c - i));

          if (!(x.r < e || x.b < i || x.x > T || x.y > w)) {
            var E = Math.max(x.x, e),
                S = Math.max(x.y, i),
                _ = Math.min(x.r, T) - E,
                A = Math.min(x.b, w) - S;

            v = _, m = A, p = o ? h + (l - (E - x.x) - _) : h + (E - x.x), g = a ? u + (c - (S - x.y) - A) : u + (S - x.y), e = E, i = S, n = _, r = A;
          } else p = 0, g = 0, v = 0, m = 0;
        } else o && (p = h + (l - e - n)), a && (g = u + (c - i - r));

        var b = this.source.width,
            O = this.source.height;
        return t.u0 = Math.max(0, p / b), t.v0 = Math.max(0, g / O), t.u1 = Math.min(1, (p + v) / b), t.v1 = Math.min(1, (g + m) / O), t.x = e, t.y = i, t.cx = p, t.cy = g, t.cw = v, t.ch = m, t.width = n, t.height = r, t.flipX = o, t.flipY = a, t;
      },
      updateCropUVs: function updateCropUVs(t, e, i) {
    ...
    var n = i(0),
      ...
      Extends: r,
      initialize: function initialize(t) {
        r.call(this), this.game = t, this.jsonCache = t.cache.json, this.sounds = [], this.mute = !1, this.volume = 1, this.pauseOnBlur = !0, this._rate = 1, this._detune = 0, this.locked = this.locked || !1, this.unlocked = !1, t.events.on(a.BLUR, function () {
          this.pauseOnBlur && this.onBlur();
        }, this), t.events.on(a.FOCUS, function () {
          this.pauseOnBlur && this.onFocus();
        }, this), t.events.on(a.PRE_STEP, this.update, this), t.events.once(a.DESTROY, this.destroy, this);
      },
      add: h,
      addAudioSprite: function addAudioSprite(t, e) {
        void 0 === e && (e = {});
        var i = this.add(t, e);

        for (var n in i.spritemap = this.jsonCache.get(t).spritemap, i.spritemap) {
          if (i.spritemap.hasOwnProperty(n)) {
            var r = s(e),
                o = i.spritemap[n];
            r.loop = !!o.hasOwnProperty("loop") && o.loop, i.addMarker({
              name: n,
              start: o.start,
      ...
      playAudioSprite: function playAudioSprite(t, e, i) {
      ...
      removeByKey: function removeByKey(t) {
        for (var e = 0, i = this.sounds.length - 1; i >= 0; i--) {
          var n = this.sounds[i];
      ...
      destroy: function destroy() {
        this.removeAllListeners(), this.forEachActiveSound(function (t) {
          t.destroy();
        }), this.sounds.length = 0, this.sounds = null, this.game = null;
      },
      forEachActiveSound: function forEachActiveSound(t, e) {
        var i = this;
    ...
    var n = i(0),
      ...
      updateMarker: function updateMarker(t) {
      ...
      removeMarker: function removeMarker(t) {
        var e = this.markers[t];
        return e ? (this.markers[t] = null, e) : null;
      },
      play: function play(t, e) {
        if (void 0 === t && (t = ""), "object" == _typeof(t) && (e = t, t = ""), "string" != typeof t) return !1;
        ...
        return this.resetConfig(), this.currentConfig = o(this.currentConfig, e), this.isPlaying = !0, this.isPaused = !1, !0;
      },
      pause: function pause() {
        return !(this.isPaused || !this.isPlaying) && (this.isPlaying = !1, this.isPaused = !0, !0);
      },
      resume: function resume() {
        return !(!this.isPaused || this.isPlaying) && (this.isPlaying = !0, this.isPaused = !1, !0);
      },
      stop: function stop() {
    ...
    t.exports = function (t, e) {
      ...
      if ("string" != typeof e && (e = (e % 360 + 360) % 360), 90 === e || -270 === e || "rotateLeft" === e) (t = s(t)).reverse();else if (-90 === e || 270 === e || "rotateRight" === e) t.reverse(), t = s(t);else if (180 === Math.abs(e) || "rotate180" === e) {
        for (var i = 0; i < t.length; i++) {
          t[i].reverse();
        }
    ...
    var n = i(0),
      ...
      Extends: r,
      Mixins: [s.Alpha, s.BlendMode, s.Depth, s.Flip, s.GetBounds, s.Mask, s.Origin, s.Pipeline, s.ScrollFactor, s.Size, s.TextureCrop, s.Tint, s.Transform, s.Visible, o],
      initialize: function initialize(t, e, i, n, s) {
    ...
    var n = i(4),
        s = {},
        r = {
      register: function register(t, e, i, n, r) {
        s[t] = {
          plugin: e,
          mapping: i,
          settingsKey: n,
    ...
    var n = new (i(0))({
      ...
      delete: function _delete(t) {
        ...
        return e > -1 && this.entries.splice(e, 1), this;
      },
      dump: function dump() {
        console.group("Set");
      ...
      iterateLocal: function iterateLocal(t) {
        var e,
            i = [];
    ...
    var n = i(10),
      ...
      addFrame: function addFrame(t) {
        return this.addFrameAt(this.frames.length, t);
      },
      addFrameAt: function addFrameAt(t, e) {
        var i = this.getFrames(this.manager.textureManager, e);

        if (i.length > 0) {
          if (0 === t) this.frames = i.concat(this.frames);else if (t === this.frames.length) this.frames = this.frames.concat(i);else {
            var n = this.frames.slice(0, t),
                s = this.frames.slice(t);
            this.frames = n.concat(i, s);
          }
      ...
      checkFrame: function checkFrame(t) {
        return t >= 0 && t < this.frames.length;
      },
      completeAnimation: function completeAnimation(t) {
        this.hideOnComplete && (t.parent.visible = !1), t.stop();
      },
      getFirstTick: function getFirstTick(t, e) {
        void 0 === e && (e = !0), t.accumulator = 0, t.nextTick = t.msPerFrame + t.currentFrame.duration, e && (t.nextTick += t._delay);
      },
      getFrameAt: function getFrameAt(t) {
        return this.frames[t];
      },
      getFrames: function getFrames(t, e, i) {
        var n,
            s,
            r,
            o,
        ...
        if ("string" == typeof e) {
          o = e;
          var c = t.get(o).getFrameNames();
          e = [], c.forEach(function (t, i) {
            e.push({
              key: o,
              frame: i
            });
        ...
        for (r = 0; r < e.length; r++) {
          ...
          if (f) {
            var p = u(d, "frame", 0),
                g = t.getFrame(f, p);
            (s = new h(f, p, l, g)).duration = u(d, "duration", 0), s.isFirst = !n, n && (n.nextFrame = s, s.prevFrame = n), a.push(s), n = s, l++;
          }
        }

        if (a.length > 0) {
          s.isLast = !0, s.nextFrame = a[0], a[0].prevFrame = s;
          var v = 1 / (a.length - 1);
      ...
      getNextTick: function getNextTick(t) {
      ...
      getFrameByProgress: function getFrameByProgress(t) {
        return t = n(t, 0, 1), a(t, this.frames, "progress");
      },
      nextFrame: function nextFrame(t) {
      ...
      handleYoyoFrame: function handleYoyoFrame(t, e) {
        if (e || (e = !1), t._reverse === !e && t.repeatCounter > 0) return t.forward = e, void this.repeatAnimation(t);

        if (t._reverse === e || 0 !== t.repeatCounter) {
          t.forward = e;
          var i = e ? t.currentFrame.nextFrame : t.currentFrame.prevFrame;
          this.updateAndGetNextTick(t, i);
        } else this.completeAnimation(t);
      },
      getLastFrame: function getLastFrame() {
        return this.frames[this.frames.length - 1];
      },
      previousFrame: function previousFrame(t) {
        var e = t.currentFrame;
        e.isFirst ? t._yoyo ? this.handleYoyoFrame(t, !0) : t.repeatCounter > 0 ? t._reverse && !t.forward ? (t.currentFrame = this.getLastFrame(), this.repeatAnimation(t)) : (t.forward = !0, this.repeatAnimation(t)) : this.completeAnimation(t) : this.updateAndGetNextTick(t, e.prevFrame);
      },
      updateAndGetNextTick: function updateAndGetNextTick(t, e) {
        t.updateFrame(e), this.getNextTick(t);
      },
      removeFrame: function removeFrame(t) {
        var e = this.frames.indexOf(t);
        return -1 !== e && this.removeFrameAt(e), this;
      },
      removeFrameAt: function removeFrameAt(t) {
        return this.frames.splice(t, 1), this.updateFrameSequence(), this;
      },
      repeatAnimation: function repeatAnimation(t) {
        if (2 === t._pendingStop) return this.completeAnimation(t);
        if (t._repeatDelay > 0 && !1 === t.pendingRepeat) t.pendingRepeat = !0, t.accumulator -= t.nextTick, t.nextTick += t._repeatDelay;else if (t.repeatCounter--, t.updateFrame(t.currentFrame[t.forward ? "nextFrame" : "prevFrame"]), t.isPlaying) {
          this.getNextTick(t), t.pendingRepeat = !1;
          var e = t.currentFrame,
              i = t.parent;
          this.emit(o.ANIMATION_REPEAT, this, e), i.emit(o.SPRITE_ANIMATION_KEY_REPEAT + this.key, this, e, t.repeatCounter, i), i.emit(o.SPRITE_ANIMATION_REPEAT, this, e, t.repeatCounter, i);
        }
      },
    ...
    var n = new (i(0))({
      ...
      dump: function dump() {
        ...
        for (var e in console.group("Map"), t) {
          console.log(e, t[e]);
        }
    ...
    var n = i(18),
      ...
      Rotate: i(581),
      RotateAround: i(165),
      RotateAroundDistance: i(91),
      RoundAwayFromZero: i(223),
      RoundTo: i(582),
      SinCosTableGenerator: i(583),
      SmootherStep: i(93),
      SmoothStep: i(94),
      ToXY: i(584),
      TransformXY: i(224),
    ...
    var n = new (i(0))({
      initialize: function initialize(t, e, i) {
        this.x = 0, this.y = 0, this.z = 0, "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0, this.z = t.z || 0) : (this.x = t || 0, this.y = e || 0, this.z = i || 0);
      },
      up: function up() {
      ...
      set: function set(t, e, i) {
        return "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0, this.z = t.z || 0) : (this.x = t || 0, this.y = e || 0, this.z = i || 0), this;
      },
      add: function add(t) {
        return this.x += t.x, this.y += t.y, this.z += t.z || 0, this;
      },
      ...
      transformCoordinates: function transformCoordinates(t) {
        var e = this.x,
            i = this.y,
            n = this.z,
            s = t.val,
      ...
      transformQuat: function transformQuat(t) {
        var e = this.x,
            i = this.y,
            n = this.z,
            s = t.x,
    ...
    var n = i(0),
      ...
      boot: function boot() {},
      addAttribute: function addAttribute(t, e, i, n, r) {
      ...
      bind: function bind() {
        ...
        for (var o = 0; o < i.length; ++o) {
          ...
          h >= 0 ? (t.enableVertexAttribArray(h), t.vertexAttribPointer(h, a.size, a.type, a.normalized, r, a.offset)) : -1 !== h && t.disableVertexAttribArray(h);
        }
      ...
      setFloat1: function setFloat1(t, e) {
    ...
    t.exports = function (t, e) {
      var i;
      if (e) "string" == typeof e ? i = document.getElementById(e) : "object" == _typeof(e) && 1 === e.nodeType && (i = e);else if (t.parentElement) return t;
      return i || (i = document.body), i.appendChild(t), t;
    };
  }, function (t, e) {
    t.exports = {
      MOUSE_DOWN: 0,
    ...
    t.exports = function (t, e, i, s) {
      var r;
      if (void 0 === s && (s = t), !Array.isArray(e)) return -1 !== (r = t.indexOf(e)) ? (n(t, r), i && i.call(s, e), e) : null;

      for (var o = e.length - 1; o >= 0;) {
        var a = e[o];
        -1 !== (r = t.indexOf(a)) ? (n(t, r), i && i.call(s, a)) : e.pop(), o--;
      }
    ...
    var n = i(0),
      ...
      init: function init(t) {
        ...
        var e = t.plugins;
        this.plugins = e, e.addToScene(this, r.Global, [r.CoreScene, h(this), a(this)]), this.events.emit(o.BOOT, this), this.settings.isBooted = !0;
      },
      install: function install(t) {
      ...
      isTransitionOut: function isTransitionOut() {
        return null !== this.scenePlugin._target && this.scenePlugin._duration > 0;
      },
      ...
      setActive: function setActive(t, e) {
      ...
      destroy: function destroy() {
        ...
        for (var t = ["scene", "game", "anims", "cache", "plugins", "registry", "sound", "textures", "add", "camera", "displayList", "events", "make", "scenePlugin", "updateList"], e = 0; e < t.length; e++) {
          this[t[e]] = null;
        }
      }
    });
    ...
    var n = i(0),
        ...
        o = new n({
      initialize: function initialize(t, e, i, n, s) {
        Array.isArray(i) || (i = [i]), this.manager = t, this.key = e, this.source = [], this.dataSource = [], this.frames = {}, this.customData = {}, this.firstFrame = "__BASE", this.frameTotal = 0;

        for (var o = 0; o < i.length; o++) {
          this.source.push(new r(this, i[o], n, s));
        }
      },
      add: function add(t, e, i, n, r, o) {
      ...
      get: function get(t) {
        t || (t = this.firstFrame);
        var e = this.frames[t];
        return e || (console.warn("Texture.frame missing: " + t), e = this.frames[this.firstFrame]), e;
      },
      getTextureSourceIndex: function getTextureSourceIndex(t) {
      ...
      getFramesFromTextureSource: function getFramesFromTextureSource(t, e) {
        void 0 === e && (e = !1);
        var i = [];
      ...
      getFrameNames: function getFrameNames(t) {
        void 0 === t && (t = !1);
        var e = Object.keys(this.frames);

        if (!t) {
          var i = e.indexOf("__BASE");
          -1 !== i && e.splice(i, 1);
        }
      ...
      getSourceImage: function getSourceImage(t) {
        void 0 !== t && null !== t && 1 !== this.frameTotal || (t = "__BASE");
        var e = this.frames[t];
        return e ? e.source.image : (console.warn("Texture.frame missing: " + t), this.frames.__BASE.source.image);
      },
      getDataSourceImage: function getDataSourceImage(t) {
        void 0 !== t && null !== t && 1 !== this.frameTotal || (t = "__BASE");
        var e,
            i = this.frames[t];
        return i ? e = i.sourceIndex : (console.warn("Texture.frame missing: " + t), e = this.frames.__BASE.sourceIndex), this.dataSource[e].image;
      },
      ...
      setFilter: function setFilter(t) {
        ...
        for (e = 0; e < this.source.length; e++) {
      ...
      destroy: function destroy() {
        ...
        for (t = 0; t < this.source.length; t++) {
    ...
    var n = i(270),
      ...
      sort: function sort(t, e) {
        return t ? (void 0 === e && (e = function e(_e, i) {
          return _e[t] - i[t];
        }), o.inplace(this.list, e), this) : this;
      },
      ...
      getFirst: function getFirst(t, e, i, s) {
        return n.GetFirst(this.list, t, e, i, s);
      },
      getAll: function getAll(t, e, i, s) {
      ...
      setAll: function setAll(t, e, i, s) {
    ...
    !function () {
      var e = function e(t, _e2) {
        return i(t.slice(), _e2);
      };

      function i(t, e) {
        "function" != typeof e && (e = function e(t, _e3) {
          return String(t).localeCompare(_e3);
        });
        var i = t.length;
        if (i <= 1) return t;
      ...
      var n = function n(t, e, i, _n2) {
        ...
        for (s = 0; s < u; s += c) {
          for (o = (r = s + i) + i, r > u && (r = u), o > u && (o = u), a = s, h = r;;) {
            if (a < r && h < o) e(t[a], t[h]) <= 0 ? _n2[l++] = t[a++] : _n2[l++] = t[h++];else if (a < r) _n2[l++] = t[a++];else {
              if (!(h < o)) break;
              _n2[l++] = t[h++];
            }
          }
    ...
    var n = i(0),
      ...
      update: function update() {
        ...
        for (t = 0; t < i.length; t++) {
          e = i[t];
          var s = n.indexOf(e);
          -1 !== s && (n.splice(s, 1), this.emit(r.REMOVE, e));
        }

        for (i.length = 0, i = this._pending, t = 0; t < i.length; t++) {
          e = i[t], this._active.push(e), this.emit(r.ADD, e);
        }
    ...
    var n = i(67),
      ...
      fillGradientStyle: function fillGradientStyle(t, e, i, n, s) {
        return void 0 === s && (s = 1), this.commandBuffer.push(r.GRADIENT_FILL_STYLE, s, t, e, i, n), this;
      },
      lineGradientStyle: function lineGradientStyle(t, e, i, n, s, o) {
        return void 0 === o && (o = 1), this.commandBuffer.push(r.GRADIENT_LINE_STYLE, t, o, e, i, n, s), this;
      },
      setTexture: function setTexture(t, e, i) {
        if (void 0 === i && (i = 0), void 0 === t) this.commandBuffer.push(r.CLEAR_TEXTURE);else {
          var n = this.scene.sys.textures.getFrame(t, e);
          n && (2 === i && (i = 3), this.commandBuffer.push(r.SET_TEXTURE, n, i));
        }
        return this;
      },
      ...
      fillRoundedRect: function fillRoundedRect(t, e, i, n, s) {
        void 0 === s && (s = 20);
        var r = s,
            o = s,
            a = s,
      ...
      strokeRoundedRect: function strokeRoundedRect(t, e, i, n, s) {
        void 0 === s && (s = 20);
        var r = s,
            o = s,
            a = s,
      ...
      fillTriangle: function fillTriangle(t, e, i, n, s, o) {
        return this.commandBuffer.push(r.FILL_TRIANGLE, t, e, i, n, s, o), this;
      },
      strokeTriangle: function strokeTriangle(t, e, i, n, s, o) {
      ...
      strokePoints: function strokePoints(t, e, i, n) {
      ...
      fillPoints: function fillPoints(t, e, i, n) {
        void 0 === e && (e = !1), void 0 === i && (i = !1), void 0 === n && (n = t.length), this.beginPath(), this.moveTo(t[0].x, t[0].y);
      ...
      strokeEllipseShape: function strokeEllipseShape(t, e) {
        void 0 === e && (e = 32);
        var i = t.getPoints(e);
        return this.strokePoints(i, !0);
      },
      strokeEllipse: function strokeEllipse(t, e, i, n, s) {
        void 0 === s && (s = 32);
        var r = new g(t, e, i, n).getPoints(s);
        return this.strokePoints(r, !0);
      },
      fillEllipseShape: function fillEllipseShape(t, e) {
        void 0 === e && (e = 32);
        var i = t.getPoints(e);
        return this.fillPoints(i, !0);
      },
      fillEllipse: function fillEllipse(t, e, i, n, s) {
        void 0 === s && (s = 32);
        var r = new g(t, e, i, n).getPoints(s);
        return this.fillPoints(r, !0);
      },
      arc: function arc(t, e, i, n, s, o, a) {
        return void 0 === o && (o = !1), void 0 === a && (a = 0), this.commandBuffer.push(r.ARC, t, e, i, n, s, o, a), this;
      },
      slice: function slice(t, e, i, n, s, o, a) {
      ...
      translateCanvas: function translateCanvas(t, e) {
        return this.commandBuffer.push(r.TRANSLATE, t, e), this;
      },
      scaleCanvas: function scaleCanvas(t, e) {
        return this.commandBuffer.push(r.SCALE, t, e), this;
      },
      rotateCanvas: function rotateCanvas(t) {
      ...
      generateTexture: function generateTexture(t, e, i) {
        var n,
            ...
            r = this.scene.sys,
            o = r.game.renderer;
        if (void 0 === e && (e = r.scale.width), void 0 === i && (i = r.scale.height), w.TargetCamera.setScene(this.scene), w.TargetCamera.setViewport(0, 0, e, i), w.TargetCamera.scrollX = this.x, w.TargetCamera.scrollY = this.y, "string" == typeof t) {
          if (r.textures.exists(t)) {
            var a = (n = r.textures.get(t)).getSourceImage();
            a instanceof HTMLCanvasElement && (s = a.getContext("2d"));
          } else s = (n = r.textures.createCanvas(t, e, i)).getSourceImage().getContext("2d");
        } else t instanceof HTMLCanvasElement && (s = t.getContext("2d"));
        return s && (this.renderCanvas(o, this, 0, w.TargetCamera, null, s, !1), n && n.refresh()), this;
      },
      preDestroy: function preDestroy() {
        this.commandBuffer = [];
      }
    ...
    var n = i(106),
      ...
      initialize: function initialize(t, e, i, n, r) {
      ...
      runWordWrap: function runWordWrap(t) {
        var e = this.style;
      ...
      advancedWordWrap: function advancedWordWrap(t, e, i) {
      ...
      basicWordWrap: function basicWordWrap(t, e, i) {
      ...
      getWrappedText: function getWrappedText(t) {
      ...
      setShadow: function setShadow(t, e, i, n, s, r) {
      ...
      setWordWrapWidth: function setWordWrapWidth(t, e) {
        return this.style.setWordWrapWidth(t, e);
      },
      setWordWrapCallback: function setWordWrapCallback(t, e) {
        return this.style.setWordWrapCallback(t, e);
      },
      setAlign: function setAlign(t) {
        return this.style.setAlign(t);
      },
      setResolution: function setResolution(t) {
        return this.style.setResolution(t);
      },
      setLineSpacing: function setLineSpacing(t) {
        return this.lineSpacing = t, this.updateText();
      },
      setPadding: function setPadding(t, e, i, n) {
        if ("object" == _typeof(t)) {
          var s = t,
              r = l(s, "x", null);
          null !== r ? (t = r, i = r) : (t = l(s, "left", 0), i = l(s, "right", t));
          var o = l(s, "y", null);
          null !== o ? (e = o, n = o) : (e = l(s, "top", 0), n = l(s, "bottom", e));
        } else void 0 === t && (t = 0), void 0 === e && (e = t), void 0 === i && (i = t), void 0 === n && (n = e);

        return this.padding.left = t, this.padding.top = e, this.padding.right = i, this.padding.bottom = n, this.updateText();
      },
      ...
      updateText: function updateText() {
        ...
        for (var g = 0; g < h.lines; g++) {
          if (c = i.strokeThickness / 2, d = i.strokeThickness / 2 + g * h.lineHeight + s.ascent, g > 0 && (d += h.lineSpacing * g), i.rtl) c = f - c;else if ("right" === i.align) c += o - h.lineWidths[g];else if ("center" === i.align) c += (o - h.lineWidths[g]) / 2;else if ("justify" === i.align) {
            if (h.lineWidths[g] / h.width >= .85) {
              ...
              for (var T = Math.floor(v / m), w = 0; T > 0;) {
                x[w] += " ", w = (w + 1) % (x.length - 1 || 1), --T;
              }
        ...
        e.restore(), this.renderer.gl && (this.frame.source.glTexture = this.renderer.canvasToTexture(t, this.frame.source.glTexture, !0), this.frame.glTexture = this.frame.source.glTexture), this.dirty = !0;
        var E = this.input;
    ...
    t.exports = {
      ...
      CONNECTED: i(800),
      DISCONNECTED: i(801),
      GAMEPAD_BUTTON_DOWN: i(802),
      GAMEPAD_BUTTON_UP: i(803)
    };
  }, function (t, e, i) {
    var n = i(16),
        s = i(84);
    ...
    t.exports = {
      ...
      IncY: i(397),
      PlaceOnCircle: i(398),
      PlaceOnEllipse: i(399),
      PlaceOnLine: i(400),
      PlaceOnRectangle: i(401),
      PlaceOnTriangle: i(403),
      PlayAnimation: i(405),
      PropertyValueInc: i(21),
      PropertyValueSet: i(12),
      RandomCircle: i(406),
      RandomEllipse: i(407),
      RandomLine: i(408),
      RandomRectangle: i(409),
      RandomTriangle: i(410),
      Rotate: i(411),
      RotateAround: i(412),
      RotateAroundDistance: i(413),
      ScaleX: i(414),
      ScaleXY: i(415),
      ScaleY: i(416),
      SetAlpha: i(417),
      ...
      SetScaleX: i(424),
      SetScaleY: i(425),
      SetScrollFactor: i(426),
      SetScrollFactorX: i(427),
      SetScrollFactorY: i(428),
      SetTint: i(429),
      SetVisible: i(430),
      SetX: i(431),
      SetXY: i(432),
      ...
      Spread: i(438),
      ToggleVisible: i(439),
      WrapInRectangle: i(440)
    };
  }, function (t, e, i) {
    var n = i(62),
        s = [];
    s[n.BOTTOM_CENTER] = i(130), s[n.BOTTOM_LEFT] = i(131), s[n.BOTTOM_RIGHT] = i(132), s[n.LEFT_BOTTOM] = i(133), s[n.LEFT_CENTER] = i(134), s[n.LEFT_TOP] = i(135), s[n.RIGHT_BOTTOM] = i(136), s[n.RIGHT_CENTER] = i(137), s[n.RIGHT_TOP] = i(138), s[n.TOP_CENTER] = i(139), s[n.TOP_LEFT] = i(140), s[n.TOP_RIGHT] = i(141);
    ...
    var n = i(62),
        s = [];
    s[n.BOTTOM_CENTER] = i(143), s[n.BOTTOM_LEFT] = i(144), s[n.BOTTOM_RIGHT] = i(145), s[n.CENTER] = i(146), s[n.LEFT_CENTER] = i(148), s[n.RIGHT_CENTER] = i(149), s[n.TOP_CENTER] = i(150), s[n.TOP_LEFT] = i(151), s[n.TOP_RIGHT] = i(152), s[n.LEFT_BOTTOM] = s[n.BOTTOM_LEFT], s[n.LEFT_TOP] = s[n.TOP_LEFT], s[n.RIGHT_BOTTOM] = s[n.BOTTOM_RIGHT], s[n.RIGHT_TOP] = s[n.TOP_RIGHT];
    ...
    t.exports = function (t, e, i) {
      if (void 0 === i && (i = new s()), e <= 0 || e >= 1) return i.x = t.x, i.y = t.y, i;
      var r = n(t) * e;
      return e > .5 ? (r -= t.width + t.height) <= t.width ? (i.x = t.right - r, i.y = t.bottom) : (i.x = t.x, i.y = t.bottom - (r - t.width)) : r <= t.width ? (i.x = t.x + r, i.y = t.y) : (i.x = t.right, i.y = t.y + (r - t.width)), i;
    };
  }, function (t, e, i) {
    var n = i(0),
        s = i(354),
      ...
      getPointA: function getPointA(t) {
        return void 0 === t && (t = new h()), t.set(this.x1, this.y1), t;
      },
      getPointB: function getPointB(t) {
    ...
    var n = i(167),
        ...
        r = {
      mask: null,
      setMask: function setMask(t) {
        return this.mask = t, this;
      },
      clearMask: function clearMask(t) {
        return void 0 === t && (t = !1), t && this.mask && this.mask.destroy(), this.mask = null, this;
      },
      createBitmapMask: function createBitmapMask(t) {
        return void 0 === t && (this.texture || this.shader) && (t = this), new n(this.scene, t);
      },
      createGeometryMask: function createGeometryMask(t) {
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e) {
        ...
        if (this.renderer = i, this.bitmapMask = e, this.maskTexture = null, this.mainTexture = null, this.dirty = !0, this.mainFramebuffer = null, this.maskFramebuffer = null, this.prevFramebuffer = null, this.invertAlpha = !1, this.isStencil = !1, i && i.gl) {
          var n = i.width,
              r = i.height,
              o = 0 == (n & n - 1) && 0 == (r & r - 1),
              a = i.gl,
              h = o ? a.REPEAT : a.CLAMP_TO_EDGE,
              u = a.LINEAR;
          this.mainTexture = i.createTexture2D(0, u, u, h, h, a.RGBA, null, n, r), this.maskTexture = i.createTexture2D(0, u, u, h, h, a.RGBA, null, n, r), this.mainFramebuffer = i.createFramebuffer(n, r, this.mainTexture, !0), this.maskFramebuffer = i.createFramebuffer(n, r, this.maskTexture, !0), t.sys.game.events.on(s.CONTEXT_RESTORED, function (t) {
            var e = t.width,
                i = t.height,
                n = 0 == (e & e - 1) && 0 == (i & i - 1),
                s = t.gl,
      ...
      setBitmap: function setBitmap(t) {
        this.bitmapMask = t;
      },
      preRenderWebGL: function preRenderWebGL(t, e, i) {
        t.pipelines.BitmapMaskPipeline.beginMask(this, e, i);
      },
      postRenderWebGL: function postRenderWebGL(t, e) {
    ...
    var n = new (i(0))({
      ...
      setInvertAlpha: function setInvertAlpha(t) {
      ...
      applyStencil: function applyStencil(t, e, i) {
        var n = t.gl,
            s = this.geometryMask,
            r = t.maskCount;
      ...
      postRenderWebGL: function postRenderWebGL(t) {
        var e = t.gl;
        if (t.maskStack.pop(), t.maskCount--, 0 === t.maskStack.length) t.flush(), t.currentMask.mask = null, e.disable(e.STENCIL_TEST);else {
          t.flush();
          var i = t.maskStack[t.maskStack.length - 1];
          i.mask.applyStencil(t, i.camera, !1), t.currentCameraMask.mask !== i.mask ? (t.currentMask.mask = i.mask, t.currentMask.camera = i.camera) : t.currentMask.mask = null;
        }
      },
      preRenderCanvas: function preRenderCanvas(t, e, i) {
        var n = this.geometryMask;
        t.currentContext.save(), n.renderCanvas(t, n, 0, i, null, null, !0), t.currentContext.clip();
      },
      postRenderCanvas: function postRenderCanvas(t) {
    ...
    var i = {
      ...
      pipeline: null,
      initPipeline: function initPipeline(t) {
      ...
      setPipeline: function setPipeline(t) {
        var e = this.scene.sys.game.renderer;
    ...
    var i = {
      scrollFactorX: 1,
      scrollFactorY: 1,
      setScrollFactor: function setScrollFactor(t, e) {
    ...
    var n = i(18),
      ...
      getLocalTransformMatrix: function getLocalTransformMatrix(t) {
        return void 0 === t && (t = new s()), t.applyITRS(this.x, this.y, this._rotation, this._scaleX, this._scaleY);
      },
      getWorldTransformMatrix: function getWorldTransformMatrix(t, e) {
        void 0 === t && (t = new s()), void 0 === e && (e = new s());
        var i = this.parentContainer;
        if (!i) return this.getLocalTransformMatrix(t);

        for (t.applyITRS(this.x, this.y, this._rotation, this._scaleX, this._scaleY); i;) {
          e.applyITRS(i.x, i.y, i._rotation, i._scaleX, i._scaleY), e.multiply(t, t), i = i.parentContainer;
        }
    ...
    t.exports = function (t, e) {
      ...
      var i = t.x2 - t.x1,
          ...
          a = Math.random(),
          h = Math.random();
      return a + h >= 1 && (a = 1 - a, h = 1 - h), e.x = t.x1 + (i * a + r * h), e.y = t.y1 + (s * a + o * h), e;
    };
  }, function (t, e, i) {
    var n = i(88),
        s = i(0),
      ...
      add: function add(t, e) {
        if (!this.anims.has(t)) return e.key = t, this.anims.set(t, e), this.emit(a.ADD_ANIMATION, t, e), this;
        console.warn("Animation key exists: " + t);
      },
      exists: function exists(t) {
      ...
      generateFrameNames: function generateFrameNames(t, e) {
        var i = u(e, "prefix", ""),
            n = u(e, "start", 0),
            s = u(e, "end", 0),
            r = u(e, "suffix", ""),
        ...
        var d,
            ...
            p = n < s ? 1 : -1;
        if (s += p, e) {
          if (Array.isArray(h)) for (d = 0; d < h.length; d++) {
            f = i + l(h[d], o, "0", 1) + r, c.has(f) && a.push({
              key: t,
              frame: f
            });
          } else for (d = n; d !== s; d += p) {
            f = i + l(d, o, "0", 1) + r, c.has(f) && a.push({
              key: t,
              frame: f
            });
          }
        } else for (h = c.getFrameNames(), d = 0; d < h.length; d++) {
          a.push({
            key: t,
            frame: h[d]
          });
      ...
      generateFrameNumbers: function generateFrameNumbers(t, e) {
        var i,
            n = u(e, "start", 0),
            s = u(e, "end", -1),
            r = u(e, "first", !1),
        ...
        if (r && h.has(r) && o.push({
          key: t,
          frame: r
        }), Array.isArray(a)) for (i = 0; i < a.length; i++) {
          h.has(a[i]) && o.push({
            key: t,
            frame: a[i]
          });
      ...
      staggerPlay: function staggerPlay(t, e, i) {
        if (void 0 === i && (i = 0), Array.isArray(e) || (e = [e]), this.get(t)) {
          for (var n = 0; n < e.length; n++) {
            e[n].anims.delayedPlay(i * n, t);
          }
      ...
      toJSON: function toJSON(t) {
        if (void 0 !== t && "" !== t) return this.anims.get(t).toJSON();
        var e = {
          anims: [],
          globalTimeScale: this.globalTimeScale
        };
        return this.anims.each(function (t, i) {
    ...
    var n = i(183),
      ...
      destroy: function destroy() {
        for (var t = ["binary", "bitmapFont", "json", "physics", "shader", "audio", "video", "text", "html", "obj", "tilemap", "xml"], e = 0; e < t.length; e++) {
          this[t[e]].destroy(), this[t[e]] = null;
        }
    ...
    var n = i(67),
      ...
      initialize: function initialize(t, e, i, s) {
        n.call(this, t, e, i, s), this.inputEnabled = !0, this.fadeEffect = new u.Fade(this), this.flashEffect = new u.Flash(this), this.shakeEffect = new u.Shake(this), this.panEffect = new u.Pan(this), this.zoomEffect = new u.Zoom(this), this.lerp = new d(1, 1), this.followOffset = new d(), this.deadzone = null, this._follow = null, this.renderToTexture = !1, this.renderToGame = !0, this.canvas = null, this.context = null, this.glTexture = null, this.framebuffer = null, this.pipeline = null;
      },
      setRenderToTexture: function setRenderToTexture(t, e) {
        void 0 === e && (e = !0);
      ...
      setPipeline: function setPipeline(t) {
        if ("string" == typeof t) {
          var e = this.scene.sys.game.renderer;
          e.gl && e.hasPipeline(t) && (this.pipeline = e.getPipeline(t));
        } else this.pipeline = t;
      ...
      setDeadzone: function setDeadzone(t, e) {
        if (void 0 === t) this.deadzone = null;else {
          if (this.deadzone ? (this.deadzone.width = t, this.deadzone.height = e) : this.deadzone = new c(0, 0, t, e), this._follow) {
            var i = this.width / 2,
                n = this.height / 2,
                s = this._follow.x - this.followOffset.x,
                o = this._follow.y - this.followOffset.y;
            this.midPoint.set(s, o), this.scrollX = s - i, this.scrollY = o - n;
          }

          r(this.deadzone, this.midPoint.x, this.midPoint.y);
        }
        return this;
      },
      fadeIn: function fadeIn(t, e, i, n, s, r) {
        return this.fadeEffect.start(!1, t, e, i, n, !0, s, r);
      },
      fadeOut: function fadeOut(t, e, i, n, s, r) {
        return this.fadeEffect.start(!0, t, e, i, n, !0, s, r);
      },
      fadeFrom: function fadeFrom(t, e, i, n, s, r, o) {
        return this.fadeEffect.start(!1, t, e, i, n, s, r, o);
      },
      fade: function fade(t, e, i, n, s, r, o) {
        return this.fadeEffect.start(!0, t, e, i, n, s, r, o);
      },
      flash: function flash(t, e, i, n, s, r, o) {
        return this.flashEffect.start(t, e, i, n, s, r, o);
      },
      shake: function shake(t, e, i, n, s) {
        return this.shakeEffect.start(t, e, i, n, s);
      },
      pan: function pan(t, e, i, n, s, r, o) {
        return this.panEffect.start(t, e, i, n, s, r, o);
      },
      zoomTo: function zoomTo(t, e, i, n, s, r) {
      ...
      preRender: function preRender(t) {
        ...
        if (d && r(d, this.midPoint.x, this.midPoint.y), c && !this.panEffect.isRunning) {
          var g = c.x - this.followOffset.x,
              v = c.y - this.followOffset.y;
          d ? (g < d.x ? f = l(f, f - (d.x - g), this.lerp.x) : g > d.right && (f = l(f, f + (g - d.right), this.lerp.x)), v < d.y ? p = l(p, p - (d.y - v), this.lerp.y) : v > d.bottom && (p = l(p, p + (v - d.bottom), this.lerp.y))) : (f = l(f, g - h, this.lerp.x), p = l(p, v - u, this.lerp.y));
        }

        this.useBounds && (f = this.clampX(f), p = this.clampY(p)), this.roundPixels && (h = Math.round(h), u = Math.round(u)), this.scrollX = f, this.scrollY = p;
        var m = f + n,
            y = p + s;
        this.midPoint.set(m, y);
        var x = e / o,
            T = i / o;
        this.worldView.setTo(m - x / 2, y - T / 2, x, T), a.applyITRS(this.x + h, this.y + u, this.rotation, o, o), a.translate(-h, -u), this.shakeEffect.preRender();
      },
      setLerp: function setLerp(t, e) {
        return void 0 === t && (t = 1), void 0 === e && (e = t), this.lerp.set(t, e), this;
      },
      setFollowOffset: function setFollowOffset(t, e) {
        return void 0 === t && (t = 0), void 0 === e && (e = 0), this.followOffset.set(t, e), this;
      },
      startFollow: function startFollow(t, e, i, n, s, r) {
      ...
      resetFX: function resetFX() {
        return this.panEffect.reset(), this.shakeEffect.reset(), this.flashEffect.reset(), this.fadeEffect.reset(), this;
      },
      update: function update(t, e) {
        this.visible && (this.panEffect.update(t, e), this.zoomEffect.update(t, e), this.shakeEffect.update(t, e), this.flashEffect.update(t, e), this.fadeEffect.update(t, e));
      },
      destroy: function destroy() {
    ...
    t.exports = function (t) {
      var e = new n(),
          i = /^rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*(\d+(?:\.\d+)?))?\s*\)$/.exec(t.toLowerCase());
    ...
    t.exports = {
      disable: function disable(t) {
        return "" === n && (n = i(t)), n && (t[n] = !1), t;
      },
      enable: function enable(t) {
        return "" === n && (n = i(t)), n && (t[n] = !0), t;
      },
      getPrefix: i = function i(t) {
    ...
    var n = new (i(0))({
      ...
      normalFromMat4: function normalFromMat4(t) {
        var e = t.val,
            i = this.val,
            n = e[0],
            s = e[1],
            ...
            C = d * y - p * v,
            R = f * y - p * m,
            P = x * R - T * C + w * M + E * O - S * b + _ * A;

        return P ? (P = 1 / P, i[0] = (h * R - u * C + l * M) * P, i[1] = (u * O - a * R - l * b) * P, i[2] = (a * C - h * O + l * A) * P, i[3] = (r * C - s * R - o * M) * P, i[4] = (n * R - r * O + o * b) * P, i[5] = (s * O - n * C - o * A) * P, i[6] = (v * _ - m * S + y * E) * P, i[7] = (m * w - g * _ - y * T) * P, i[8] = (g * S - v * w + y * x) * P, this) : null;
      }
    });
    t.exports = n;
  }, function (t, e, i) {
    var n = new (i(0))({
      ...
      xyz: function xyz(t, e, i) {
        this.identity();
        var n = this.val;
        return n[12] = t, n[13] = e, n[14] = i, this;
      },
      scaling: function scaling(t, e, i) {
        this.zero();
        var n = this.val;
      ...
      invert: function invert() {
        var t = this.val,
            ...
            O = l * v - d * p,
            M = c * v - d * g,
            C = m * M - y * O + x * b + T * A - w * _ + E * S;

        return C ? (C = 1 / C, t[0] = (o * M - a * O + h * b) * C, t[1] = (n * O - i * M - s * b) * C, t[2] = (p * E - g * w + v * T) * C, t[3] = (c * w - l * E - d * T) * C, t[4] = (a * A - r * M - h * _) * C, t[5] = (e * M - n * A + s * _) * C, t[6] = (g * x - f * E - v * y) * C, t[7] = (u * E - c * x + d * y) * C, t[8] = (r * O - o * A + h * S) * C, t[9] = (i * A - e * O - s * S) * C, t[10] = (f * w - p * x + v * m) * C, t[11] = (l * x - u * w - d * m) * C, t[12] = (o * _ - r * b - a * S) * C, t[13] = (e * b - i * _ + n * S) * C, t[14] = (p * y - f * T - g * m) * C, t[15] = (u * T - l * y + c * m) * C, this) : null;
      },
      adjoint: function adjoint() {
        var t = this.val,
            e = t[0],
      ...
      multiplyLocal: function multiplyLocal(t) {
        var e = [],
            i = this.val,
            n = t.val;
      ...
      translateXYZ: function translateXYZ(t, e, i) {
        var n = this.val;
      ...
      scaleXYZ: function scaleXYZ(t, e, i) {
        var n = this.val;
      ...
      rotate: function rotate(t, e) {
        ...
        return i[0] = l * E + p * S + y * _, i[1] = c * E + g * S + x * _, i[2] = d * E + v * S + T * _, i[3] = f * E + m * S + w * _, i[4] = l * A + p * b + y * O, i[5] = c * A + g * b + x * O, i[6] = d * A + v * b + T * O, i[7] = f * A + m * b + w * O, i[8] = l * M + p * C + y * R, i[9] = c * M + g * C + x * R, i[10] = d * M + v * C + T * R, i[11] = f * M + m * C + w * R, this;
      },
      ...
      fromRotationTranslation: function fromRotationTranslation(t, e) {
        var i = this.val,
            n = t.x,
            s = t.y,
            r = t.z,
      ...
      frustum: function frustum(t, e, i, n, s, r) {
        var o = this.val,
            a = 1 / (e - t),
            h = 1 / (n - i),
            u = 1 / (s - r);
      ...
      perspective: function perspective(t, e, i, n) {
        var s = this.val,
            r = 1 / Math.tan(t / 2),
            o = 1 / (i - n);
      ...
      perspectiveLH: function perspectiveLH(t, e, i, n) {
        var s = this.val;
      ...
      ortho: function ortho(t, e, i, n, s, r) {
        var o = this.val,
            a = t - e,
            h = i - n,
            u = s - r;
        return a = 0 === a ? a : 1 / a, h = 0 === h ? h : 1 / h, u = 0 === u ? u : 1 / u, o[0] = -2 * a, o[1] = 0, o[2] = 0, o[3] = 0, o[4] = 0, o[5] = -2 * h, o[6] = 0, o[7] = 0, o[8] = 0, o[9] = 0, o[10] = 2 * u, o[11] = 0, o[12] = (t + e) * a, o[13] = (n + i) * h, o[14] = (r + s) * u, o[15] = 1, this;
      },
      lookAt: function lookAt(t, e, i) {
        ...
        var f = s - l,
            ...
            y = u * (f *= v) - a * g,
            x = a * p - h * f;
        (v = Math.sqrt(m * m + y * y + x * x)) ? (m *= v = 1 / v, y *= v, x *= v) : (m = 0, y = 0, x = 0);
        var T = p * x - g * y,
            w = g * m - f * x,
            E = f * y - p * m;
        return (v = Math.sqrt(T * T + w * w + E * E)) ? (T *= v = 1 / v, w *= v, E *= v) : (T = 0, w = 0, E = 0), n[0] = m, n[1] = T, n[2] = f, n[3] = 0, n[4] = y, n[5] = w, n[6] = p, n[7] = 0, n[8] = x, n[9] = E, n[10] = g, n[11] = 0, n[12] = -(m * s + y * r + x * o), n[13] = -(T * s + w * r + E * o), n[14] = -(f * s + p * r + g * o), n[15] = 1, this;
      },
      yawPitchRoll: function yawPitchRoll(t, e, i) {
      ...
      setWorldMatrix: function setWorldMatrix(t, e, i, n, o) {
    ...
    var n = i(0),
        ...
        d = new n({
      initialize: function initialize(t, e, i, n) {
        "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0, this.z = t.z || 0, this.w = t.w || 0) : (this.x = t || 0, this.y = e || 0, this.z = i || 0, this.w = n || 0);
      },
      copy: function copy(t) {
        return this.x = t.x, this.y = t.y, this.z = t.z, this.w = t.w, this;
      },
      set: function set(t, e, i, n) {
        return "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0, this.z = t.z || 0, this.w = t.w || 0) : (this.x = t || 0, this.y = e || 0, this.z = i || 0, this.w = n || 0), this;
      },
      add: function add(t) {
        return this.x += t.x, this.y += t.y, this.z += t.z, this.w += t.w, this;
      },
      ...
      normalize: function normalize() {
        var t = this.x,
            ...
            n = this.w,
            s = t * t + e * e + i * i + n * n;
        return s > 0 && (s = 1 / Math.sqrt(s), this.x = t * s, this.y = e * s, this.z = i * s, this.w = n * s), this;
      },
      dot: function dot(t) {
      ...
      rotationTo: function rotationTo(t, e) {
        var i = t.x * e.x + t.y * e.y + t.z * e.z;
        return i < -.999999 ? (l.copy(h).cross(t).length() < 1e-6 && l.copy(u).cross(t), l.normalize(), this.setAxisAngle(l, Math.PI)) : i > .999999 ? (this.x = 0, this.y = 0, this.z = 0, this.w = 1, this) : (l.copy(t).cross(e), this.x = l.x, this.y = l.y, this.z = l.z, this.w = 1 + i, this.normalize());
      },
      setAxes: function setAxes(t, e, i) {
        var n = c.val;
      ...
      setAxisAngle: function setAxisAngle(t, e) {
        e *= .5;
        var i = Math.sin(e);
      ...
      slerp: function slerp(t, e) {
        ...
        if (1 - l > 1e-6) {
          var f = Math.acos(l),
              p = Math.sin(f);
          c = Math.sin((1 - e) * f) / p, d = Math.sin(e * f) / p;
        }

        return this.x = c * i + d * o, this.y = c * n + d * a, this.z = c * s + d * h, this.w = c * r + d * u, this;
      },
      invert: function invert() {
        var t = this.x,
            e = this.y,
      ...
      fromMat3: function fromMat3(t) {
        var e,
            i = t.val,
            n = i[0] + i[4] + i[8];
        if (n > 0) e = Math.sqrt(n + 1), this.w = .5 * e, e = .5 / e, this.x = (i[7] - i[5]) * e, this.y = (i[2] - i[6]) * e, this.z = (i[3] - i[1]) * e;else {
          var s = 0;
          i[4] > i[0] && (s = 1), i[8] > i[3 * s + s] && (s = 2);
          var r = o[s],
              h = o[r];
          e = Math.sqrt(i[3 * s + s] - i[3 * r + r] - i[3 * h + h] + 1), a[s] = .5 * e, e = .5 / e, a[r] = (i[3 * r + s] + i[3 * s + r]) * e, a[h] = (i[3 * h + s] + i[3 * s + h]) * e, this.x = a[0], this.y = a[1], this.z = a[2], this.w = (i[3 * h + r] - i[3 * r + h]) * e;
        }
        return this;
      }
    });
    ...
    t.exports = function (t) {
      ...
      if (!e.customEnvironment && !e.canvas && e.renderType !== r.HEADLESS) if (e.renderType === r.CANVAS || e.renderType !== r.CANVAS && !o.webGL) {
      ...
      var a,
          ...
          l = u.width,
          c = u.height;
      e.canvas ? (t.canvas = e.canvas, t.canvas.width = l, t.canvas.height = c) : t.canvas = s.create(t, l, c, e.renderType), e.canvasStyle && (t.canvas.style = e.canvasStyle), e.antialias || n.setCrisp(t.canvas), e.renderType !== r.HEADLESS && (a = i(588), h = i(591), e.renderType === r.WEBGL ? t.renderer = new h(t) : (t.renderer = new a(t), t.context = t.renderer.gameContext));
    };
  }, function (t, e) {
    t.exports = {
      setCrisp: function setCrisp(t) {
    ...
    var n = i(0),
      ...
      setTexture2D: function setTexture2D(t, e) {
        return void 0 === t && (t = this.renderer.blankTexture.glTexture), void 0 === e && (e = 0), this.requireTextureBatch(t, e) && this.pushBatch(t, e), this;
      },
      requireTextureBatch: function requireTextureBatch(t, e) {
        var i = this.batches,
            n = i.length;
        return !(n > 0) || !((e > 0 ? i[n - 1].textures[e - 1] : i[n - 1].texture) === t);
      },
      pushBatch: function pushBatch(t, e) {
        if (0 === e) this.batches.push({
      ...
      flush: function flush() {
        ...
        for (var d = 0; d < u - 1; d++) {
          if (c = h[d], t = h[d + 1], c.textures.length > 0) {
            for (e = 0; e < c.textures.length; ++e) {
              (i = c.textures[e]) && a.setTexture2D(i, 1 + e, !1);
            }
        ...
        return l = s - c.first, c.texture && l > 0 && (a.setTexture2D(c.texture, 0, !1), n.drawArrays(r, c.first, l)), this.vertexCount = 0, h.length = 0, this.flushLocked = !1, this;
      },
      batchSprite: function batchSprite(t, e, i) {
        ...
        if (t.isCropped) {
          var E = t._crop;
          E.flipX === t.flipX && E.flipY === t.flipY || o.updateCropUVs(E, t.flipX, t.flipY), h = E.u0, u = E.v0, c = E.u1, d = E.v1, g = E.width, v = E.height, T = -y + (f = E.x), w = -x + (p = E.y);
        }

        var S = 1,
            _ = 1;
        t.flipX && (m || (T += -o.realWidth + 2 * y), S = -1), (t.flipY || o.source.isGLTexture && !a.flipY) && (m || (w += -o.realHeight + 2 * x), _ = -1), s.applyITRS(t.x, t.y, t.rotation, t.scaleX * S, t.scaleY * _), n.copyFrom(e.matrix), i ? (n.multiplyWithOffset(i, -e.scrollX * t.scrollFactorX, -e.scrollY * t.scrollFactorY), s.e = t.x, s.f = t.y, n.multiply(s, r)) : (s.e -= e.scrollX * t.scrollFactorX, s.f -= e.scrollY * t.scrollFactorY, n.multiply(s, r));
        var A = T + g,
            b = w + v,
            O = r.getX(T, w),
            M = r.getY(T, w),
            ...
            k = r.getX(A, w),
            D = r.getY(A, w),
            F = l.getTintAppendFloatAlpha(t._tintTL, e.alpha * t._alphaTL),
            I = l.getTintAppendFloatAlpha(t._tintTR, e.alpha * t._alphaTR),
            B = l.getTintAppendFloatAlpha(t._tintBL, e.alpha * t._alphaBL),
            N = l.getTintAppendFloatAlpha(t._tintBR, e.alpha * t._alphaBR);
        e.roundPixels && (O = Math.round(O), M = Math.round(M), C = Math.round(C), R = Math.round(R), P = Math.round(P), L = Math.round(L), k = Math.round(k), D = Math.round(D)), this.setTexture2D(a, 0);
        var U = t._isTinted && t.tintFill;
        this.batchQuad(O, M, C, R, P, L, k, D, h, u, c, d, F, I, B, N, U, a, 0);
      },
      batchQuad: function batchQuad(t, e, i, n, s, r, o, a, h, u, l, c, d, f, p, g, v, m, y) {
        var x = !1;
      ...
      batchTri: function batchTri(t, e, i, n, s, r, o, a, h, u, l, c, d, f, p, g) {
        var v = !1;
      ...
      batchTexture: function batchTexture(t, e, i, n, s, r, o, a, h, u, l, c, d, f, p, g, v, m, y, x, T, w, E, S, _, A, b, O, M, C, R) {
        ...
        if (t.isCropped) {
          var X = t._crop;
          N = X.width, U = X.height, o = X.width, a = X.height;
          var G = m = X.x,
              H = y = X.y;
          c && (G = x - X.x - X.width), d && !e.isRenderTexture && (H = T - X.y - X.height), D = G / i + b, F = H / n + O, I = (G + X.width) / i + b, B = (H + X.height) / n + O, z = -g + m, Y = -v + y;
        }

        d ^= !R && e.isRenderTexture ? 1 : 0, c && (N *= -1, z += o), d && (U *= -1, Y += a);
        var W = z + N,
            V = Y + U;
        L.applyITRS(s, r, l, h, u), P.copyFrom(M.matrix), C ? (P.multiplyWithOffset(C, -M.scrollX * f, -M.scrollY * p), L.e = s, L.f = r, P.multiply(L, k)) : (L.e -= M.scrollX * f, L.f -= M.scrollY * p, P.multiply(L, k));
        var j = k.getX(z, Y),
            K = k.getY(z, Y),
            q = k.getX(z, V),
            Z = k.getY(z, V),
            ...
            $ = k.getX(W, Y),
            tt = k.getY(W, Y);
        M.roundPixels && (j = Math.round(j), K = Math.round(K), q = Math.round(q), Z = Math.round(Z), J = Math.round(J), Q = Math.round(Q), $ = Math.round($), tt = Math.round(tt)), this.setTexture2D(e, 0), this.batchQuad(j, K, q, Z, J, Q, $, tt, D, F, I, B, w, E, S, _, A, e, 0);
      },
      batchTextureFrame: function batchTextureFrame(t, e, i, n, s, r, o) {
        this.renderer.setPipeline(this);
      ...
      drawFillRect: function drawFillRect(t, e, i, n, s, r) {
        var o = t + i,
            a = e + n;
        this.setTexture2D();
      ...
      batchFillRect: function batchFillRect(t, e, i, n, s, r) {
        this.renderer.setPipeline(this);
      ...
      batchFillTriangle: function batchFillTriangle(t, e, i, n, s, r, o, a) {
        this.renderer.setPipeline(this);
      ...
      batchStrokeTriangle: function batchStrokeTriangle(t, e, i, n, s, r, o, a, h) {
      ...
      batchFillPath: function batchFillPath(t, e, i) {
        this.renderer.setPipeline(this);
        var n = this._tempMatrix3;
        i && i.multiply(e, n);

        for (var r, o, a = t.length, h = this.polygonCache, u = this.fillTint.TL, l = this.fillTint.TR, c = this.fillTint.BL, d = this.tintEffect, f = 0; f < a; ++f) {
          o = t[f], h.push(o.x, o.y);
        }
        ...
        for (var p = this.currentFrame, g = 0; g < a; g += 3) {
          var v = 2 * r[g + 0],
              ...
              k = p.u1,
              D = p.v1;
          this.batchTri(A, b, O, M, C, R, P, L, k, D, u, l, c, d);
        }

        h.length = 0;
      },
      batchStrokePath: function batchStrokePath(t, e, i, n, s) {
      ...
      batchLine: function batchLine(t, e, i, n, s, r, o, a, h, u, l) {
        this.renderer.setPipeline(this);
        ...
        if (this.batchQuad(k, D, C, R, O, M, P, L, X, G, H, W, B, N, U, z, I), !(o <= 2)) {
          var V = this.prevQuad,
              j = this.firstQuad;
          a > 0 && V[4] ? this.batchQuad(k, D, C, R, V[0], V[1], V[2], V[3], X, G, H, W, B, N, U, z, I) : (j[0] = k, j[1] = D, j[2] = C, j[3] = R, j[4] = 1), h && j[4] ? this.batchQuad(O, M, P, L, j[0], j[1], j[2], j[3], X, G, H, W, B, N, U, z, I) : (V[0] = O, V[1] = M, V[2] = P, V[3] = L, V[4] = 1);
        }
      }
    });
    t.exports = d;
    ...
    var i = {
      ...
      modelScale: function modelScale(t, e, i) {
      ...
      modelTranslate: function modelTranslate(t, e, i) {
        var n = this.modelMatrix;
      ...
      modelRotateX: function modelRotateX(t) {
      ...
      modelRotateY: function modelRotateY(t) {
        var e = this.modelMatrix,
            i = Math.sin(t),
            n = Math.cos(t),
            s = e[0],
      ...
      modelRotateZ: function modelRotateZ(t) {
        var e = this.modelMatrix,
            i = Math.sin(t),
            n = Math.cos(t),
            s = e[0],
      ...
      viewScale: function viewScale(t, e, i) {
      ...
      viewTranslate: function viewTranslate(t, e, i) {
        var n = this.viewMatrix;
      ...
      viewRotateX: function viewRotateX(t) {
      ...
      viewRotateY: function viewRotateY(t) {
        var e = this.viewMatrix,
            i = Math.sin(t),
            n = Math.cos(t),
            s = e[0],
      ...
      viewRotateZ: function viewRotateZ(t) {
        var e = this.viewMatrix,
            i = Math.sin(t),
            n = Math.cos(t),
            s = e[0],
      ...
      viewLoad2D: function viewLoad2D(t) {
        var e = this.viewMatrix;
      ...
      projOrtho: function projOrtho(t, e, i, n, s, r) {
      ...
      projPersp: function projPersp(t, e, i, n) {
    ...
    t.exports = function (t) {
      ...
      if (!e.hideBanner) {
        var i = "WebGL";
        e.renderType === n.CANVAS ? i = "Canvas" : e.renderType === n.HEADLESS && (i = "Headless");
        var s,
            r = e.audio,
            o = t.device.audio;
        if (s = !o.webAudio || r && r.disableWebAudio ? r && r.noAudio || !o.webAudio && !o.audioData ? "No Audio" : "HTML5 Audio" : "Web Audio", t.device.browser.ie) window.console && console.log("Phaser v" + n.VERSION + " / https://phaser.io");else {
          var a,
              h = "",
              u = [h];
          Array.isArray(e.bannerBackgroundColor) ? (e.bannerBackgroundColor.forEach(function (t) {
            h = h.concat("%c "), u.push("background: " + t), a = t;
          }), u[u.length - 1] = "color: " + e.bannerTextColor + "; background: " + a) : (h = h.concat("%c "), u.push("color: " + e.bannerTextColor + "; background: " + e.bannerBackgroundColor)), u.push("background: #fff"), e.gameTitle && (h = h.concat(e.gameTitle), e.gameVersion && (h = h.concat(" v" + e.gameVersion)), e.hidePhaser || (h = h.concat(" / "))), e.hidePhaser || (h = h.concat("Phaser v" + n.VERSION + " (" + i + " | " + s + ")")), h = h.concat(" %c " + e.gameURL), u[0] = h, console.log.apply(console, u);
        }
      }
    };
  }, function (t, e, i) {
    var n = i(0),
      ...
      resetDelta: function resetDelta() {
        ...
        this.time = t, this.lastTime = t, this.nextFpsUpdate = t + 1e3, this.framesThisSecond = 0;

        for (var e = 0; e < this.deltaSmoothingMax; e++) {
      ...
      step: function step() {
        ...
        if (this.smoothStep) {
          (this._coolDown > 0 || !this.inFocus) && (this._coolDown--, r = Math.min(r, this._target)), r > this._min && (r = n[i], r = Math.min(r, this._min)), n[i] = r, this.deltaIndex++, this.deltaIndex > s && (this.deltaIndex = 0), o = 0;
      ...
      wake: function wake(t) {
        this.running ? this.sleep() : t && (this.startTime += -this.lastTime + (this.lastTime + window.performance.now())), this.raf.start(this.step.bind(this), this.useRAF), this.running = !0, this.step();
      },
    ...
    t.exports = function (t) {
      ...
      i || (i = s.create2D(this, f, p), u = !1, l = !1), u && (i.width = f, i.height = p);
    ...
    var n = i(0),
      ...
      setCanvasOver: function setCanvasOver(t) {
        this.isOver = !0, this.events.emit(o.GAME_OVER, t);
      },
      setCanvasOut: function setCanvasOut(t) {
      ...
      setDefaultCursor: function setDefaultCursor(t) {
      ...
      updateInputPlugins: function updateInputPlugins(t, e) {
        var i = this.game.scene.getScenes(!0, !0);
        this._tempSkip = !1;

        for (var n = 0; n < i.length; n++) {
          var s = i[n];
          if (s.sys.input) if (s.sys.input.update(t, e) && this.globalTopOnly || this._tempSkip) return;
        }
      },
      ...
      hitTest: function hitTest(t, e, i, n) {
        ...
        for (var u = {
          ...
          if (this.inputCandidate(p, i)) {
            var g = s.x + r * p.scrollFactorX - r,
                v = s.y + o * p.scrollFactorY - o;
            p.parentContainer ? (p.getWorldTransformMatrix(l, c), l.applyInverse(g, v, u)) : f(g, v, p.x, p.y, p.rotation, p.scaleX, p.scaleY, u), this.pointWithinHitArea(p, u.x, u.y) && n.push(p);
          }
        }

        return n;
      },
      pointWithinHitArea: function pointWithinHitArea(t, e, i) {
        e += t.displayOriginX, i += t.displayOriginY;
        var n = t.input;
        return !(!n || !n.hitAreaCallback(n.hitArea, e, i, t)) && (n.localX = e, n.localY = i, !0);
      },
      pointWithinInteractiveObject: function pointWithinInteractiveObject(t, e, i) {
      ...
      transformPointer: function transformPointer(t, e, i, n) {
        var s = t.position,
            r = t.prevPosition;
        r.x = s.x, r.y = s.y;
    ...
    var n = i(108),
      ...
      startListeners: function startListeners() {
        ...
        this.onKeyDown = function (e) {
          if (!e.defaultPrevented && t.enabled && t.manager) {
            t.queue.push(e), t.manager.useQueue || t.manager.events.emit(o.MANAGER_PROCESS);
            var i = e.altKey || e.ctrlKey || e.shiftKey || e.metaKey;
            t.preventDefault && !i && t.captures.indexOf(e.keyCode) > -1 && e.preventDefault();
          }
      ...
      addCapture: function addCapture(t) {
        ...
        this.preventDefault = e.length > 0;
      },
      removeCapture: function removeCapture(t) {
        "string" == typeof t && (t = t.split(",")), Array.isArray(t) || (t = [t]);
    ...
    var n = i(212),
      ...
      updateWorldPoint: function updateWorldPoint(t) {
        var e = this.x,
            i = this.y;
      ...
      positionToCamera: function positionToCamera(t, e) {
      ...
      updateMotion: function updateMotion() {
        ...
        if (t !== i || e !== s) {
          var r = a(this.motionFactor, i, t),
              h = a(this.motionFactor, s, e);
          o(r, t, .1) && (r = t), o(h, e, .1) && (h = e), this.midPoint.set(r, h);
          var u = t - r,
              l = e - h;
          this.velocity.set(u, l), this.angle = n(r, h, t, e), this.distance = Math.sqrt(u * u + l * l);
        }
      },
      up: function up(t) {
      ...
      touchcancel: function touchcancel(t, e) {
      ...
      getInterpolatedPosition: function getInterpolatedPosition(t, e) {
    ...
    var n = i(0),
      ...
      boot: function boot() {
        var t,
            ...
            a,
            h = this.game.config,
            l = h.installGlobalPlugins;

        for (l = l.concat(this._pendingGlobal), t = 0; t < l.length; t++) {
          e = l[t], i = u(e, "key", null), n = u(e, "plugin", null), r = u(e, "start", !1), o = u(e, "mapping", null), a = u(e, "data", null), i && (n ? this.install(i, n, r, o, a) : console.warn("Missing `plugin` for key: " + i));
        }

        for (l = (l = h.installScenePlugins).concat(this._pendingScene), t = 0; t < l.length; t++) {
          e = l[t], i = u(e, "key", null), n = u(e, "plugin", null), o = u(e, "mapping", null), i && (n ? this.installScenePlugin(i, n, o) : console.warn("Missing `plugin` for key: " + i));
        }

        this._pendingGlobal = [], this._pendingScene = [], this.game.events.once(s.DESTROY, this.destroy, this);
      },
      addToScene: function addToScene(t, e, i) {
        var n,
            s,
            r,
            o = this.game,
            a = t.scene,
            h = t.settings.map,
            u = t.settings.isBooted;

        for (n = 0; n < e.length; n++) {
          o[s = e[n]] ? (t[s] = o[s], h.hasOwnProperty(s) && (a[h[s]] = t[s])) : "game" === s && h.hasOwnProperty(s) && (a[h[s]] = o);
        }

        for (var c = 0; c < i.length; c++) {
          for (r = i[c], n = 0; n < r.length; n++) {
            if (s = r[n], l.hasCore(s)) {
              var d = l.getCore(s),
                  f = new d.plugin(a, this);
              t[d.mapping] = f, d.custom ? a[d.mapping] = f : h.hasOwnProperty(d.mapping) && (a[h[d.mapping]] = f), u && f.boot();
            }
          }
        }

        for (r = this.plugins, n = 0; n < r.length; n++) {
          var p = r[n];
          p.mapping && (a[p.mapping] = p.plugin);
        }
      },
      ...
      installScenePlugin: function installScenePlugin(t, e, i, n, s) {
        if (void 0 === s && (s = !1), "function" == typeof e) {
          ...
          if (n) {
            var r = new e(n, this);
            n.sys[t] = r, i && "" !== i && (n[i] = r), r.boot();
          }
        } else console.warn("Invalid Scene Plugin: " + t);
      },
      install: function install(t, e, i, n, s) {
      ...
      createEntry: function createEntry(t, e) {
        var i = l.getCustom(t);

        if (i) {
          var n = new i.plugin(this);
          i = {
            key: e,
            plugin: n,
            active: !0,
      ...
      removeGlobalPlugin: function removeGlobalPlugin(t) {
        var e = this.getEntry(t);
        e && c(this.plugins, e), l.removeCustom(t);
      },
      removeScenePlugin: function removeScenePlugin(t) {
        c(this.scenePlugins, t), l.remove(t);
      },
      registerGameObject: function registerGameObject(t, e, i) {
        return e && h.register(t, e), i && a.register(t, i), this;
      },
      removeGameObject: function removeGameObject(t, e, i) {
        return void 0 === e && (e = !0), void 0 === i && (i = !0), e && h.remove(t), i && a.remove(t), this;
      },
      registerFileType: function registerFileType(t, e, i) {
        o.register(t, e), i && i.sys.load && (i.sys.load[t] = e);
      },
      destroy: function destroy() {
        for (var t = 0; t < this.plugins.length; t++) {
          this.plugins[t].plugin.destroy();
        }
    ...
    var n = i(109),
      ...
      parseConfig: function parseConfig(t) {
        ...
        if ("string" == typeof e) {
          var h = this.parentSize.width;
          0 === h && (h = window.innerWidth);
          var u = parseInt(e, 10) / 100;
          e = Math.floor(h * u);
        }

        if ("string" == typeof i) {
          var c = this.parentSize.height;
          0 === c && (c = window.innerHeight);
          var d = parseInt(i, 10) / 100;
          i = Math.floor(c * d);
        }

        this.resolution = 1, this.scaleMode = s, this.autoRound = a, this.autoCenter = t.autoCenter, this.resizeInterval = t.resizeInterval, a && (e = Math.floor(e), i = Math.floor(i)), this.gameSize.setSize(e, i), o === n.ZOOM.MAX_ZOOM && (o = this.getMaxZoom()), this.zoom = o, 1 !== o && (this._resetZoom = !0), this.baseSize.setSize(e * r, i * r), a && (this.baseSize.width = Math.floor(this.baseSize.width), this.baseSize.height = Math.floor(this.baseSize.height)), t.minWidth > 0 && this.displaySize.setMin(t.minWidth * o, t.minHeight * o), t.maxWidth > 0 && this.displaySize.setMax(t.maxWidth * o, t.maxHeight * o), this.displaySize.setSize(e, i), this.orientation = l(e, i);
      },
      getParent: function getParent(t) {
        var e = t.parent;

        if (null !== e) {
          if (this.parent = u(e), this.parentIsWindow = this.parent === document.body, t.expandParent && t.scaleMode !== n.SCALE_MODE.NONE) {
            var i = this.parent.getBoundingClientRect();
            (this.parentIsWindow || 0 === i.height) && (document.documentElement.style.height = "100%", document.body.style.height = "100%", i = this.parent.getBoundingClientRect(), this.parentIsWindow || 0 !== i.height || (this.parent.style.overflow = "hidden", this.parent.style.width = "100%", this.parent.style.height = "100%"));
          }

          t.fullscreenTarget && !this.fullscreenTarget && (this.fullscreenTarget = u(t.fullscreenTarget));
        }
      },
      ...
      lockOrientation: function lockOrientation(t) {
        var e = screen.lockOrientation || screen.mozLockOrientation || screen.msLockOrientation;
        return !!e && e(t);
      },
      setParentSize: function setParentSize(t, e) {
        return this.parentSize.setSize(t, e), this.refresh();
      },
      setGameSize: function setGameSize(t, e) {
        var i = this.autoRound,
            n = this.resolution;
        i && (t = Math.floor(t), e = Math.floor(e));
        var s = this.width,
            r = this.height;
        return this.gameSize.resize(t, e), this.baseSize.resize(t * n, e * n), i && (this.baseSize.width = Math.floor(this.baseSize.width), this.baseSize.height = Math.floor(this.baseSize.height)), this.displaySize.setSize(t, e), this.canvas.width = this.baseSize.width, this.canvas.height = this.baseSize.height, this.refresh(s, r);
      },
      ...
      refresh: function refresh(t, e) {
        ...
        if (i) {
          ...
          var n = this.canvas.style,
              s = i.style;
          s.transform = "scale(" + this.displaySize.width / this.baseSize.width + "," + this.displaySize.height / this.baseSize.height + ")", s.marginLeft = n.marginLeft, s.marginTop = n.marginTop;
        }

        return this.emit(o.RESIZE, this.gameSize, this.baseSize, this.displaySize, this.resolution, t, e), this;
      },
      updateOrientation: function updateOrientation() {
        if (this._checkOrientation) {
          this._checkOrientation = !1;
          var t = l(this.width, this.height);
          t !== this.orientation && (this.orientation = t, this.emit(o.ORIENTATION_CHANGE, t));
        }
      },
      ...
      updateCenter: function updateCenter() {
        var t = this.autoCenter;

        if (t !== n.CENTER.NO_CENTER) {
          var e = this.canvas,
              i = e.style,
              s = e.getBoundingClientRect(),
              r = s.width,
              o = s.height,
              a = Math.floor((this.parentSize.width - r) / 2),
              h = Math.floor((this.parentSize.height - o) / 2);
          t === n.CENTER.CENTER_HORIZONTALLY ? h = 0 : t === n.CENTER.CENTER_VERTICALLY && (a = 0), i.marginLeft = a + "px", i.marginTop = h + "px";
        }
      },
      ...
      startFullscreen: function startFullscreen(t) {
        void 0 === t && (t = {
          navigationUI: "hide"
        });
        ...
        if (e.available) {
          if (!e.active) {
            var i,
                n = this.getFullscreenTarget();
            (i = e.keyboard ? n[e.request](Element.ALLOW_KEYBOARD_INPUT) : n[e.request](t)) ? i.then(this.fullscreenSuccessHandler.bind(this)).catch(this.fullscreenErrorHandler.bind(this)) : e.active ? this.fullscreenSuccessHandler() : this.fullscreenErrorHandler();
          }
        } else this.emit(o.FULLSCREEN_UNSUPPORTED);
      },
      fullscreenSuccessHandler: function fullscreenSuccessHandler() {
        this.getParentBounds(), this.refresh(), this.emit(o.ENTER_FULLSCREEN);
      },
      fullscreenErrorHandler: function fullscreenErrorHandler(t) {
        this.removeFullscreenTarget(), this.emit(o.FULLSCREEN_FAILED, t);
      },
      getFullscreenTarget: function getFullscreenTarget() {
        if (!this.fullscreenTarget) {
          var t = document.createElement("div");
          t.style.margin = "0", t.style.padding = "0", t.style.width = "100%", t.style.height = "100%", this.fullscreenTarget = t, this._createdFullscreenTarget = !0;
        }
      ...
      removeFullscreenTarget: function removeFullscreenTarget() {
        if (this._createdFullscreenTarget) {
          var t = this.fullscreenTarget;

          if (t && t.parentNode) {
            var e = t.parentNode;
            e.insertBefore(this.canvas, t), e.removeChild(t);
          }
        }
      },
      ...
      startListeners: function startListeners() {
        ...
        if (e.orientationChange = function () {
          t._checkOrientation = !0, t.dirty = !0;
        }, e.windowResize = function () {
          t.dirty = !0;
        }, window.addEventListener("orientationchange", e.orientationChange, !1), window.addEventListener("resize", e.windowResize, !1), this.fullscreen.available) {
          e.fullScreenChange = function (e) {
      ...
      stopListeners: function stopListeners() {
        ...
        window.removeEventListener("orientationchange", t.orientationChange, !1), window.removeEventListener("resize", t.windowResize, !1);
        ["webkit", "moz", ""].forEach(function (e) {
    ...
    var n = i(10),
      ...
      getNewWidth: function getNewWidth(t, e) {
      ...
      getNewHeight: function getNewHeight(t, e) {
      ...
      constrain: function constrain(t, e, i) {
        void 0 === t && (t = 0), void 0 === e && (e = t), void 0 === i && (i = !0), t = this.getNewWidth(t), e = this.getNewHeight(e);
        var n = this.snapTo,
            s = 0 === e ? 1 : t / e;
        return i && this.aspectRatio > s || !i && this.aspectRatio < s ? (e = (t = r(t, n.x)) / this.aspectRatio, n.y > 0 && (t = (e = r(e, n.y)) * this.aspectRatio)) : (i && this.aspectRatio < s || !i && this.aspectRatio > s) && (t = (e = r(e, n.y)) * this.aspectRatio, n.x > 0 && (e = (t = r(t, n.x)) * (1 / this.aspectRatio))), this._width = t, this._height = e, this;
      },
      fitTo: function fitTo(t, e) {
        return this.constrain(t, e, !0);
      },
      envelop: function envelop(t, e) {
    ...
    var n = i(0),
      ...
      bootQueue: function bootQueue() {
        if (!this.isBooted) {
          ...
          for (t = 0; t < this._pending.length; t++) {
            var s;
            i = (e = this._pending[t]).key, (n = e.scene) instanceof l ? s = this.createSceneFromInstance(i, n) : "object" == _typeof(n) ? s = this.createSceneFromObject(i, n) : "function" == typeof n && (s = this.createSceneFromFunction(i, n)), i = s.sys.settings.key, this.keys[i] = s, this.scenes.push(s), this._data[i] && (s.sys.settings.data = this._data[i].data, this._data[i].autoStart && (e.autoStart = !0)), (e.autoStart || s.sys.settings.active) && this._start.push(i);
          }

          for (this._pending.length = 0, this._data = {}, this.isBooted = !0, t = 0; t < this._start.length; t++) {
      ...
      processQueue: function processQueue() {
        ...
        if (0 !== t || 0 !== e) {
          ...
          if (t) {
            for (i = 0; i < t; i++) {
              n = this._pending[i], this.add(n.key, n.scene, n.autoStart, n.data);
            }

            for (i = 0; i < this._start.length; i++) {
              n = this._start[i], this.start(n);
            }
          ...
          for (i = 0; i < this._queue.length; i++) {
            this[(n = this._queue[i]).op](n.keyA, n.keyB);
          }

          this._queue.length = 0;
        }
      },
      add: function add(t, e, i, n) {
        return void 0 === i && (i = !1), void 0 === n && (n = {}), this.isProcessing || !this.isBooted ? (this._pending.push({
          ...
          data: n
        }), null) : (t = this.getKey(t, e), e instanceof l ? s = this.createSceneFromInstance(t, e) : "object" == _typeof(e) ? (e.key = t, s = this.createSceneFromObject(t, e)) : "function" == typeof e && (s = this.createSceneFromFunction(t, e)), s.sys.settings.data = n, t = s.sys.settings.key, this.keys[t] = s, this.scenes.push(s), (i || s.sys.settings.active) && (this._pending.length ? this._start.push(t) : this.start(t)), s);
        var s;
      },
      remove: function remove(t) {
        if (this.isProcessing) this._queue.push({
          ...
          i > -1 && (delete this.keys[n], this.scenes.splice(i, 1), this._start.indexOf(n) > -1 && (i = this._start.indexOf(n), this._start.splice(i, 1)), e.sys.destroy());
        }
        return this;
      },
      bootScene: function bootScene(t) {
        var e,
            i = t.sys,
            n = i.settings;
        t.init && (t.init.call(t, n.data), n.status = s.INIT, n.isTransition && i.events.emit(r.TRANSITION_INIT, n.transitionFrom, n.transitionDuration)), i.load && (e = i.load).reset(), e && t.preload ? (t.preload.call(t), 0 === e.list.size ? this.create(t) : (n.status = s.LOADING, e.once(h.COMPLETE, this.loadComplete, this), e.start())) : this.create(t);
      },
      loadComplete: function loadComplete(t) {
        var e = t.scene;
        this.game.sound && this.game.sound.onBlurPausedSounds && this.game.sound.unlock(), this.create(e);
      },
      payloadComplete: function payloadComplete(t) {
      ...
      createSceneFromFunction: function createSceneFromFunction(t, e) {
        var i = new e();
      ...
      createSceneFromInstance: function createSceneFromInstance(t, e) {
        var i = e.sys.settings.key;
        return "" !== i ? t = i : e.sys.settings.key = t, e.sys.init(this.game), e;
      },
      createSceneFromObject: function createSceneFromObject(t, e) {
        var i = new l(e),
            n = i.sys.settings.key;
        "" !== n ? t = n : i.sys.settings.key = t, i.sys.init(this.game);

        for (var s = ["init", "preload", "create", "update", "render"], r = 0; r < s.length; r++) {
          var o = a(e, s[r], null);
          o && (i[s[r]] = o);
        }

        if (e.hasOwnProperty("extend")) for (var h in e.extend) {
          if (e.extend.hasOwnProperty(h)) {
            var u = e.extend[h];
            "data" === h && i.hasOwnProperty("data") && "object" == _typeof(u) ? i.data.merge(u) : "sys" !== h && (i[h] = u);
          }
        }
        return i;
      },
      getKey: function getKey(t, e) {
        if (t || (t = "default"), "function" == typeof e) return t;
        if (e instanceof l ? t = e.sys.settings.key : "object" == _typeof(e) && e.hasOwnProperty("key") && (t = e.key), this.keys.hasOwnProperty(t)) throw new Error("Cannot add a Scene with duplicate key: " + t);
        return t;
      },
      getScenes: function getScenes(t, e) {
      ...
      getScene: function getScene(t) {
        if ("string" == typeof t) {
          if (this.keys[t]) return this.keys[t];
        } else for (var e = 0; e < this.scenes.length; e++) {
      ...
      start: function start(t, e) {
        ...
        if (i) {
          var n;
          if (i.sys.isActive() || i.sys.isPaused()) i.sys.shutdown(), i.sys.start(e);else if (i.sys.start(e), i.sys.load && (n = i.sys.load), n && i.sys.settings.hasOwnProperty("pack") && (n.reset(), n.addPack({
            payload: i.sys.settings.pack
          }))) return i.sys.settings.status = s.LOADING, n.once(h.COMPLETE, this.payloadComplete, this), n.start(), this;
          this.bootScene(i);
        }
      ...
      bringToTop: function bringToTop(t) {
        if (this.isProcessing) this._queue.push({
          ...
          if (-1 !== e && e < this.scenes.length) {
            var i = this.getScene(t);
            this.scenes.splice(e, 1), this.scenes.push(i);
          }
        }
        return this;
      },
      sendToBack: function sendToBack(t) {
        if (this.isProcessing) this._queue.push({
          ...
          if (-1 !== e && e > 0) {
            var i = this.getScene(t);
            this.scenes.splice(e, 1), this.scenes.unshift(i);
          }
        }
        return this;
      },
        ...
        if (this.isProcessing) this._queue.push({
          ...
          if (e > 0) {
            var i = e - 1,
                n = this.getScene(t),
                s = this.getAt(i);
            this.scenes[e] = s, this.scenes[i] = n;
          }
        }
        return this;
      },
      ...
      moveAbove: function moveAbove(t, e) {
        if (t === e) return this;
        if (this.isProcessing) this._queue.push({
          op: "moveAbove",
          keyA: t,
          ...
          if (-1 !== i && -1 !== n) {
            var s = this.getAt(n);
            this.scenes.splice(n, 1), this.scenes.splice(i + 1, 0, s);
          }
        }
        return this;
      },
      moveBelow: function moveBelow(t, e) {
        if (t === e) return this;
        if (this.isProcessing) this._queue.push({
          op: "moveBelow",
          keyA: t,
          ...
          if (-1 !== i && -1 !== n) {
            var s = this.getAt(n);
            this.scenes.splice(n, 1), 0 === i ? this.scenes.unshift(s) : this.scenes.splice(i, 0, s);
          }
        }
        return this;
      },
      queueOp: function queueOp(t, e, i) {
      ...
      swapPosition: function swapPosition(t, e) {
        if (t === e) return this;
        if (this.isProcessing) this._queue.push({
          op: "swapPosition",
          keyA: t,
          ...
          if (i !== n && -1 !== i && -1 !== n) {
            var s = this.getAt(i);
            this.scenes[i] = this.scenes[n], this.scenes[n] = s;
          }
        }
        return this;
      },
    ...
    var n = i(0),
        ...
        r = new n({
      initialize: function initialize(t) {
        this.sys = new s(this, t), this.game, this.anims, this.cache, this.registry, this.sound, this.textures, this.events, this.cameras, this.add, this.make, this.scene, this.children, this.lights, this.data, this.input, this.load, this.time, this.tweens, this.physics, this.impact, this.matter, this.scale, this.plugins;
      },
      update: function update() {}
    });
    t.exports = r;
    ...
    var n = i(17),
      ...
      getBase64: function getBase64(t, e, i, s) {
        void 0 === i && (i = "image/png"), void 0 === s && (s = .92);
        var r = "",
            o = this.getFrame(t, e);
        if (o && (o.source.isRenderTexture || o.source.isGLTexture)) console.warn("Cannot getBase64 from WebGL Texture");else if (o) {
          var a = o.canvasData,
              h = n.create2D(this, a.width, a.height);
          h.getContext("2d").drawImage(o.source.image, a.x, a.y, a.width, a.height, 0, 0, a.width, a.height), r = h.toDataURL(i, s), n.remove(h);
        }
        return r;
      },
      addImage: function addImage(t, e, i) {
        var n = null;
        return this.checkKey(t) && (n = this.create(t, e), f.Image(n, 0), i && n.setDataSource(i), this.emit(u.ADD, t, n)), n;
      },
      addGLTexture: function addGLTexture(t, e, i, n) {
        var s = null;
        return this.checkKey(t) && ((s = this.create(t, e, i, n)).add("__BASE", 0, 0, 0, i, n), this.emit(u.ADD, t, s)), s;
      },
      addRenderTexture: function addRenderTexture(t, e) {
        var i = null;
      ...
      addCanvas: function addCanvas(t, e, i) {
        void 0 === i && (i = !1);
        var n = null;
      ...
      addAtlas: function addAtlas(t, e, i, n) {
        return Array.isArray(i.textures) || Array.isArray(i.frames) ? this.addAtlasJSONArray(t, e, i, n) : this.addAtlasJSONHash(t, e, i, n);
      },
      addAtlasJSONArray: function addAtlasJSONArray(t, e, i, n) {
        var s = null;

        if (this.checkKey(t)) {
          if (s = this.create(t, e), Array.isArray(i)) for (var r = 1 === i.length, o = 0; o < s.source.length; o++) {
            var a = r ? i[0] : i[o];
            f.JSONArray(s, o, a);
      ...
      addAtlasJSONHash: function addAtlasJSONHash(t, e, i, n) {
        var s = null;

        if (this.checkKey(t)) {
          if (s = this.create(t, e), Array.isArray(i)) for (var r = 0; r < i.length; r++) {
            f.JSONHash(s, r, i[r]);
      ...
      addSpriteSheet: function addSpriteSheet(t, e, i) {
        ...
        if (this.checkKey(t)) {
          var s = (n = this.create(t, e)).source[0].width,
              r = n.source[0].height;
          f.SpriteSheet(n, 0, 0, 0, s, r, i), this.emit(u.ADD, t, n);
        }
      ...
      getTextureKeys: function getTextureKeys() {
        ...
        for (var e in this.list) {
          "__DEFAULT" !== e && "__MISSING" !== e && t.push(e);
        }
      ...
      getPixelAlpha: function getPixelAlpha(t, e, i, n) {
        var s = this.getFrame(i, n);
      ...
      renameTexture: function renameTexture(t, e) {
        var i = this.get(t);
    ...
    var n = i(0),
      ...
      draw: function draw(t, e, i) {
        return this.context.drawImage(i, t, e), this.update();
      },
      drawFrame: function drawFrame(t, e, i, n) {
      ...
      setPixel: function setPixel(t, e, i, n, s, r) {
        if (void 0 === r && (r = 255), t = Math.abs(Math.floor(t)), e = Math.abs(Math.floor(e)), this.getIndex(t, e) > -1) {
          var o = this.context.getImageData(t, e, 1, 1);
          o.data[0] = i, o.data[1] = n, o.data[2] = s, o.data[3] = r, this.context.putImageData(o, t, e);
        }

        return this;
      },
      putData: function putData(t, e, i, n, s, r, o) {
        return void 0 === n && (n = 0), void 0 === s && (s = 0), void 0 === r && (r = t.width), void 0 === o && (o = t.height), this.context.putImageData(t, e, i, n, s, r, o), this;
      },
      getData: function getData(t, e, i, n) {
      ...
      getPixel: function getPixel(t, e, i) {
        i || (i = new r());
      ...
      getPixels: function getPixels(t, e, i, n) {
      ...
      clear: function clear(t, e, i, n) {
        return void 0 === t && (t = 0), void 0 === e && (e = 0), void 0 === i && (i = this.width), void 0 === n && (n = this.height), this.context.clearRect(t, e, i, n), this.update();
      },
      setSize: function setSize(t, e) {
        return void 0 === e && (e = t), t === this.width && e === this.height || (this.canvas.width = t, this.canvas.height = e, this._source.width = t, this._source.height = e, this._source.isPowerOf2 = a(t, e), this.frames.__BASE.setSize(t, e, 0, 0), this.refresh()), this;
      },
      destroy: function destroy() {
    ...
    var n = i(263),
      ...
      create: function create(t) {
        var e = t.config.audio,
            i = t.device.audio;
        return e && e.noAudio || !i.webAudio && !i.audioData ? new s(t) : !i.webAudio || e && e.disableWebAudio ? new n(t) : new r(t);
      }
    };
    t.exports = o;
  }, function (t, e, i) {
    var n = i(77),
      ...
      unlock: function unlock() {
        ...
        if (this.game.cache.audio.entries.each(function (e, i) {
          for (var n = 0; n < i.length; n++) {
            if ("true" === i[n].dataset.locked) return t.locked = !0, !1;
          }
          ...
          var e = !1,
            ...
            e = !0;
              ...
              n = function n() {
            if (e) e = !1;else {
              document.body.removeEventListener("touchmove", i), document.body.removeEventListener("touchend", n);
              var s = [];

              if (t.game.cache.audio.entries.each(function (t, e) {
                for (var i = 0; i < e.length; i++) {
                  var n = e[i];
          ...
          }, this), document.body.addEventListener("touchmove", i, !1), document.body.addEventListener("touchend", n, !1);
        }
      },
      ...
      isLocked: function isLocked(t, e, i) {
    ...
    var n = i(78),
      ...
      pause: function pause() {
        return !this.manager.isLocked(this, "pause") && !(this.startTime > 0) && !!n.prototype.pause.call(this) && (this.currentConfig.seek = this.audio.currentTime - (this.currentMarker ? this.currentMarker.start : 0), this.stopAndReleaseAudioTag(), this.emit(r.PAUSE, this), !0);
      },
      resume: function resume() {
        return !this.manager.isLocked(this, "resume") && !(this.startTime > 0) && !!n.prototype.resume.call(this) && !!this.pickAndPlayAudioTag() && (this.emit(r.RESUME, this), !0);
      },
      stop: function stop() {
      ...
      pickAudioTag: function pickAudioTag() {
        ...
        var n = i[0];
        return this.audio = n.audio, n.reset(), n.audio = null, n.startTime = 0, n.previousTime = 0, !0;
      },
      ...
      stopAndReleaseAudioTag: function stopAndReleaseAudioTag() {
        this.audio.pause(), this.audio.dataset.used = "false", this.audio = null, this.startTime = 0, this.previousTime = 0;
      },
      reset: function reset() {
      ...
      updateVolume: function updateVolume() {
        this.audio && (this.audio.volume = this.currentConfig.volume * this.manager.volume);
      },
      calculateRate: function calculateRate() {
      ...
      seek: {
        ...
        set: function set(t) {
          this.manager.isLocked(this, "seek", t) || this.startTime > 0 || (this.isPlaying || this.isPaused) && (t = Math.min(Math.max(0, t), this.duration), this.isPlaying ? (this.previousTime = t, this.audio.currentTime = t) : this.isPaused && (this.currentConfig.seek = t), this.emit(r.SEEK, this, t));
        }
      },
      setSeek: function setSeek(t) {
    ...
    var n = i(78),
      ...
      destroy: function destroy() {
        this.manager.remove(this), n.prototype.destroy.call(this);
      }
    });
    t.exports = a;
  }, function (t, e, i) {
    var n = i(268),
      ...
      setAudioContext: function setAudioContext(t) {
      ...
      decodeAudio: function decodeAudio(t, e) {
        var i;
        i = Array.isArray(t) ? t : [{
          key: t,
          data: e
        ...
        for (var s = this.game.cache.audio, r = i.length, a = 0; a < i.length; a++) {
          var h = i[a],
              u = h.key,
              l = h.data;
      ...
      unlock: function unlock() {
        var t = this,
            e = document.body,
            i = function i() {
          t.context && t.context.resume().then(function () {
            e.removeEventListener("touchstart", i), e.removeEventListener("touchend", i), e.removeEventListener("click", i), e.removeEventListener("keydown", i), t.unlocked = !0;
          }, function () {
            e.removeEventListener("touchstart", i), e.removeEventListener("touchend", i), e.removeEventListener("click", i), e.removeEventListener("keydown", i);
          });
        };

        e && (e.addEventListener("touchstart", i, !1), e.addEventListener("touchend", i, !1), e.addEventListener("click", i, !1), e.addEventListener("keydown", i, !1));
      },
      onBlur: function onBlur() {
      ...
      destroy: function destroy() {
        if (this.destination = null, this.masterVolumeNode.disconnect(), this.masterVolumeNode = null, this.masterMuteNode.disconnect(), this.masterMuteNode = null, this.game.config.audio && this.game.config.audio.context) this.context.suspend();else {
          var t = this;
    ...
    for (var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = new Uint8Array(256), s = 0; s < i.length; s++) {
      n[i.charCodeAt(s)] = s;
    }
    ...
    t.exports = function (t) {
      var e,
          ...
          s,
          r,
          o = (t = t.substr(t.indexOf(",") + 1)).length,
          a = .75 * o,
          h = 0;
      "=" === t[o - 1] && (a--, "=" === t[o - 2] && a--);

      for (var u = new ArrayBuffer(a), l = new Uint8Array(u), c = 0; c < o; c += 4) {
        e = n[t.charCodeAt(c)], i = n[t.charCodeAt(c + 1)], s = n[t.charCodeAt(c + 2)], r = n[t.charCodeAt(c + 3)], l[h++] = e << 2 | i >> 4, l[h++] = (15 & i) << 4 | s >> 2, l[h++] = (3 & s) << 6 | 63 & r;
      }
    ...
    var n = i(78),
      ...
      getLoopTime: function getLoopTime() {
        for (var t = 0, e = 0; e < this.rateUpdates.length - 1; e++) {
          t += (this.rateUpdates[e + 1].time - this.rateUpdates[e].time) * this.rateUpdates[e].rate;
        }
    ...
    t.exports = {
      ...
      AddAt: i(739),
      BringToTop: i(740),
      CountAllMatching: i(741),
      Each: i(742),
      EachInRange: i(743),
      FindClosestInSorted: i(156),
      GetAll: i(744),
      GetFirst: i(745),
      GetRandom: i(746),
      MoveDown: i(747),
      ...
      MoveUp: i(749),
      NumberArray: i(750),
      NumberArrayStep: i(751),
      QuickSelect: i(272),
      Range: i(273),
      Remove: i(108),
      RemoveAt: i(752),
      RemoveBetween: i(753),
      RemoveRandomElement: i(754),
      Replace: i(755),
      RotateLeft: i(178),
      RotateRight: i(179),
      SafeRange: i(45),
    ...
    var s = function s(t, e, r, o, a) {
      for (void 0 === r && (r = 0), void 0 === o && (o = t.length - 1), void 0 === a && (a = n); o > r;) {
        if (o - r > 600) {
          var h = o - r + 1,
              u = e - r + 1,
              l = Math.log(h),
              c = .5 * Math.exp(2 * l / 3),
              d = .5 * Math.sqrt(l * c * (h - c) / h) * (u - h / 2 < 0 ? -1 : 1),
              f = Math.max(r, Math.floor(e - u * c / h + d)),
              p = Math.min(o, Math.floor(e + (h - u) * c / h + d));
          s(t, e, f, p, a);
        }
        ...
        for (i(t, r, e), a(t[o], g) > 0 && i(t, r, o); v < m;) {
          for (i(t, v, m), v++, m--; a(t[v], g) < 0;) {
            v++;
          }
    ...
    t.exports = function (t, e, i) {
      var o = n(i, "max", 0),
          ...
          c = n(i, "yoyo", !1),
          d = [];
      if (u && s(e), -1 === l) if (0 === o) l = 0;else {
        var f = t.length * e.length * a;
        c && (f *= 2), l = Math.ceil(o / f);
      }

      for (var p = 0; p <= l; p++) {
        var g = r(t, e, a);
        h && s(g), d = d.concat(g), c && (g.reverse(), d = d.concat(g));
      }
    ...
    t.exports = function (t, e) {
      ...
      if (null === i) return t;
      if ("string" == typeof i) t.anims.play(i);else if ("object" == _typeof(i)) {
        var s = t.anims,
            r = n(i, "key", void 0),
            o = n(i, "startFrame", void 0),
            a = n(i, "delay", 0),
            h = n(i, "repeat", 0),
            u = n(i, "repeatDelay", 0),
            l = n(i, "yoyo", !1),
            c = n(i, "play", !1),
            d = n(i, "delayedPlay", 0);
        s.setDelay(a), s.setRepeat(h), s.setRepeatDelay(u), s.setYoyo(l), c ? s.play(r, o) : d > 0 ? s.delayedPlay(d, r, o) : s.load(r);
      }
      return t;
    };
  }, function (t, e, i) {
    ...
    var n = i(280),
      ...
      initialize: function initialize(t, e) {
        ...
        for (var i = [], r = 0; r < e.buttons.length; r++) {
          i.push(new s(this, r));
        }
      ...
      getAxisValue: function getAxisValue(t) {
        return this.axes[t].getValue();
      },
      setAxisThreshold: function setAxisThreshold(t) {
        for (var e = 0; e < this.axes.length; e++) {
          this.axes[e].threshold = t;
        }
      },
      getButtonTotal: function getButtonTotal() {
        return this.buttons.length;
      },
      getButtonValue: function getButtonValue(t) {
        return this.buttons[t].value;
      },
      isButtonDown: function isButtonDown(t) {
      ...
      update: function update(t) {
        ...
        for (e = 0; e < s; e++) {
          i[e].update(n[e].value);
        }

        var r = this.axes,
            o = t.axes;

        for (s = r.length, e = 0; e < s; e++) {
          r[e].update(o[e]);
        }

        s >= 2 && (this.leftStick.set(r[0].getValue(), r[1].getValue()), s >= 4 && this.rightStick.set(r[2].getValue(), r[3].getValue()));
      },
      destroy: function destroy() {
        var t;

        for (this.removeAllListeners(), this.manager = null, this.pad = null, t = 0; t < this.buttons.length; t++) {
    ...
    var n = i(0),
      ...
      setEmitOnRepeat: function setEmitOnRepeat(t) {
    ...
    t.exports = function (t, e) {
      ...
      return s.open("GET", t.src, i.async, i.user, i.password), s.responseType = t.xhrSettings.responseType, s.timeout = i.timeout, i.header && i.headerValue && s.setRequestHeader(i.header, i.headerValue), i.requestedWith && s.setRequestHeader("X-Requested-With", i.requestedWith), i.overrideMimeType && s.overrideMimeType(i.overrideMimeType), i.withCredentials && (s.withCredentials = !0), s.onload = t.onLoad.bind(t, s), s.onerror = t.onError.bind(t, s), s.onprogress = t.onProgress.bind(t), s.send(), s;
    };
  }, function (t, e, i) {
    var n = i(0),
        s = i(19),
      ...
      initialize: function initialize(t, e, i, n, s) {
        if (u(e)) {
          var o = e;
          e = a(o, "key"), n = a(o, "xhrSettings"), s = a(o, "context", s);
        }
      ...
      onProcess: function onProcess() {
        ...
        this.config.context.decodeAudioData(this.xhrLoader.response, function (e) {
          ...
          console.error("Error decoding audio: " + this.key + " - ", e ? e.message : null), t.onProcessError();
    ...
    l.create = function (t, e, i, n, s) {
      ...
      for (var i = 0; i < e.length; i++) {
        ...
        if (s = a(e[i], "type", s ? s[1] : "").toLowerCase(), t.device.audio[s]) return {
          url: n,
          type: s
        };
      }
      ...
      if (Array.isArray(t)) for (var h = 0; h < t.length; h++) {
        (s = l.create(this, t[h])) && this.addFile(s);
    ...
    var n = i(0),
      ...
      load: function load() {
        ...
        this.filesTotal = t, this.filesLoaded = 0, this.percentComplete = 0;

        for (var e = 0; e < t; e++) {
          var i = new Audio();
          i.dataset = {}, i.dataset.name = this.key + ("0" + e).slice(-2), i.dataset.used = "false", this.locked ? i.dataset.locked = "true" : (i.dataset.locked = "false", i.preload = "auto", i.oncanplaythrough = this.onProgress.bind(this), i.onerror = this.onError.bind(this)), this.data.push(i);
        }

        for (e = 0; e < this.data.length; e++) {
          (i = this.data[e]).src = a(this, this.loader.baseURL), this.locked || i.load();
        }
    ...
    var n = i(292),
      ...
      staticGroup: function staticGroup(t, e) {
    ...
    var n = i(86),
      ...
      initialize: function initialize(t, e, i, s) {
        if (i || s) {
          if (h(i)) s = i, i = null, s.internalCreateCallback = this.createCallbackHandler, s.internalRemoveCallback = this.removeCallbackHandler;else if (Array.isArray(i) && h(i[0])) {
            s = i[0];
            var u = this;
      ...
      createCallbackHandler: function createCallbackHandler(t) {
      ...
      removeCallbackHandler: function removeCallbackHandler(t) {
        t.body && this.world.disableBody(t);
      },
      setVelocity: function setVelocity(t, e, i) {
        void 0 === i && (i = 0);

        for (var n = this.getChildren(), s = 0; s < n.length; s++) {
          n[s].body.velocity.set(t + s * i, e + s * i);
        }

        return this;
      },
      setVelocityX: function setVelocityX(t, e) {
        void 0 === e && (e = 0);

        for (var i = this.getChildren(), n = 0; n < i.length; n++) {
          i[n].body.velocity.x = t + n * e;
        }

        return this;
      },
      setVelocityY: function setVelocityY(t, e) {
        void 0 === e && (e = 0);

        for (var i = this.getChildren(), n = 0; n < i.length; n++) {
          i[n].body.velocity.y = t + n * e;
        }
    ...
    var n = i(128),
        ...
        d = new s({
      initialize: function initialize(t, e, i) {
        i ? e && !Array.isArray(e) && (e = [e]) : Array.isArray(e) ? h(e[0]) && (i = e, e = null) : h(e) && (i = e, e = null), this.scene = t, this.children = new l(e), this.isParent = !0, this.type = "Group", this.classType = o(i, "classType", c), this.name = o(i, "name", ""), this.active = o(i, "active", !0), this.maxSize = o(i, "maxSize", -1), this.defaultKey = o(i, "defaultKey", null), this.defaultFrame = o(i, "defaultFrame", null), this.runChildUpdate = o(i, "runChildUpdate", !1), this.createCallback = o(i, "createCallback", null), this.removeCallback = o(i, "removeCallback", null), this.createMultipleCallback = o(i, "createMultipleCallback", null), this.internalCreateCallback = o(i, "internalCreateCallback", null), this.internalRemoveCallback = o(i, "internalRemoveCallback", null), i && this.createMultiple(i);
      },
      create: function create(t, e, i, n, s, r) {
      ...
      createMultiple: function createMultiple(t) {
        ...
        Array.isArray(t) || (t = [t]);
        var e = [];
        if (t[0].key) for (var i = 0; i < t.length; i++) {
      ...
      createFromConfig: function createFromConfig(t) {
        ...
        var _ = a(t, "setRotation.value", 0),
            A = a(t, "setRotation.step", 0);

        n.SetRotation(h, _, A);
        var b = a(t, "setScale.x", 1),
            O = a(t, "setScale.y", b),
            M = a(t, "setScale.stepX", 0),
            C = a(t, "setScale.stepY", 0);
        n.SetScale(h, b, O, M, C);
        var R = a(t, "setAlpha.value", 1),
            P = a(t, "setAlpha.step", 0);
        n.SetAlpha(h, R, P);
        var L = a(t, "setDepth.value", 0),
            k = a(t, "setDepth.step", 0);
        n.SetDepth(h, L, k);
        var D = a(t, "setScrollFactor.x", 1),
            F = a(t, "setScrollFactor.y", D),
            I = a(t, "setScrollFactor.stepX", 0),
            B = a(t, "setScrollFactor.stepY", 0);
        n.SetScrollFactor(h, D, F, I, B);
        var N = o(t, "hitArea", null),
            U = o(t, "hitAreaCallback", null);
        N && n.SetHitArea(h, N, U);
        var z = o(t, "gridAlign", !1);
        return z && n.GridAlign(h, z), this.createMultipleCallback && this.createMultipleCallback.call(this, h), h;
      },
      preUpdate: function preUpdate(t, e) {
        if (this.runChildUpdate && 0 !== this.children.size) for (var i = this.children.entries.slice(), n = 0; n < i.length; n++) {
          var s = i[n];
          s.active && s.update(t, e);
        }
      },
      add: function add(t, e) {
        return void 0 === e && (e = !1), this.isFull() ? this : (this.children.set(t), this.internalCreateCallback && this.internalCreateCallback.call(this, t), this.createCallback && this.createCallback.call(this, t), e && (this.scene.sys.displayList.add(t), t.preUpdate && this.scene.sys.updateList.add(t)), t.on(r.DESTROY, this.remove, this), this);
      },
      addMultiple: function addMultiple(t, e) {
        if (void 0 === e && (e = !1), Array.isArray(t)) for (var i = 0; i < t.length; i++) {
          this.add(t[i], e);
        }
        return this;
      },
      remove: function remove(t, e, i) {
      ...
      getFirst: function getFirst(t, e, i, n, s, r, o) {
        return this.getHandler(!0, 1, t, e, i, n, s, r, o);
      },
      getFirstNth: function getFirstNth(t, e, i, n, s, r, o, a) {
        return this.getHandler(!0, t, e, i, n, s, r, o, a);
      },
      getLast: function getLast(t, e, i, n, s, r, o) {
        return this.getHandler(!1, 1, t, e, i, n, s, r, o);
      },
      getLastNth: function getLastNth(t, e, i, n, s, r, o, a) {
        return this.getHandler(!1, t, e, i, n, s, r, o, a);
      },
      getHandler: function getHandler(t, e, i, n, s, r, o, a, h) {
        var u, l;
        void 0 === i && (i = !1), void 0 === n && (n = !1);
        var c = 0,
            d = this.children.entries;
        if (t) for (l = 0; l < d.length; l++) {
          if ((u = d[l]).active === i) {
            if (++c === e) break;
          } else u = null;
        } else for (l = d.length - 1; l >= 0; l--) {
          if ((u = d[l]).active === i) {
            if (++c === e) break;
          } else u = null;
        }
      ...
      get: function get(t, e, i, n, s) {
        return this.getFirst(!1, !0, t, e, i, n, s);
      },
      getFirstAlive: function getFirstAlive(t, e, i, n, s, r) {
        return this.getFirst(!0, t, e, i, n, s, r);
      },
      getFirstDead: function getFirstDead(t, e, i, n, s, r) {
      ...
      countActive: function countActive(t) {
        void 0 === t && (t = !0);
      ...
      propertyValueSet: function propertyValueSet(t, e, i, s, r) {
        return n.PropertyValueSet(this.children.entries, t, e, i, s, r), this;
      },
      propertyValueInc: function propertyValueInc(t, e, i, s, r) {
      ...
      setHitArea: function setHitArea(t, e) {
      ...
      setVisible: function setVisible(t, e, i) {
    ...
    var n = i(86),
      ...
      refresh: function refresh() {
        for (var t = this.children.entries, e = 0; e < t.length; e++) {
          t[e].body.reset();
        }
    ...
    t.exports = function (t, e, i, n, s, r, o) {
      ...
      var a = [],
          h = [],
          u = t.treeMinMax;
      if (u.minX = e, u.minY = i, u.maxX = e + n, u.maxY = i + s, o && (h = t.staticTree.search(u)), r && t.useTree) a = t.tree.search(u);else if (r) {
        var l = t.bodies,
            c = {
          position: {
            x: e,
    ...
    var n = i(298),
      ...
      Extends: u,
      initialize: function initialize(t, e) {
        u.call(this), this.scene = t, this.bodies = new _(), this.staticBodies = new _(), this.pendingDestroy = new _(), this.colliders = new m(), this.gravity = new M(v(e, "gravity.x", 0), v(e, "gravity.y", 0)), this.bounds = new x(v(e, "x", 0), v(e, "y", 0), v(e, "width", t.sys.scale.width), v(e, "height", t.sys.scale.height)), this.checkCollision = {
          up: v(e, "checkCollision.up", !0),
          down: v(e, "checkCollision.down", !0),
          left: v(e, "checkCollision.left", !0),
          right: v(e, "checkCollision.right", !0)
        }, this.fps = v(e, "fps", 60), this._elapsed = 0, this._frameTime = 1 / this.fps, this._frameTimeMS = 1e3 * this._frameTime, this.stepsLastFrame = 0, this.timeScale = v(e, "timeScale", 1), this.OVERLAP_BIAS = v(e, "overlapBias", 4), this.TILE_BIAS = v(e, "tileBias", 16), this.forceX = v(e, "forceX", !1), this.isPaused = v(e, "isPaused", !1), this._total = 0, this.drawDebug = v(e, "debug", !1), this.debugGraphic, this.defaults = {
          debugShowBody: v(e, "debugShowBody", !0),
          debugShowStaticBody: v(e, "debugShowStaticBody", !0),
          debugShowVelocity: v(e, "debugShowVelocity", !0),
          bodyDebugColor: v(e, "debugBodyColor", 16711935),
          staticBodyDebugColor: v(e, "debugStaticBodyColor", 255),
          velocityDebugColor: v(e, "debugVelocityColor", 65280)
      ...
      enable: function enable(t, e) {
        void 0 === e && (e = a.DYNAMIC_BODY), Array.isArray(t) || (t = [t]);

        for (var i = 0; i < t.length; i++) {
          var n = t[i];
          if (n.isParent) for (var s = n.getChildren(), r = 0; r < s.length; r++) {
            var o = s[r];
            o.isParent ? this.enable(o, e) : this.enableBody(o, e);
          } else this.enableBody(n, e);
        }
      },
      enableBody: function enableBody(t, e) {
        return void 0 === e && (e = a.DYNAMIC_BODY), t.body || (e === a.DYNAMIC_BODY ? t.body = new n(this, t) : e === a.STATIC_BODY && (t.body = new A(this, t))), this.add(t.body), t;
      },
      add: function add(t) {
        return t.physicsType === a.DYNAMIC_BODY ? this.bodies.set(t) : t.physicsType === a.STATIC_BODY && (this.staticBodies.set(t), this.staticTree.insert(t)), t.enable = !0, t;
      },
      disable: function disable(t) {
        Array.isArray(t) || (t = [t]);
        ...
        for (var e = 0; e < t.length; e++) {
          var i = t[e];
          if (i.isParent) for (var n = i.getChildren(), s = 0; s < n.length; s++) {
            var r = n[s];
            r.isParent ? this.disable(r) : this.disableBody(r.body);
          } else this.disableBody(i.body);
        }
      },
      disableBody: function disableBody(t) {
        this.remove(t), t.enable = !1;
      },
      remove: function remove(t) {
        t.physicsType === a.DYNAMIC_BODY ? (this.tree.remove(t), this.bodies.delete(t)) : t.physicsType === a.STATIC_BODY && (this.staticBodies.delete(t), this.staticTree.remove(t));
      },
      ...
      setBounds: function setBounds(t, e, i, n, s, r, o, a) {
        return this.bounds.setTo(t, e, i, n), void 0 !== s && this.setBoundsCollision(s, r, o, a), this;
      },
      setBoundsCollision: function setBoundsCollision(t, e, i, n) {
      ...
      pause: function pause() {
        return this.isPaused = !0, this.emit(l.PAUSE), this;
      },
      resume: function resume() {
        return this.isPaused = !1, this.emit(l.RESUME), this;
      },
      addCollider: function addCollider(t, e, i, n, s) {
        void 0 === i && (i = null), void 0 === n && (n = null), void 0 === s && (s = i);
        var r = new o(this, !1, t, e, i, n, s);
        return this.colliders.add(r), r;
      },
      addOverlap: function addOverlap(t, e, i, n, s) {
        void 0 === i && (i = null), void 0 === n && (n = null), void 0 === s && (s = i);
        var r = new o(this, !0, t, e, i, n, s);
        return this.colliders.add(r), r;
      },
      removeCollider: function removeCollider(t) {
      ...
      update: function update(t, e) {
        if (!this.isPaused && 0 !== this.bodies.size) {
          var i,
              n,
              s = this._frameTime,
              r = this._frameTimeMS * this.timeScale;
          this._elapsed += e;
          var o = this.bodies.entries,
              a = this._elapsed >= r;

          for (i = 0; i < o.length; i++) {
            (n = o[i]).enable && n.preUpdate(a, s);
          }

          if (a) {
            this._elapsed -= r, this.stepsLastFrame = 1, this.useTree && (this.tree.clear(), this.tree.load(o));
            var h = this.colliders.update();
            ...
            this.emit(l.WORLD_STEP);
          }

          for (; this._elapsed >= r;) {
            this._elapsed -= r, this.step(s);
          }
        }
      },
      step: function step(t) {
        var e,
            i,
            n = this.bodies.entries,
            s = n.length;

        for (e = 0; e < s; e++) {
          (i = n[e]).enable && i.update(t);
        }

        this.useTree && (this.tree.clear(), this.tree.load(n));
        ...
        this.emit(l.WORLD_STEP), this.stepsLastFrame++;
      },
      postUpdate: function postUpdate() {
        var t,
            e,
            i = this.bodies.entries,
            n = i.length,
            s = this.bodies,
            r = this.staticBodies;
        if (this.stepsLastFrame) for (this.stepsLastFrame = 0, t = 0; t < n; t++) {
          (e = i[t]).enable && e.postUpdate();
        }

        if (this.drawDebug) {
          var o = this.debugGraphic;

          for (o.clear(), t = 0; t < n; t++) {
            (e = i[t]).willDrawDebug() && e.drawDebug(o);
          }

          for (n = (i = r.entries).length, t = 0; t < n; t++) {
            (e = i[t]).willDrawDebug() && e.drawDebug(o);
          }
        }
        ...
        if (h.size > 0) {
          ...
          for (n = (i = h.entries).length, t = 0; t < n; t++) {
            (e = i[t]).physicsType === a.DYNAMIC_BODY ? (u.remove(e), s.delete(e)) : e.physicsType === a.STATIC_BODY && (l.remove(e), r.delete(e)), e.world = void 0, e.gameObject = void 0;
          }

          h.clear();
        }
      },
      updateMotion: function updateMotion(t, e) {
        t.allowRotation && this.computeAngularVelocity(t, e), this.computeVelocity(t, e);
      },
      computeAngularVelocity: function computeAngularVelocity(t, e) {
        var i = t.angularVelocity,
            n = t.angularAcceleration,
            r = t.angularDrag,
            o = t.maxAngular;
        n ? i += n * e : t.allowDrag && r && (d(i - (r *= e), 0, .1) ? i -= r : f(i + r, 0, .1) ? i += r : i = 0);
        var a = (i = s(i, -o, o)) - t.angularVelocity;
        t.angularVelocity += a, t.rotation += t.angularVelocity * e;
      },
      computeVelocity: function computeVelocity(t, e) {
        var i = t.velocity.x,
            n = t.acceleration.x,
            r = t.drag.x,
            o = t.maxVelocity.x,
            ...
            v = t.allowDrag,
            m = t.useDamping;
        t.allowGravity && (i += (this.gravity.x + t.gravity.x) * e, a += (this.gravity.y + t.gravity.y) * e), n ? i += n * e : v && r && (m ? (i *= r, p = Math.sqrt(i * i + a * a), c(p, 0, .001) && (i = 0)) : d(i - (r *= e), 0, .01) ? i -= r : f(i + r, 0, .01) ? i += r : i = 0), h ? a += h * e : v && u && (m ? (a *= u, p = Math.sqrt(i * i + a * a), c(p, 0, .001) && (a = 0)) : d(a - (u *= e), 0, .01) ? a -= u : f(a + u, 0, .01) ? a += u : a = 0), i = s(i, -o, o), a = s(a, -l, l), t.velocity.set(i, a), g > -1 && p > g && (t.velocity.normalize().scale(g), p = g), t.speed = p;
      },
      separate: function separate(t, e, i, n, s) {
        ...
        var u = !1,
            c = !1;
        this.forceX || Math.abs(this.gravity.y + t.gravity.y) < Math.abs(this.gravity.x + t.gravity.x) ? (u = E(t, e, s, this.OVERLAP_BIAS), this.intersects(t, e) && (c = S(t, e, s, this.OVERLAP_BIAS))) : (c = S(t, e, s, this.OVERLAP_BIAS), this.intersects(t, e) && (u = E(t, e, s, this.OVERLAP_BIAS)));
        var d = u || c;
        return d && (s ? (t.onOverlap || e.onOverlap) && this.emit(l.OVERLAP, t.gameObject, e.gameObject, t, e) : (t.onCollide || e.onCollide) && this.emit(l.COLLIDE, t.gameObject, e.gameObject, t, e)), d;
      },
      separateCircle: function separateCircle(t, e, i, n) {
        p(t, e, !1, n), g(t, e, !1, n);
        var s = 0;
        ...
        if (t.isCircle !== e.isCircle) {
          ...
          o.y < r.y ? o.x < r.x ? s = h(o.x, o.y, r.x, r.y) - o.radius : o.x > r.right && (s = h(o.x, o.y, r.right, r.y) - o.radius) : o.y > r.bottom && (o.x < r.x ? s = h(o.x, o.y, r.x, r.bottom) - o.radius : o.x > r.right && (s = h(o.x, o.y, r.right, r.bottom) - o.radius)), s *= -1;
        } else s = t.halfWidth + e.halfWidth - h(t.center.x, t.center.y, e.center.x, e.center.y);

        if (i || 0 === s || t.immovable && e.immovable || t.customSeparateX || e.customSeparateX) return 0 !== s && (t.onOverlap || e.onOverlap) && this.emit(l.OVERLAP, t.gameObject, e.gameObject, t, e), 0 !== s;
        var a = t.center.x - e.center.x,
            u = t.center.y - e.center.y,
            c = Math.sqrt(Math.pow(a, 2) + Math.pow(u, 2)),
            d = (e.center.x - t.center.x) / c || 0,
            f = (e.center.y - t.center.y) / c || 0,
            v = 2 * (t.velocity.x * d + t.velocity.y * f - e.velocity.x * d - e.velocity.y * f) / (t.mass + e.mass);
        t.immovable || (t.velocity.x = t.velocity.x - v * t.mass * d, t.velocity.y = t.velocity.y - v * t.mass * f), e.immovable || (e.velocity.x = e.velocity.x + v * e.mass * d, e.velocity.y = e.velocity.y + v * e.mass * f);
        var m = e.velocity.x - t.velocity.x,
            y = e.velocity.y - t.velocity.y,
            x = Math.atan2(y, m),
            T = this._frameTime;
        return t.immovable || e.immovable || (s /= 2), t.immovable || (t.x += t.velocity.x * T - s * Math.cos(x), t.y += t.velocity.y * T - s * Math.sin(x)), e.immovable || (e.x += e.velocity.x * T + s * Math.cos(x), e.y += e.velocity.y * T + s * Math.sin(x)), t.velocity.x *= t.bounce.x, t.velocity.y *= t.bounce.y, e.velocity.x *= e.bounce.x, e.velocity.y *= e.bounce.y, (t.onCollide || e.onCollide) && this.emit(l.COLLIDE, t.gameObject, e.gameObject, t, e), !0;
      },
      intersects: function intersects(t, e) {
        return t !== e && (t.isCircle || e.isCircle ? t.isCircle ? e.isCircle ? h(t.center.x, t.center.y, e.center.x, e.center.y) <= t.halfWidth + e.halfWidth : this.circleBodyIntersects(t, e) : this.circleBodyIntersects(e, t) : !(t.right <= e.position.x || t.bottom <= e.position.y || t.position.x >= e.right || t.position.y >= e.bottom));
      },
      circleBodyIntersects: function circleBodyIntersects(t, e) {
        var i = s(t.center.x, e.left, e.right),
            n = s(t.center.y, e.top, e.bottom);
      ...
      collide: function collide(t, e, i, n, s) {
        return void 0 === i && (i = null), void 0 === n && (n = null), void 0 === s && (s = i), this.collideObjects(t, e, i, n, s, !1);
      },
      collideObjects: function collideObjects(t, e, i, n, s, r) {
        var o, a;
        ...
        var h = Array.isArray(t),
            u = Array.isArray(e);
        if (this._total = 0, h || u) {
          if (!h && u) for (o = 0; o < e.length; o++) {
            this.collideHandler(t, e[o], i, n, s, r);
          } else if (h && !u) {
            if (e) for (o = 0; o < t.length; o++) {
              this.collideHandler(t[o], e, i, n, s, r);
            } else for (o = 0; o < t.length; o++) {
              var l = t[o];

              for (a = o + 1; a < t.length; a++) {
                o !== a && this.collideHandler(l, t[a], i, n, s, r);
              }
            }
          } else for (o = 0; o < t.length; o++) {
            for (a = 0; a < e.length; a++) {
              this.collideHandler(t[o], e[a], i, n, s, r);
            }
          }
        } else this.collideHandler(t, e, i, n, s, r);
        return this._total > 0;
      },
      collideHandler: function collideHandler(t, e, i, n, s, r) {
      ...
      collideSpriteVsSprite: function collideSpriteVsSprite(t, e, i, n, s, r) {
        return !(!t.body || !e.body) && (this.separate(t.body, e.body, n, s, r) && (i && i.call(s, t, e), this._total++), !0);
      },
      collideSpriteVsGroup: function collideSpriteVsGroup(t, e, i, n, s, r) {
        var o,
            h,
            u,
            l = t.body;
        if (0 !== e.length && l && l.enable) if (this.useTree) {
          var c = this.treeMinMax;
          c.minX = l.left, c.minY = l.top, c.maxX = l.right, c.maxY = l.bottom;
          var d = e.physicsType === a.DYNAMIC_BODY ? this.tree.search(c) : this.staticTree.search(c);

          for (h = d.length, o = 0; o < h; o++) {
            l !== (u = d[o]) && u.enable && e.contains(u.gameObject) && this.separate(l, u, n, s, r) && (i && i.call(s, l.gameObject, u.gameObject), this._total++);
          }
        } else {
          var f = e.getChildren(),
              p = e.children.entries.indexOf(t);

          for (h = f.length, o = 0; o < h; o++) {
            (u = f[o].body) && o !== p && u.enable && this.separate(l, u, n, s, r) && (i && i.call(s, l.gameObject, u.gameObject), this._total++);
          }
        }
      },
      collideGroupVsTilemapLayer: function collideGroupVsTilemapLayer(t, e, i, n, s, r) {
        var o = t.getChildren();
        if (0 === o.length) return !1;

        for (var a = !1, h = 0; h < o.length; h++) {
          o[h].body && this.collideSpriteVsTilemapLayer(o[h], e, i, n, s, r) && (a = !0);
        }

        return a;
      },
      collideTiles: function collideTiles(t, e, i, n, s) {
        return !(!t.body.enable || 0 === e.length) && this.collideSpriteVsTilesHandler(t, e, i, n, s, !1, !1);
      },
      overlapTiles: function overlapTiles(t, e, i, n, s) {
        return !(!t.body.enable || 0 === e.length) && this.collideSpriteVsTilesHandler(t, e, i, n, s, !0, !1);
      },
      collideSpriteVsTilemapLayer: function collideSpriteVsTilemapLayer(t, e, i, n, s, r) {
        var o = t.body;
        ...
        if (c.tileWidth > c.baseTileWidth) {
          var d = (c.tileWidth - c.baseTileWidth) * e.scaleX;
          a -= d, u += d;
        }

        c.tileHeight > c.baseTileHeight && (l += (c.tileHeight - c.baseTileHeight) * e.scaleY);
        var f = e.getTilesWithinWorldXY(a, h, u, l);
        return 0 !== f.length && this.collideSpriteVsTilesHandler(t, f, i, n, s, r, !0);
      },
      collideSpriteVsTilesHandler: function collideSpriteVsTilesHandler(t, e, i, n, s, r, o) {
        for (var a, h, u = t.body, c = {
          left: 0,
          right: 0,
          top: 0,
          bottom: 0
        }, d = !1, f = 0; f < e.length; f++) {
          h = (a = e[f]).tilemapLayer, c.left = h.tileToWorldX(a.x), c.top = h.tileToWorldY(a.y), a.baseHeight !== a.height && (c.top -= (a.height - a.baseHeight) * h.scaleY), c.right = c.left + a.width * h.scaleX, c.bottom = c.top + a.height * h.scaleY, b(c, u) && (!n || n.call(s, t, a)) && y(a, t) && (r || w(f, u, a, c, h, this.TILE_BIAS, o)) && (this._total++, d = !0, i && i.call(s, t, a), r && u.onOverlap ? this.emit(l.TILE_OVERLAP, t, a, u) : u.onCollide && this.emit(l.TILE_COLLIDE, t, a, u));
        }

        return d;
      },
      collideGroupVsGroup: function collideGroupVsGroup(t, e, i, n, s, r) {
        if (0 !== t.length && 0 !== e.length) for (var o = t.getChildren(), a = 0; a < o.length; a++) {
          this.collideSpriteVsGroup(o[a], e, i, n, s, r);
        }
      },
      ...
      wrapArray: function wrapArray(t, e) {
        for (var i = 0; i < t.length; i++) {
          this.wrapObject(t[i], e);
        }
      },
      wrapObject: function wrapObject(t, e) {
        void 0 === e && (e = 0), t.x = C(t.x, this.bounds.left - e, this.bounds.right + e), t.y = C(t.y, this.bounds.top - e, this.bounds.bottom + e);
      },
      shutdown: function shutdown() {
    ...
    var n = i(0),
        ...
        l = new n({
      initialize: function initialize(t, e) {
        var i = e.width ? e.width : 64,
            n = e.height ? e.height : 64;
      ...
      updateBounds: function updateBounds() {
        ...
        if (t.parentContainer) {
          var i = t.getWorldTransformMatrix(this.world._tempMatrix, this.world._tempMatrix2);
          e.x = i.tx, e.y = i.ty, e.rotation = o(i.rotation), e.scaleX = i.scaleX, e.scaleY = i.scaleY, e.displayOriginX = t.displayOriginX, e.displayOriginY = t.displayOriginY;
        } else e.x = t.x, e.y = t.y, e.rotation = t.angle, e.scaleX = t.scaleX, e.scaleY = t.scaleY, e.displayOriginX = t.displayOriginX, e.displayOriginY = t.displayOriginY;

        var n = !1;

        if (this.syncBounds) {
          var s = t.getBounds(this._bounds);
          this.width = s.width, this.height = s.height, n = !0;
        } else {
          var r = Math.abs(e.scaleX),
              a = Math.abs(e.scaleY);
          this._sx === r && this._sy === a || (this.width = this.sourceWidth * r, this.height = this.sourceHeight * a, this._sx = r, this._sy = a, n = !0);
        }

        n && (this.halfWidth = Math.floor(this.width / 2), this.halfHeight = Math.floor(this.height / 2), this.updateCenter());
      },
      updateCenter: function updateCenter() {
        this.center.set(this.position.x + this.halfWidth, this.position.y + this.halfHeight);
      },
      resetFlags: function resetFlags() {
        this.wasTouching.none = this.touching.none, this.wasTouching.up = this.touching.up, this.wasTouching.down = this.touching.down, this.wasTouching.left = this.touching.left, this.wasTouching.right = this.touching.right, this.touching.none = !0, this.touching.up = !1, this.touching.down = !1, this.touching.left = !1, this.touching.right = !1, this.blocked.none = !0, this.blocked.up = !1, this.blocked.down = !1, this.blocked.left = !1, this.blocked.right = !1, this.overlapR = 0, this.overlapX = 0, this.overlapY = 0, this.embedded = !1;
      },
      preUpdate: function preUpdate(t, e) {
        t && this.resetFlags(), this.updateBounds();
        var i = this.transform;
        this.position.x = i.x + i.scaleX * (this.offset.x - i.displayOriginX), this.position.y = i.y + i.scaleY * (this.offset.y - i.displayOriginY), this.updateCenter(), this.rotation = i.rotation, this.preRotation = this.rotation, this.moves && (this.prev.x = this.position.x, this.prev.y = this.position.y, this.prevFrame.x = this.position.x, this.prevFrame.y = this.position.y), t && this.update(e);
      },
      update: function update(t) {
        if (this.prev.x = this.position.x, this.prev.y = this.position.y, this.moves) {
          ...
          var e = this.velocity.x,
              i = this.velocity.y;
          this.newVelocity.set(e * t, i * t), this.position.add(this.newVelocity), this.updateCenter(), this.angle = Math.atan2(i, e), this.speed = Math.sqrt(e * e + i * i), this.collideWorldBounds && this.checkWorldBounds() && this.onWorldBounds && this.world.emit(r.WORLD_BOUNDS, this, this.blocked.up, this.blocked.down, this.blocked.left, this.blocked.right);
        }

        this._dx = this.position.x - this.prev.x, this._dy = this.position.y - this.prev.y;
      },
      postUpdate: function postUpdate() {
        var t = this.position.x - this.prevFrame.x,
            e = this.position.y - this.prevFrame.y;

        if (this.moves) {
          var i = this.deltaMax.x,
              n = this.deltaMax.y;
          0 !== i && 0 !== t && (t < 0 && t < -i ? t = -i : t > 0 && t > i && (t = i)), 0 !== n && 0 !== e && (e < 0 && e < -n ? e = -n : e > 0 && e > n && (e = n)), this.gameObject.x += t, this.gameObject.y += e;
        }

        t < 0 ? this.facing = s.FACING_LEFT : t > 0 && (this.facing = s.FACING_RIGHT), e < 0 ? this.facing = s.FACING_UP : e > 0 && (this.facing = s.FACING_DOWN), this.allowRotation && (this.gameObject.angle += this.deltaZ()), this._tx = t, this._ty = e;
      },
      setBoundsRectangle: function setBoundsRectangle(t) {
      ...
      checkWorldBounds: function checkWorldBounds() {
        var t = this.position,
            ...
            r = !1;
        return t.x < e.x && i.left ? (t.x = e.x, this.velocity.x *= n, this.blocked.left = !0, r = !0) : this.right > e.right && i.right && (t.x = e.right - this.width, this.velocity.x *= n, this.blocked.right = !0, r = !0), t.y < e.y && i.up ? (t.y = e.y, this.velocity.y *= s, this.blocked.up = !0, r = !0) : this.bottom > e.bottom && i.down && (t.y = e.bottom - this.height, this.velocity.y *= s, this.blocked.down = !0, r = !0), r && (this.blocked.none = !1), r;
      },
      setOffset: function setOffset(t, e) {
        return void 0 === e && (e = t), this.offset.set(t, e), this.updateCenter(), this;
      },
      setSize: function setSize(t, e, i) {
        void 0 === i && (i = !0);
        var n = this.gameObject;

        if (!t && n.frame && (t = n.frame.realWidth), !e && n.frame && (e = n.frame.realHeight), this.sourceWidth = t, this.sourceHeight = e, this.width = this.sourceWidth * this._sx, this.height = this.sourceHeight * this._sy, this.halfWidth = Math.floor(this.width / 2), this.halfHeight = Math.floor(this.height / 2), this.updateCenter(), i && n.getCenter) {
          var s = n.displayWidth / 2,
              r = n.displayHeight / 2;
          this.offset.set(s - this.halfWidth, r - this.halfHeight);
        }

        return this.isCircle = !1, this.radius = 0, this;
      },
      setCircle: function setCircle(t, e, i) {
        return void 0 === e && (e = this.offset.x), void 0 === i && (i = this.offset.y), t > 0 ? (this.isCircle = !0, this.radius = t, this.sourceWidth = 2 * t, this.sourceHeight = 2 * t, this.width = this.sourceWidth * this._sx, this.height = this.sourceHeight * this._sy, this.halfWidth = Math.floor(this.width / 2), this.halfHeight = Math.floor(this.height / 2), this.offset.set(e, i), this.updateCenter()) : this.isCircle = !1, this;
      },
      ...
      hitTest: function hitTest(t, e) {
        return this.isCircle ? this.radius > 0 && t >= this.left && t <= this.right && e >= this.top && e <= this.bottom && (this.center.x - t) * (this.center.x - t) + (this.center.y - e) * (this.center.y - e) <= this.radius * this.radius : h(this, t, e);
      },
      ...
      setCollideWorldBounds: function setCollideWorldBounds(t, e, i) {
      ...
      setVelocityX: function setVelocityX(t) {
        this.velocity.x = t;
        var e = t,
            i = this.velocity.y;
        return this.speed = Math.sqrt(e * e + i * i), this;
      },
    ...
    function s(t) {
      if (!(this instanceof s)) return new s(t, [".left", ".top", ".right", ".bottom"]);
    ...
    function a(t, e, i, n, s) {
      s || (s = g(null)), s.minX = 1 / 0, s.minY = 1 / 0, s.maxX = -1 / 0, s.maxY = -1 / 0;

      for (var r, o = e; o < i; o++) {
        r = t.children[o], h(s, t.leaf ? n(r) : r);
      }
    ...
    function v(t, e, i, s, r) {
      for (var o, a = [e, i]; a.length;) {
        (i = a.pop()) - (e = a.pop()) <= s || (o = e + Math.ceil((i - e) / s / 2) * s, n(t, o, e, i, r), a.push(e, o, o, i));
      }
    }

    s.prototype = (_s$prototype = {
      all: function all() {
      ...
      search: function search(t) {
        ...
        for (var s, r, o, a, h = []; e;) {
          for (s = 0, r = e.children.length; s < r; s++) {
            o = e.children[s], p(t, a = e.leaf ? n(o) : o) && (e.leaf ? i.push(o) : f(t, a) ? this._all(o, i) : h.push(o));
          }
      ...
      collides: function collides(t) {
        ...
        for (var n, s, r, o, a = []; e;) {
          for (n = 0, s = e.children.length; n < s; n++) {
            if (r = e.children[n], p(t, o = e.leaf ? i(r) : r)) {
      ...
      remove: function remove(t, e) {
        ...
        for (var i, n, s, o, a = this.data, h = this.toBBox(t), u = [], l = []; a || u.length;) {
          if (a || (a = u.pop(), n = u[u.length - 1], i = l.pop(), o = !0), a.leaf && -1 !== (s = r(t, a.children, e))) return a.children.splice(s, 1), u.push(a), this._condense(u), this;
          o || a.leaf || !f(a, h) ? n ? (i++, a = n.children[i], o = !1) : a = null : (u.push(a), l.push(i), i = 0, n = a, a = a.children[0]);
        }
      ...
      _build: function _build(t, e, i, n) {
        var s,
            r = i - e + 1,
            a = this._maxEntries;
        if (r <= a) return o(s = g(t.slice(e, i + 1)), this.toBBox), s;
        n || (n = Math.ceil(Math.log(r) / Math.log(a)), a = Math.ceil(r / Math.pow(a, n - 1))), (s = g([])).leaf = !1, s.height = n;
        var h,
            u,
            l,
            c,
        ...
        for (v(t, e, i, f, this.compareMinX), h = e; h <= i; h += f) {
          for (v(t, h, l = Math.min(h + f - 1, i), d, this.compareMinY), u = h; u <= l; u += d) {
            c = Math.min(u + d - 1, l), s.children.push(this._build(t, u, c, n - 1));
          }
        }
      ...
      _chooseSubtree: function _chooseSubtree(t, e, i, n) {
        for (var s, r, o, a, h, u, l, d, f, p; n.push(e), !e.leaf && n.length - 1 !== i;) {
          for (l = d = 1 / 0, s = 0, r = e.children.length; s < r; s++) {
            h = c(o = e.children[s]), f = t, p = o, (u = (Math.max(p.maxX, f.maxX) - Math.min(p.minX, f.minX)) * (Math.max(p.maxY, f.maxY) - Math.min(p.minY, f.minY)) - h) < d ? (d = u, l = h < l ? h : l, a = o) : u === d && h < l && (l = h, a = o);
          }
      ...
      _insert: function _insert(t, e, i) {
        ...
        for (o.children.push(t), h(o, s); e >= 0 && r[e].children.length > this._maxEntries;) {
          this._split(r, e), e--;
        }
      ...
      _split: function _split(t, e) {
        ...
        var r = this._chooseSplitIndex(i, s, n),
            a = g(i.children.splice(r, i.children.length - r));

        a.height = i.height, a.leaf = i.leaf, o(i, this.toBBox), o(a, this.toBBox), e ? t[e - 1].children.push(a) : this._splitRoot(i, a);
      },
      ...
      _chooseSplitIndex: function _chooseSplitIndex(t, e, i) {
        var n, s, r, o, h, u, l, d, f, p, g, v, m, y;

        for (u = l = 1 / 0, n = e; n <= i - e; n++) {
          s = a(t, 0, n, this.toBBox), r = a(t, n, i, this.toBBox), f = s, p = r, void 0, void 0, void 0, void 0, g = Math.max(f.minX, p.minX), v = Math.max(f.minY, p.minY), m = Math.min(f.maxX, p.maxX), y = Math.min(f.maxY, p.maxY), o = Math.max(0, m - g) * Math.max(0, y - v), h = c(s) + c(r), o < u ? (u = o, d = n, l = h < l ? h : l) : o === u && h < l && (l = h, d = n);
        }
      ...
      _allDistMargin: function _allDistMargin(t, e, i, n) {
        ...
        for (s = e; s < i - e; s++) {
          r = t.children[s], h(u, t.leaf ? o(r) : r), c += d(u);
        }

        for (s = i - e - 1; s >= e; s--) {
          r = t.children[s], h(l, t.leaf ? o(r) : r), c += d(l);
        }
      ...
      _condense: function _condense(t) {
        for (var e, i = t.length - 1; i >= 0; i--) {
          0 === t[i].children.length ? i > 0 ? (e = t[i - 1].children).splice(e.indexOf(t[i]), 1) : this.clear() : o(t[i], this.toBBox);
        }
      }
    }, _defineProperty(_s$prototype, "compareMinX", function compareMinX(t, e) {
      return t.left - e.left;
    }), _defineProperty(_s$prototype, "compareMinY", function compareMinY(t, e) {
      return t.top - e.top;
    }), _defineProperty(_s$prototype, "toBBox", function toBBox(t) {
      return {
        minX: t.left,
        minY: t.top,
        maxX: t.right,
    ...
    var n = i(63),
      ...
      setGameObject: function setGameObject(t, e) {
        return t && t !== this.gameObject && (this.gameObject.body = null, t.body = this, this.gameObject = t), e && this.updateFromGameObject(), this;
      },
      ...
      setSize: function setSize(t, e, i) {
        ...
        if (!t && n.frame && (t = n.frame.realWidth), !e && n.frame && (e = n.frame.realHeight), this.world.staticTree.remove(this), this.width = t, this.height = e, this.halfWidth = Math.floor(t / 2), this.halfHeight = Math.floor(e / 2), i && n.getCenter) {
          var s = n.displayWidth / 2,
              r = n.displayHeight / 2;
          this.position.x -= this.offset.x, this.position.y -= this.offset.y, this.offset.set(s - this.halfWidth, r - this.halfHeight), this.position.x += this.offset.x, this.position.y += this.offset.y;
        }

        return this.updateCenter(), this.isCircle = !1, this.radius = 0, this.world.staticTree.insert(this), this;
      },
      setCircle: function setCircle(t, e, i) {
        return void 0 === e && (e = this.offset.x), void 0 === i && (i = this.offset.y), t > 0 ? (this.world.staticTree.remove(this), this.isCircle = !0, this.radius = t, this.width = 2 * t, this.height = 2 * t, this.halfWidth = Math.floor(this.width / 2), this.halfHeight = Math.floor(this.height / 2), this.offset.set(e, i), this.updateCenter(), this.world.staticTree.insert(this)) : this.isCircle = !1, this;
      },
      updateCenter: function updateCenter() {
        this.center.set(this.position.x + this.halfWidth, this.position.y + this.halfHeight);
      },
      ...
      hitTest: function hitTest(t, e) {
        return this.isCircle ? n(this, t, e) : o(this, t, e);
      },
      postUpdate: function postUpdate() {},
      deltaAbsX: function deltaAbsX() {
        return 0;
    ...
    (function (e) {
      ...
      var n = i(19),
        ...
        GameObjects: {
          DisplayList: i(730),
          GameObjectCreator: i(42),
          GameObjectFactory: i(43),
          UpdateList: i(759),
          Components: i(33),
          BuildGameObject: i(60),
          BuildGameObjectAnimation: i(274),
          Blitter: i(117),
          GameObject: i(40),
          Graphics: i(118),
          Image: i(80),
      ...
      (r = s(!1, r, n)).Sound = i(918), t.exports = r, e.Phaser = r;
    }).call(this, i(309));
  }, function (t, e) {
    var i;
    ...
    i(311), i(312), i(313), i(314), i(315), i(316), i(317), i(318);
  }, function (t, e) {
    Array.prototype.forEach || (Array.prototype.forEach = function (t) {
      ...
      for (var n = arguments.length >= 2 ? arguments[1] : void 0, s = 0; s < i; s++) {
    ...
    !function () {
      ...
      window.hasOwnProperty("webkitAudioContext") && !window.hasOwnProperty("AudioContext") && (window.AudioContext = webkitAudioContext, AudioContext.prototype.hasOwnProperty("createGain") || (AudioContext.prototype.createGain = AudioContext.prototype.createGainNode), AudioContext.prototype.hasOwnProperty("createDelay") || (AudioContext.prototype.createDelay = AudioContext.prototype.createDelayNode), AudioContext.prototype.hasOwnProperty("createScriptProcessor") || (AudioContext.prototype.createScriptProcessor = AudioContext.prototype.createJavaScriptNode), AudioContext.prototype.hasOwnProperty("createPeriodicWave") || (AudioContext.prototype.createPeriodicWave = AudioContext.prototype.createWaveTable), AudioContext.prototype.internal_createGain = AudioContext.prototype.createGain, AudioContext.prototype.createGain = function () {
        ...
        return e.start ? (e.internal_start = e.start, e.start = function (t, i, n) {
          void 0 !== n ? e.internal_start(t || 0, i, n) : e.internal_start(t || 0, i || 0);
    ...
    for (var i = Date.now(), n = ["ms", "moz", "webkit", "o"], s = 0; s < n.length && !window.requestAnimationFrame; s++) {
    ...
    t.exports = function (t, e) {
      ...
      for (var x = 0; x < t.length; x++) {
        if (n(t[x], a, d), i && -1 === h) a.x += l;else if (o && -1 === u) a.y += c;else if (g += l, a.x += l, g === m && (g = 0, v += c, a.x = f, a.y += c, v === y)) break;
      }
    ...
    var n = i(55),
      ...
      initialize: function initialize(t, e, i, s, r) {
    ...
    var n = i(10),
      ...
      setAlpha: function setAlpha(t, e, i, s) {
    ...
    var n = i(88),
        ...
        o = new s({
      initialize: function initialize(t) {
        this.parent = t, this.animationManager = t.scene.sys.anims, this.animationManager.once(r.REMOVE_ANIMATION, this.remove, this), this.isPlaying = !1, this.currentAnim = null, this.currentFrame = null, this.nextAnim = null, this._timeScale = 1, this.frameRate = 0, this.duration = 0, this.msPerFrame = 0, this.skipMissedFrames = !0, this._delay = 0, this._repeat = 0, this._repeatDelay = 0, this._yoyo = !1, this.forward = !0, this._reverse = !1, this.accumulator = 0, this.nextTick = 0, this.repeatCounter = 0, this.pendingRepeat = !1, this._paused = !1, this._wasPlaying = !1, this._pendingStop = 0, this._pendingStopValue;
      },
      chain: function chain(t) {
        return t instanceof n && (t = t.key), this.nextAnim = t, this.parent;
      },
      setDelay: function setDelay(t) {
        return void 0 === t && (t = 0), this._delay = t, this.parent;
      },
      getDelay: function getDelay() {
        return this._delay;
      },
      delayedPlay: function delayedPlay(t, e, i) {
      ...
      playReverse: function playReverse(t, e, i) {
      ...
      _startAnimation: function _startAnimation(t, e) {
        this.load(t, e);
      ...
      setProgress: function setProgress(t) {
      ...
      stop: function stop() {
        ...
        if (e && (e.emit(r.ANIMATION_COMPLETE, e, i, t), t.emit(r.SPRITE_ANIMATION_KEY_COMPLETE + e.key, e, i, t), t.emit(r.SPRITE_ANIMATION_COMPLETE, e, i, t)), this.nextAnim) {
          var n = this.nextAnim;
          this.nextAnim = null, this.play(n);
        }

        return t;
      },
      stopAfterDelay: function stopAfterDelay(t) {
      ...
      stopOnFrame: function stopOnFrame(t) {
      ...
      updateFrame: function updateFrame(t) {
        var e = this.setCurrentFrame(t);

        if (this.isPlaying) {
          t.setAlpha && (e.alpha = t.alpha);
          var i = this.currentAnim;
          e.emit(r.SPRITE_ANIMATION_KEY_UPDATE + i.key, i, t, e), e.emit(r.SPRITE_ANIMATION_UPDATE, i, t, e), 3 === this._pendingStop && this._pendingStopValue === t && this.currentAnim.completeAnimation(this);
        }
      },
      ...
      destroy: function destroy() {
        this.animationManager.off(r.REMOVE_ANIMATION, this.remove, this), this.animationManager = null, this.parent = null, this.currentAnim = null, this.currentFrame = null;
      }
    });
    t.exports = o;
  }, function (t, e) {
    ...
    var i = {
      ...
      frame: null,
      isCropped: !1,
      setCrop: function setCrop(t, e, i, n) {
        if (void 0 === t) this.isCropped = !1;else if (this.frame) {
          if ("number" == typeof t) this.frame.setCropUVs(this._crop, t, e, i, n, this.flipX, this.flipY);else {
            var s = t;
    ...
    var n = i(34),
        ...
        r = i(7),
        o = {
      prepareBoundsOutput: function prepareBoundsOutput(t, e) {
        (void 0 === e && (e = !1), 0 !== this.rotation && s(t, this.x, this.y, this.rotation), e && this.parentContainer) && this.parentContainer.getBoundsTransformMatrix().transformPoint(t.x, t.y, t);
        return t;
      },
      ...
      getTopLeft: function getTopLeft(t, e) {
      ...
      getTopCenter: function getTopCenter(t, e) {
      ...
      getTopRight: function getTopRight(t, e) {
      ...
      getLeftCenter: function getLeftCenter(t, e) {
      ...
      getRightCenter: function getRightCenter(t, e) {
      ...
      getBottomLeft: function getBottomLeft(t, e) {
      ...
      getBottomCenter: function getBottomCenter(t, e) {
      ...
      getBottomRight: function getBottomRight(t, e) {
      ...
      getBounds: function getBounds(t) {
        ...
        if (void 0 === t && (t = new n()), this.parentContainer) {
          ...
          this.getTopLeft(t), l.transformPoint(t.x, t.y, t), e = t.x, i = t.y, this.getTopRight(t), l.transformPoint(t.x, t.y, t), s = t.x, r = t.y, this.getBottomLeft(t), l.transformPoint(t.x, t.y, t), o = t.x, a = t.y, this.getBottomRight(t), l.transformPoint(t.x, t.y, t), h = t.x, u = t.y;
        } else this.getTopLeft(t), e = t.x, i = t.y, this.getTopRight(t), s = t.x, r = t.y, this.getBottomLeft(t), o = t.x, a = t.y, this.getBottomRight(t), h = t.x, u = t.y;

        return t.x = Math.min(e, s, o, h), t.y = Math.min(i, r, a, u), t.width = Math.max(e, s, o, h) - t.x, t.height = Math.max(i, r, a, u) - t.y, t;
      }
    };
    t.exports = o;
  }, function (t, e, i) {
    ...
    var n = i(65),
      ...
      setRotateToPath: function setRotateToPath(t, e) {
      ...
      startFollow: function startFollow(t, e) {
        ...
        if (u && (t.onStart = function (t) {
          var e = t.data[0];
          e.progress = u, e.elapsed = e.duration * u;
          ...
          var l = this.path.getPoint(.1);
          this.rotation = Math.atan2(l.y - this.y, l.x - this.x) + n(this.pathRotationOffset);
        }
      ...
      pathUpdate: function pathUpdate() {
        ...
        if (t) {
          var e = t.data[0],
              i = this.pathVector;
          if (e.state === o.COMPLETE) return this.path.getPoint(1, i), i.add(this.pathOffset), void this.setPosition(i.x, i.y);
          if (e.state !== o.PLAYING_FORWARD && e.state !== o.PLAYING_BACKWARD) return;
          this.path.getPoint(t.getValue(), i), i.add(this.pathOffset);
          var s = this.x,
              r = this.y;
          ...
          this.rotateToPath && (this.rotation = Math.atan2(h, a) + n(this.pathRotationOffset));
        }
      }
    };
    t.exports = h;
    ...
    var i = {
      ...
      setFrame: function setFrame(t, e, i) {
    ...
    var i = function i(t) {
      ...
      setTint: function setTint(t, e, n, s) {
        return void 0 === t && (t = 16777215), void 0 === e && (e = t, n = t, s = t), this._tintTL = i(t), this._tintTR = i(e), this._tintBL = i(n), this._tintBR = i(s), this._isTinted = !0, this.tintFill = !1, this;
      },
      setTintFill: function setTintFill(t, e, i, n) {
    ...
    t.exports = function (t, e, i, s, r, o, a) {
      return void 0 !== i && null !== i || (i = e), n(t, "x", e, s, o, a), n(t, "y", i, r, o, a);
    };
  }, function (t, e, i) {
    var n = i(21);
    ...
    t.exports = function (t, e, i, n) {
      ...
      for (var s = i, r = (n - i) / t.length, o = 0; o < t.length; o++) {
        t[o].x = e.x + e.radius * Math.cos(s), t[o].y = e.y + e.radius * Math.sin(s), s += r;
      }
    ...
    t.exports = function (t, e, i, n) {
      ...
      for (var s = i, r = (n - i) / t.length, o = e.width / 2, a = e.height / 2, h = 0; h < t.length; h++) {
        t[h].x = e.x + o * Math.cos(s), t[h].y = e.y + a * Math.sin(s), s += r;
      }
    ...
    t.exports = function (t, e, i) {
      ...
      i > 0 ? s(o, i) : i < 0 && r(o, Math.abs(i));

      for (var a = 0; a < t.length; a++) {
        t[a].x = o[a].x, t[a].y = o[a].y;
      }
    ...
    t.exports = function (t, e, i, r) {
      ...
      for (var o = t.x, a = t.y, h = 0, u = 0; u < i; u++) {
        switch (r.push(new s(o, a)), h) {
          case 0:
    ...
    t.exports = function (t, e, i) {
      ...
      for (var d = 1; n !== r || s !== o;) {
        var f = c << 1;
        f > -h && (c -= h, n += u), f < a && (c += a, s += l), d % e == 0 && i.push({
          x: n,
          y: s
        }), d++;
      }
    ...
    t.exports = function (t, e, i, s, r, o, a) {
      return void 0 !== i && null !== i || (i = e), n(t, "scaleX", e, s, o, a), n(t, "scaleY", i, r, o, a);
    };
  }, function (t, e, i) {
    var n = i(21);
    ...
    t.exports = function (t, e, i, s, r, o, a) {
      return void 0 !== i && null !== i || (i = e), n(t, "originX", e, s, o, a), n(t, "originY", i, r, o, a);
    };
  }, function (t, e, i) {
    var n = i(12);
    ...
    t.exports = function (t, e, i, s, r, o, a) {
      return void 0 !== i && null !== i || (i = e), n(t, "scrollFactorX", e, s, o, a), n(t, "scrollFactorY", i, r, o, a);
    };
  }, function (t, e, i) {
    var n = i(12);
    ...
    t.exports = function (t, e, i, s, r) {
      var o, a, h, u, l, c;
      if (void 0 === s && (s = 0), void 0 === r && (r = new n()), t.length > 1) {
        if (0 === s) {
          var d = t.length - 1;

          for (o = t[d].x, a = t[d].y, h = d - 1; h >= 0; h--) {
            u = (c = t[h]).x, l = c.y, c.x = o, c.y = a, o = u, a = l;
          }

          t[d].x = e, t[d].y = i;
        } else {
          for (o = t[0].x, a = t[0].y, h = 1; h < t.length; h++) {
            u = (c = t[h]).x, l = c.y, c.x = o, c.y = a, o = u, a = l;
          }

          t[0].x = e, t[0].y = i;
        }
      } else o = t[0].x, a = t[0].y, t[0].x = e, t[0].y = i;
    ...
    t.exports = function (t, e, i, s, r) {
      void 0 === r && (r = !1);
      var o,
          a = Math.abs(s - i) / t.length;
      if (r) for (o = 0; o < t.length; o++) {
        t[o][e] += n(o * a, i, s);
      } else for (o = 0; o < t.length; o++) {
        t[o][e] = n(o * a, i, s);
      }
    ...
    t.exports = {
      Animation: i(88),
      AnimationFrame: i(157),
      AnimationManager: i(182),
      Events: i(64)
    };
  }, function (t, e, i) {
    t.exports = {
    ...
    t.exports = {
      FixedKeyControl: i(447),
      SmoothedKeyControl: i(448)
    };
  }, function (t, e, i) {
    var n = i(0),
        s = i(4),
      ...
      update: function update(t) {
        if (this.active) {
          void 0 === t && (t = 1);
          var e = this.camera;
          this.up && this.up.isDown ? e.scrollY -= this.speedY * t | 0 : this.down && this.down.isDown && (e.scrollY += this.speedY * t | 0), this.left && this.left.isDown ? e.scrollX -= this.speedX * t | 0 : this.right && this.right.isDown && (e.scrollX += this.speedX * t | 0), this.zoomIn && this.zoomIn.isDown ? (e.zoom -= this.zoomSpeed, e.zoom < .1 && (e.zoom = .1)) : this.zoomOut && this.zoomOut.isDown && (e.zoom += this.zoomSpeed);
        }
      },
      destroy: function destroy() {
    ...
    var n = i(0),
      ...
      update: function update(t) {
        if (this.active) {
          void 0 === t && (t = 1);
          var e = this.camera;
          this._speedX > 0 ? (this._speedX -= this.dragX * t, this._speedX < 0 && (this._speedX = 0)) : this._speedX < 0 && (this._speedX += this.dragX * t, this._speedX > 0 && (this._speedX = 0)), this._speedY > 0 ? (this._speedY -= this.dragY * t, this._speedY < 0 && (this._speedY = 0)) : this._speedY < 0 && (this._speedY += this.dragY * t, this._speedY > 0 && (this._speedY = 0)), this.up && this.up.isDown ? (this._speedY += this.accelY, this._speedY > this.maxSpeedY && (this._speedY = this.maxSpeedY)) : this.down && this.down.isDown && (this._speedY -= this.accelY, this._speedY < -this.maxSpeedY && (this._speedY = -this.maxSpeedY)), this.left && this.left.isDown ? (this._speedX += this.accelX, this._speedX > this.maxSpeedX && (this._speedX = this.maxSpeedX)) : this.right && this.right.isDown && (this._speedX -= this.accelX, this._speedX < -this.maxSpeedX && (this._speedX = -this.maxSpeedX)), this.zoomIn && this.zoomIn.isDown ? this._zoom = -this.zoomSpeed : this.zoomOut && this.zoomOut.isDown ? this._zoom = this.zoomSpeed : this._zoom = 0, 0 !== this._speedX && (e.scrollX -= this._speedX * t | 0), 0 !== this._speedY && (e.scrollY -= this._speedY * t | 0), 0 !== this._zoom && (e.zoom += this._zoom, e.zoom < .001 && (e.zoom = .001));
        }
      },
      destroy: function destroy() {
        this.camera = null, this.left = null, this.right = null, this.up = null, this.down = null, this.zoomIn = null, this.zoomOut = null;
    ...
    var n = i(10),
      ...
      start: function start(t, e, i, n, s, o, a, h) {
    ...
    var n = i(10),
      ...
      start: function start(t, e, i, n, s, o, a) {
    ...
    var n = i(10),
      ...
      start: function start(t, e, i, n, s, a, h) {
        void 0 === i && (i = 1e3), void 0 === n && (n = r.Linear), void 0 === s && (s = !1), void 0 === a && (a = null), void 0 === h && (h = this.camera.scene);
        var u = this.camera;
        return !s && this.isRunning ? u : (this.isRunning = !0, this.duration = i, this.progress = 0, this.source.set(u.scrollX, u.scrollY), this.destination.set(t, e), u.getScroll(t, e, this.current), "string" == typeof n && r.hasOwnProperty(n) ? this.ease = r[n] : "function" == typeof n && (this.ease = n), this._elapsed = 0, this._onUpdate = a, this._onUpdateScope = h, this.camera.emit(o.PAN_START, this.camera, this, i, t, e), u);
      },
      update: function update(t, e) {
        if (this.isRunning) {
          this._elapsed += e;
          var i = n(this._elapsed / this.duration, 0, 1);
          this.progress = i;
          var s = this.camera;

          if (this._elapsed < this.duration) {
            var r = this.ease(i);
            s.getScroll(this.destination.x, this.destination.y, this.current);
            var o = this.source.x + (this.current.x - this.source.x) * r,
                a = this.source.y + (this.current.y - this.source.y) * r;
            s.setScroll(o, a), this._onUpdate && this._onUpdate.call(this._onUpdateScope, s, i, o, a);
          } else s.centerOn(this.destination.x, this.destination.y), this._onUpdate && this._onUpdate.call(this._onUpdateScope, s, i, s.scrollX, s.scrollY), this.effectComplete();
        }
      },
      effectComplete: function effectComplete() {
    ...
    var n = i(10),
      ...
      start: function start(t, e, i, n, s) {
      ...
      update: function update(t, e) {
        if (this.isRunning) if (this._elapsed += e, this.progress = n(this._elapsed / this.duration, 0, 1), this._onUpdate && this._onUpdate.call(this._onUpdateScope, this.camera, this.progress), this._elapsed < this.duration) {
          var i = this.intensity,
              s = this.camera._cw,
              r = this.camera._ch,
              o = this.camera.zoom;
          this._offsetX = (Math.random() * i.x * s * 2 - i.x * s) * o, this._offsetY = (Math.random() * i.y * r * 2 - i.y * r) * o, this.camera.roundPixels && (this._offsetX = Math.round(this._offsetX), this._offsetY = Math.round(this._offsetY));
    ...
    var n = i(10),
      ...
      start: function start(t, e, i, n, s, a) {
        void 0 === e && (e = 1e3), void 0 === i && (i = r.Linear), void 0 === n && (n = !1), void 0 === s && (s = null), void 0 === a && (a = this.camera.scene);
        var h = this.camera;
        return !n && this.isRunning ? h : (this.isRunning = !0, this.duration = e, this.progress = 0, this.source = h.zoom, this.destination = t, "string" == typeof i && r.hasOwnProperty(i) ? this.ease = r[i] : "function" == typeof i && (this.ease = i), this._elapsed = 0, this._onUpdate = s, this._onUpdateScope = a, this.camera.emit(o.ZOOM_START, this.camera, this, e, t), h);
      },
      update: function update(t, e) {
    ...
    var n = i(186),
      ...
      start: function start() {
        if (!this.main) {
          var t = this.systems;
          t.settings.cameras ? this.fromJSON(t.settings.cameras) : this.add(), this.main = this.cameras[0];
        }

        var e = this.systems.events;
        e.on(u.UPDATE, this.update, this), e.once(u.SHUTDOWN, this.shutdown, this);
      },
      add: function add(t, e, i, s, r, o) {
      ...
      addExisting: function addExisting(t, e) {
      ...
      getCamera: function getCamera(t) {
      ...
      getCamerasBelowPointer: function getCamerasBelowPointer(t) {
      ...
      remove: function remove(t, e) {
        ...
        for (var i = 0, n = this.cameras, s = 0; s < t.length; s++) {
          var r = n.indexOf(t[s]);
          -1 !== r && (e && n[r].destroy(), n.splice(r, 1), i++);
        }
      ...
      render: function render(t, e, i) {
        for (var n = this.scene, s = this.cameras, r = 0; r < this.cameras.length; r++) {
          var o = s[r];
          o.visible && o.alpha > 0 && (o.preRender(1), t.render(n, e, i, o));
        }
      },
      ...
      onResize: function onResize(t, e, i, n, s, r) {
    ...
    t.exports = {
      Config: i(209),
      CreateRenderer: i(228),
      DebugHeader: i(234),
      Events: i(11),
      TimeStep: i(235),
      VisibilityHandler: i(236)
    };
  }, function (t, e) {
    var i,
        n,
    ...
    t.exports = function () {
      ...
      try {
        if (e && (t.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "") && (s.ogg = !0), (t.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/, "") || t.canPlayType("audio/opus;").replace(/^no$/, "")) && (s.opus = !0), t.canPlayType("audio/mpeg;").replace(/^no$/, "") && (s.mp3 = !0), t.canPlayType('audio/wav; codecs="1"').replace(/^no$/, "") && (s.wav = !0), (t.canPlayType("audio/x-m4a;") || t.canPlayType("audio/aac;").replace(/^no$/, "")) && (s.m4a = !0), t.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "") && (s.webm = !0), "" !== t.canPlayType('audio/mp4;codecs="ec-3"'))) if (n.edge) s.dolby = !0;else if (n.safari && n.safariVersion >= 9 && /Mac OS X (\d+)_(\d+)/.test(navigator.userAgent)) {
          var i = parseInt(RegExp.$1, 10),
              r = parseInt(RegExp.$2, 10);
          (10 === i && r >= 11 || i > 10) && (s.dolby = !0);
        }
      } catch (t) {}
    ...
    t.exports = function () {
      var t,
          e = "Fullscreen",
          n = "FullScreen",
          s = ["request" + e, "request" + n, "webkitRequest" + e, "webkitRequest" + n, "msRequest" + e, "msRequest" + n, "mozRequest" + n, "mozRequest" + e];

      for (t = 0; t < s.length; t++) {
        if (document.documentElement[s[t]]) {
          i.available = !0, i.request = s[t];
          break;
        }
      }

      var r = ["cancel" + n, "exit" + e, "webkitCancel" + n, "webkitExit" + e, "msCancel" + n, "msExit" + e, "mozCancel" + n, "mozExit" + e];
      if (i.available) for (t = 0; t < r.length; t++) {
        if (document[r[t]]) {
          i.cancel = r[t];
          break;
        }
    ...
    t.exports = {
      Between: i(212),
      BetweenPoints: i(536),
      BetweenPointsY: i(537),
      BetweenY: i(538),
      CounterClockwise: i(539),
      Normalize: i(213),
      Reverse: i(540),
      RotateTo: i(541),
      ShortestBetween: i(542),
      Wrap: i(173),
      WrapDegrees: i(174)
    };
  }, function (t, e) {
    ...
    t.exports = function (t, e) {
      for (var i = 0, s = t.length - 1, r = 0; r <= s; r++) {
        i += Math.pow(1 - e, s - r) * Math.pow(e, r) * t[r] * n(s, r);
      }
    ...
    t.exports = function (t, e) {
      var i = t.length - 1,
          s = i * e,
          r = Math.floor(s);
      return t[0] === t[i] ? (e < 0 && (r = Math.floor(s = i * (1 + e))), n(s - r, t[(r - 1 + i) % i], t[r], t[(r + 1) % i], t[(r + 2) % i])) : e < 0 ? t[0] - (n(-s, t[0], t[0], t[1], t[1]) - t[0]) : e > 1 ? t[i] - (n(s - i, t[i], t[i], t[i - 1], t[i - 1]) - t[i]) : n(s - r, t[r ? r - 1 : 0], t[r], t[i < r + 1 ? i : r + 1], t[i < r + 2 ? i : r + 2]);
    };
  }, function (t, e) {
    t.exports = function (t, e, i, n, s) {
      return function (t, e) {
    ...
    t.exports = function (t, e) {
      var i = t.length - 1,
          s = i * e,
          r = Math.floor(s);
      return e < 0 ? n(t[0], t[1], s) : e > 1 ? n(t[i], t[i - 1], i - s) : n(t[r], t[r + 1 > i ? i : r + 1], s - r);
    };
  }, function (t, e) {
    t.exports = function (t, e, i, n) {
      return function (t, e) {
    ...
    var n = new (i(0))({
      ...
      hash: function hash(t) {
        ...
        for (var n = 0; n < t.length; n++) {
          e = .02519603282416938 * (i += t.charCodeAt(n)), e -= i = e >>> 0, i = (e *= i) >>> 0, i += 4294967296 * (e -= i);
        }
      ...
      sow: function sow(t) {
        if (this.n = 4022871197, this.s0 = this.hash(" "), this.s1 = this.hash(" "), this.s2 = this.hash(" "), this.c = 1, t) for (var e = 0; e < t.length && null != t[e]; e++) {
          var i = t[e];
    ...
    t.exports = function (t, e, i, n) {
      void 0 === i && (i = e + 1);
      var s = (t - e) / (i - e);
      return s > 1 ? void 0 !== n ? (s = (n - t) / (n - i)) < 0 && (s = 0) : s = 1 : s < 0 && (s = 0), s;
    };
  }, function (t, e) {
    t.exports = function (t, e) {
      void 0 === e && (e = 1);
    ...
    t.exports = function (t, e, i, n) {
      ...
      for (var s = [], r = [], o = 0; o < t; o++) {
        e += (i -= e * n) * n, s[o] = i, r[o] = e;
      }
    ...
    t.exports = function (t, e, i, s) {
      ...
      var r = 0,
          o = 0;
      return t > 0 && t <= e * i && (r = t > e - 1 ? t - (o = Math.floor(t / e)) * e : t, s.set(r, o)), s;
    };
  }, function (t, e) {
    t.exports = function (t, e, i) {
    ...
    var n = new (i(0))({
      initialize: function initialize(t, e, i, n) {
        this.x = 0, this.y = 0, this.z = 0, this.w = 0, "object" == _typeof(t) ? (this.x = t.x || 0, this.y = t.y || 0, this.z = t.z || 0, this.w = t.w || 0) : (this.x = t || 0, this.y = e || 0, this.z = i || 0, this.w = n || 0);
      },
      clone: function clone() {
    ...
    var n = i(589),
      ...
      snapshotCanvas: function snapshotCanvas(t, e, i, s, r, o, a, h, u) {
      ...
      snapshot: function snapshot(t, e, i) {
        return this.snapshotArea(0, 0, this.gameCanvas.width, this.gameCanvas.height, t, e, i);
      },
      snapshotArea: function snapshotArea(t, e, i, n, s, r, o) {
      ...
      snapshotPixel: function snapshotPixel(t, e, i) {
        return this.snapshotArea(t, e, 1, 1, i), this.snapshotState.getPixel = !0, this;
      },
      batchSprite: function batchSprite(t, e, i, n) {
        ...
        if (0 !== s) {
          ...
          if (t.isCropped) {
            var T = t._crop;
            T.flipX === t.flipX && T.flipY === t.flipY || e.updateCropUVs(T, t.flipX, t.flipY), d = T.cw, f = T.ch, l = T.cx, c = T.cy, y = -v + T.x, x = -m + T.y, t.flipX && (y >= 0 ? y = -(y + d) : y < 0 && (y = Math.abs(y) - d)), t.flipY && (x >= 0 ? x = -(x + f) : x < 0 && (x = Math.abs(x) - f));
          }

          var w = 1,
              E = 1;
          t.flipX && (p || (y += -e.realWidth + 2 * v), w = -1), t.flipY && (p || (x += -e.realHeight + 2 * m), E = -1), a.applyITRS(t.x, t.y, t.rotation, t.scaleX * w, t.scaleY * E), o.copyFrom(i.matrix), n ? (o.multiplyWithOffset(n, -i.scrollX * t.scrollFactorX, -i.scrollY * t.scrollFactorY), a.e = t.x, a.f = t.y, o.multiply(a, h)) : (a.e -= i.scrollX * t.scrollFactorX, a.f -= i.scrollY * t.scrollFactorY, o.multiply(a, h)), r.save(), h.setToContext(r), r.globalCompositeOperation = this.blendModes[t.blendMode], r.globalAlpha = s, r.imageSmoothingEnabled = !(!this.antialias || e.source.scaleMode), r.drawImage(e.source.image, l, c, d, f, y, x, d / g, f / g), r.restore();
        }
      },
      destroy: function destroy() {
    ...
    t.exports = function (t, e) {
      var i = r(e, "callback"),
          o = r(e, "type", "image/png"),
          a = r(e, "encoder", .92),
          h = Math.abs(Math.round(r(e, "x", 0))),
          u = Math.abs(Math.round(r(e, "y", 0))),
          l = r(e, "width", t.width),
          c = r(e, "height", t.height);

      if (r(e, "getPixel", !1)) {
        var d = t.getContext("2d").getImageData(h, u, 1, 1).data;
        i.call(null, new s(d[0], d[1], d[2], d[3] / 255));
      } else if (0 !== h || 0 !== u || l !== t.width || c !== t.height) {
        var f = n.createWebGL(this, l, c);
        f.getContext("2d").drawImage(t, h, u, l, c, 0, 0, l, c);
        var p = new Image();
        p.onerror = function () {
          i.call(null), n.remove(f);
        }, p.onload = function () {
          i.call(null, p), n.remove(f);
        }, p.src = f.toDataURL(o, a);
      } else {
        var g = new Image();
        g.onerror = function () {
          i.call(null);
    ...
    var n = i(67),
      ...
      init: function init(t) {
        var e,
            ...
            n = this.canvas,
            s = t.backgroundColor;
        if (!(e = i.config.context ? i.config.context : n.getContext("webgl", t.contextCreation) || n.getContext("experimental-webgl", t.contextCreation)) || e.isContextLost()) throw this.contextLost = !0, new Error("WebGL unsupported");
        this.gl = e;
        var r = this;
        ...
        }, n.addEventListener("webglcontextlost", this.contextLostHandler, !1), n.addEventListener("webglcontextrestored", this.contextRestoredHandler, !1), i.context = e;
        ...
        this.blendModes[1].func = [e.ONE, e.DST_ALPHA], this.blendModes[2].func = [e.DST_COLOR, e.ONE_MINUS_SRC_ALPHA], this.blendModes[3].func = [e.ONE, e.ONE_MINUS_SRC_COLOR], this.blendModes[17] = {
          func: [e.ZERO, e.ONE_MINUS_SRC_ALPHA],
          equation: e.FUNC_REVERSE_SUBTRACT
        }, this.glFormats[0] = e.BYTE, this.glFormats[1] = e.SHORT, this.glFormats[2] = e.UNSIGNED_BYTE, this.glFormats[3] = e.UNSIGNED_SHORT, this.glFormats[4] = e.FLOAT, this.glFuncMap = {
          mat2: {
        ...
        })), this.setBlendMode(o.BlendModes.NORMAL), i.textures.once(d.READY, this.boot, this), this;
      },
      boot: function boot() {
        for (var t in this.pipelines) {
          this.pipelines[t].boot();
        }
      ...
      onResize: function onResize(t, e, i, n) {
      ...
      resize: function resize(t, e, i) {
        ...
        for (var r in this.width = t, this.height = e, this.resolution = i, n.viewport(0, 0, t, e), s) {
          s[r].resize(t, e, i);
        }
      ...
      hasExtension: function hasExtension(t) {
      ...
      hasPipeline: function hasPipeline(t) {
        return t in this.pipelines;
      },
      getPipeline: function getPipeline(t) {
        return this.hasPipeline(t) ? this.pipelines[t] : null;
      },
      removePipeline: function removePipeline(t) {
        return delete this.pipelines[t], this;
      },
      addPipeline: function addPipeline(t, e) {
      ...
      pushScissor: function pushScissor(t, e, i, n, s) {
        void 0 === s && (s = this.drawingBufferHeight);
        var r = [t, e, i, n];
        return this.scissorStack.push(r), this.setScissor(t, e, i, n, s), this.currentScissor = r, r;
      },
      setScissor: function setScissor(t, e, i, n, s) {
        void 0 === s && (s = this.drawingBufferHeight);
        var r = this.gl,
        ...
        a && (this.flush(), r.scissor(t, s - e - n, i, n));
      },
      ...
      setPipeline: function setPipeline(t, e) {
      ...
      rebindPipeline: function rebindPipeline(t) {
        var e = this.gl;
      ...
      setBlendMode: function setBlendMode(t, e) {
        void 0 === e && (e = !1);
        var i = this.gl,
            n = this.blendModes[t];
        return !!(e || t !== o.BlendModes.SKIP_CHECK && this.currentBlendMode !== t) && (this.flush(), i.enable(i.BLEND), i.blendEquation(n.equation), n.func.length > 2 ? i.blendFuncSeparate(n.func[0], n.func[1], n.func[2], n.func[3]) : i.blendFunc(n.func[0], n.func[1]), this.currentBlendMode = t, !0);
      },
      ...
      removeBlendMode: function removeBlendMode(t) {
        return t > 17 && this.blendModes[t] && this.blendModes.splice(t, 1), this;
      },
      setBlankTexture: function setBlankTexture(t) {
        void 0 === t && (t = !1), !t && 0 === this.currentActiveTextureUnit && this.currentTextures[0] || this.setTexture2D(this.blankTexture.glTexture, 0);
      },
      setTexture2D: function setTexture2D(t, e, i) {
        void 0 === i && (i = !0);
        var n = this.gl;
      ...
      setFramebuffer: function setFramebuffer(t, e) {
        void 0 === e && (e = !1);
        var i = this.gl,
            n = this.width,
            s = this.height;
      ...
      createTexture2D: function createTexture2D(t, e, i, n, s, r, o, a, u, l, c, d) {
        l = void 0 === l || null === l || l, void 0 === c && (c = !1), void 0 === d && (d = !1);
        var f = this.gl,
            p = f.createTexture();
        return this.setTexture2D(p, 0), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_MIN_FILTER, e), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_MAG_FILTER, i), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_WRAP_S, s), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_WRAP_T, n), f.pixelStorei(f.UNPACK_PREMULTIPLY_ALPHA_WEBGL, l), f.pixelStorei(f.UNPACK_FLIP_Y_WEBGL, d), null === o || void 0 === o ? f.texImage2D(f.TEXTURE_2D, t, r, a, u, 0, r, f.UNSIGNED_BYTE, null) : (c || (a = o.width, u = o.height), f.texImage2D(f.TEXTURE_2D, t, r, r, f.UNSIGNED_BYTE, o)), h(a, u) && f.generateMipmap(f.TEXTURE_2D), this.setTexture2D(null, 0), p.isAlphaPremultiplied = l, p.isRenderTexture = !1, p.width = a, p.height = u, this.nativeTextures.push(p), p;
      },
      createFramebuffer: function createFramebuffer(t, e, i, n) {
        var s,
            r = this.gl,
        ...
        if (this.setFramebuffer(o), n) {
          ...
          r.bindRenderbuffer(r.RENDERBUFFER, a), r.renderbufferStorage(r.RENDERBUFFER, r.DEPTH_STENCIL, t, e), r.framebufferRenderbuffer(r.FRAMEBUFFER, r.DEPTH_STENCIL_ATTACHMENT, r.RENDERBUFFER, a);
        }

        if (i.isRenderTexture = !0, i.isAlphaPremultiplied = !1, r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0, r.TEXTURE_2D, i, 0), (s = r.checkFramebufferStatus(r.FRAMEBUFFER)) !== r.FRAMEBUFFER_COMPLETE) {
      ...
      createProgram: function createProgram(t, e) {
        var i = this.gl,
            n = i.createProgram(),
      ...
      deleteFramebuffer: function deleteFramebuffer(t) {
        return this.gl.deleteFramebuffer(t), this;
      },
      deleteProgram: function deleteProgram(t) {
        return this.gl.deleteProgram(t), this;
      },
      deleteBuffer: function deleteBuffer(t) {
        return this.gl.deleteBuffer(t), this;
      },
      preRenderCamera: function preRenderCamera(t) {
        var e = t._cx,
            i = t._cy,
            n = t._cw,
            r = t._ch,
            o = this.pipelines.TextureTintPipeline,
            a = t.backgroundColor;

        if (t.renderToTexture) {
          this.flush(), this.pushScissor(e, i, n, -r), this.setFramebuffer(t.framebuffer);
          var h = this.gl;
          h.clearColor(0, 0, 0, 0), h.clear(h.COLOR_BUFFER_BIT), o.projOrtho(e, n + e, i, r + i, -1e3, 1e3), t.mask && (this.currentCameraMask.mask = t.mask, this.currentCameraMask.camera = t._maskCamera, t.mask.preRenderWebGL(this, t, t._maskCamera)), a.alphaGL > 0 && o.drawFillRect(e, i, n + e, r + i, p.getTintFromFloats(a.redGL, a.greenGL, a.blueGL, 1), a.alphaGL), t.emit(s.PRE_RENDER, t);
        } else this.pushScissor(e, i, n, r), t.mask && (this.currentCameraMask.mask = t.mask, this.currentCameraMask.camera = t._maskCamera, t.mask.preRenderWebGL(this, t, t._maskCamera)), a.alphaGL > 0 && o.drawFillRect(e, i, n, r, p.getTintFromFloats(a.redGL, a.greenGL, a.blueGL, 1), a.alphaGL);
      },
      getCurrentStencilMask: function getCurrentStencilMask() {
        var t = null,
            e = this.maskStack,
            i = this.currentCameraMask;
        return e.length > 0 ? t = e[e.length - 1] : i.mask && i.mask.isStencil && (t = i), t;
      },
      postRenderCamera: function postRenderCamera(t) {
        var e = this.pipelines.TextureTintPipeline;

        if (t.flashEffect.postRenderWebGL(e, p.getTintFromFloats), t.fadeEffect.postRenderWebGL(e, p.getTintFromFloats), t.dirty = !1, this.popScissor(), t.renderToTexture) {
          if (e.flush(), this.setFramebuffer(null), t.emit(s.POST_RENDER, t), t.renderToGame) {
            e.projOrtho(0, e.width, e.height, 0, -1e3, 1e3);
            var i = p.getTintAppendFloatAlpha;
            (t.pipeline ? t.pipeline : e).batchTexture(t, t.glTexture, t.width, t.height, t.x, t.y, t.width, t.height, t.zoom, t.zoom, t.rotation, t.flipX, !t.flipY, 1, 1, 0, 0, 0, 0, t.width, t.height, i(t._tintTL, t._alphaTL), i(t._tintTR, t._alphaTR), i(t._tintBL, t._alphaBL), i(t._tintBR, t._alphaBR), t._isTinted && t.tintFill, 0, 0, this.defaultCamera, null);
          }
      ...
      preRender: function preRender() {
        if (!this.contextLost) {
          ...
          if (t.bindFramebuffer(t.FRAMEBUFFER, null), this.config.clearBeforeRender) {
            var i = this.config.backgroundColor;
            t.clearColor(i.redGL, i.greenGL, i.blueGL, i.alphaGL), t.clear(t.COLOR_BUFFER_BIT | t.DEPTH_BUFFER_BIT | t.STENCIL_BUFFER_BIT);
          }

          for (var n in t.enable(t.SCISSOR_TEST), e) {
            e[n].onPreRender();
          }
        ...
        if (!this.contextLost) {
          ...
          for (var u = this.currentMask, l = 0; l < r; l++) {
            ...
            if (c.willRender(n)) {
              ...
              var d = c.mask;
              (u = this.currentMask).mask && u.mask !== d && u.mask.postRenderWebGL(this, u.camera), d && u.mask !== d && d.preRenderWebGL(this, c, n);
              var f = c.type;
              f !== this.currentType && (this.newType = !0, this.currentType = f), this.nextTypeMatch = l < r - 1 && s[l + 1].type === this.currentType, c.renderWebGL(this, c, i, n), this.newType = !1;
            }
          }
      ...
      snapshotFramebuffer: function snapshotFramebuffer(t, e, i, n, s, r, o, a, h, u, l) {
      ...
      canvasToTexture: function canvasToTexture(t, e, i, n) {
        return void 0 === i && (i = !1), void 0 === n && (n = !1), e ? this.updateCanvasTexture(t, e, n) : this.createCanvasTexture(t, i, n);
      },
      createCanvasTexture: function createCanvasTexture(t, e, i) {
        void 0 === e && (e = !1), void 0 === i && (i = !1);
        var n = this.gl,
            s = n.NEAREST,
            r = n.NEAREST,
      ...
      updateCanvasTexture: function updateCanvasTexture(t, e, i) {
        void 0 === i && (i = !1);
        var n = this.gl,
            s = t.width,
            r = t.height;
        return s > 0 && r > 0 && (this.setTexture2D(e, 0), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, i), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, t), e.width = s, e.height = r, this.setTexture2D(null, 0)), e;
      },
      createVideoTexture: function createVideoTexture(t, e, i) {
        void 0 === e && (e = !1), void 0 === i && (i = !1);
        var n = this.gl,
            s = n.NEAREST,
            r = n.NEAREST,
      ...
      updateVideoTexture: function updateVideoTexture(t, e, i) {
        void 0 === i && (i = !1);
        var n = this.gl,
            s = t.videoWidth,
            r = t.videoHeight;
      ...
      setTextureFilter: function setTextureFilter(t, e) {
        var i = this.gl,
      ...
      destroy: function destroy() {
        for (var t = 0; t < this.nativeTextures.length; t++) {
          this.gl.deleteTexture(this.nativeTextures[t]);
        }

        for (var e in this.nativeTextures = [], this.pipelines) {
          this.pipelines[e].destroy(), delete this.pipelines[e];
        }
    ...
    t.exports = function (t, e) {
      ...
      if (c) {
        ...
        for (var w = n.createWebGL(this, m, y), E = w.getContext("2d"), S = E.getImageData(0, 0, m, y), _ = S.data, A = 0; A < y; A++) {
          for (var b = 0; b < m; b++) {
            var O = 4 * ((y - A) * m + b),
                M = d ? x - 4 * (A * m + (m - b)) : 4 * (A * m + b);
            _[M + 0] = T[O + 0], _[M + 1] = T[O + 1], _[M + 2] = T[O + 2], _[M + 3] = T[O + 3];
          }
        }
        ...
        C.onerror = function () {
          ...
          o.call(null, C), n.remove(w);
        }, C.src = w.toDataURL(a, h);
      }
    };
  }, function (t, e, i) {
    var n = i(0),
      ...
      beginMask: function beginMask(t, e, i) {
        var n = this.renderer,
            s = this.gl;
      ...
      endMask: function endMask(t, e) {
        var i = this.gl,
            n = this.renderer,
            s = t.bitmapMask;

        if (s && i) {
          n.flush(), n.setFramebuffer(t.maskFramebuffer), i.clearColor(0, 0, 0, 0), i.clear(i.COLOR_BUFFER_BIT), n.setBlendMode(0, !0), s.renderWebGL(n, s, 0, e), n.flush(), n.setFramebuffer(t.prevFramebuffer);
          var r = n.getCurrentStencilMask();
          r ? (i.enable(i.STENCIL_TEST), r.mask.applyStencil(n, r.camera, !0)) : n.currentMask.mask = null, n.setPipeline(this), i.activeTexture(i.TEXTURE1), i.bindTexture(i.TEXTURE_2D, t.maskTexture), i.activeTexture(i.TEXTURE0), i.bindTexture(i.TEXTURE_2D, t.mainTexture), i.uniform1i(i.getUniformLocation(this.program, "uInvertMaskAlpha"), t.invertAlpha), i.drawArrays(this.topology, 0, 3);
        }
      }
    });
    t.exports = a;
    ...
    var n = i(0),
      ...
      onRender: function onRender(t, e) {
        this.active = !1;
        var i = t.sys.lights;
        ...
        for (r = 0; r < o; ++r) {
          a.setFloat1(h, "uLights[" + r + "].radius", 0);
        }

        for (a.setFloat4(h, "uCamera", e.x, e.y, e.rotation, e.zoom), a.setFloat3(h, "uAmbientLightColor", i.ambientColor.r, i.ambientColor.g, i.ambientColor.b), r = 0; r < s; ++r) {
          var d = n[r],
              f = "uLights[" + r + "].";
          u.transformPoint(d.x, d.y, l), a.setFloat2(h, f + "position", l.x - e.scrollX * d.scrollFactorX * e.zoom, c - (l.y - e.scrollY * d.scrollFactorY * e.zoom)), a.setFloat3(h, f + "color", d.r, d.g, d.b), a.setFloat1(h, f + "intensity", d.intensity), a.setFloat1(h, f + "radius", d.radius);
        }

        return this.currentNormalMapRotation = null, this;
      },
      batchTexture: function batchTexture(t, e, i, n, s, r, o, a, h, u, l, c, d, f, p, g, v, m, y, x, T, w, E, S, _, A, b, O, M, C) {
        var R;
        if (this.active) if (this.renderer.setPipeline(this), t.displayTexture ? R = t.displayTexture.dataSource[t.displayFrame.sourceIndex] : t.texture ? R = t.texture.dataSource[t.frame.sourceIndex] : t.tileset && (R = Array.isArray(t.tileset) ? t.tileset[0].image.dataSource[0] : t.tileset.image.dataSource[0]), R) {
          this.setTexture2D(R.glTexture, 1), this.setNormalMapRotation(l);
          var P = this._tempMatrix1,
              L = this._tempMatrix2,
              k = this._tempMatrix3,
              D = m / i + b,
          ...
          d ^= e.isRenderTexture ? 1 : 0, c && (N *= -1, z += o), d && (U *= -1, Y += a);
          var W = z + N,
              V = Y + U;
          L.applyITRS(s, r, l, h, u), P.copyFrom(M.matrix), C ? (P.multiplyWithOffset(C, -M.scrollX * f, -M.scrollY * p), L.e = s, L.f = r, P.multiply(L, k)) : (L.e -= M.scrollX * f, L.f -= M.scrollY * p, P.multiply(L, k));
          var j = k.getX(z, Y),
              ...
              tt = k.getY(W, Y);
          M.roundPixels && (j = Math.round(j), K = Math.round(K), q = Math.round(q), Z = Math.round(Z), J = Math.round(J), Q = Math.round(Q), $ = Math.round($), tt = Math.round(tt)), this.setTexture2D(e, 0), this.batchQuad(j, K, q, Z, J, Q, $, tt, D, F, I, B, w, E, S, _, A, e, 0);
        } else console.warn("Normal map missing or invalid");
      },
      setNormalMap: function setNormalMap(t) {
        var e;
      ...
      setNormalMapRotation: function setNormalMapRotation(t) {
        if (t !== this.currentNormalMapRotation || 0 === this.batches.length) {
          this.batches.length > 0 && this.flush();
          var e = this.inverseRotationMatrix;

          if (t) {
            var i = -t,
                n = Math.cos(i),
                s = Math.sin(i);
            e[1] = s, e[3] = -s, e[0] = e[4] = n;
          } else e[0] = e[4] = 1, e[1] = e[3] = 0;

          this.renderer.setMatrix3(this.program, "uInverseRotationMatrix", !1, e), this.currentNormalMapRotation = t;
        }
      },
      batchSprite: function batchSprite(t, e, i) {
        if (this.active) {
          var n = t.texture.dataSource[t.frame.sourceIndex];
          n && (this.renderer.setPipeline(this), this.setTexture2D(n.glTexture, 1), this.setNormalMapRotation(t.rotation), r.prototype.batchSprite.call(this, t, e, i));
        }
      }
    });
    ...
    function n(t, e, i) {
      ...
      if (v && (y = function (t, e, i, n) {
        ...
        for (o = 0, a = e.length; o < a; o++) {
          h = e[o] * n, u = o < a - 1 ? e[o + 1] * n : t.length, (l = s(t, h, u, n, !1)) === l.next && (l.steiner = !0), f.push(p(l));
        }

        for (f.sort(c), o = 0; o < f.length; o++) {
          d(f[o], i), i = r(i, i.next);
        }
        ...
        for (var T = i; T < m; T += i) {
          l = t[T], f = t[T + 1], l < n && (n = l), f < a && (a = f), l > h && (h = l), f > u && (u = f);
        }

        g = 0 !== (g = Math.max(h - n, u - a)) ? 1 / g : 0;
      }

      return o(y, x, i, n, a, g), x;
    }

    function s(t, e, i, n, s) {
      var r, o;
      if (s === A(t, e, i, n) > 0) for (r = e; r < i; r += n) {
        o = E(r, t[r], t[r + 1], o);
      } else for (r = i - n; r >= e; r -= n) {
        o = E(r, t[r], t[r + 1], o);
      }
      return o && y(o, o.next) && (S(o), o = o.next), o;
    }
    ...
    function r(t, e) {
      ...
      do {
        if (i = !1, n.steiner || !y(n, n.next) && 0 !== m(n.prev, n, n.next)) n = n.next;else {
          if (S(n), (n = e = n.prev) === n.next) break;
          i = !0;
        }
      } while (i || n !== e);
    ...
    function o(t, e, i, n, s, c, d) {
      if (t) {
        !d && c && function (t, e, i, n) {
          var s = t;

          do {
            null === s.z && (s.z = f(s.x, s.y, e, i, n)), s.prevZ = s.prev, s.nextZ = s.next, s = s.next;
          } while (s !== t);

          s.prevZ.nextZ = null, s.prevZ = null, function (t) {
            var e,
                i,
                n,
                s,
            ...
            do {
              for (i = t, t = null, r = null, o = 0; i;) {
                for (o++, n = i, a = 0, e = 0; e < u && (a++, n = n.nextZ); e++) {
                  ;
                }

                for (h = u; a > 0 || h > 0 && n;) {
                  0 !== a && (0 === h || !n || i.z <= n.z) ? (s = i, i = i.nextZ, a--) : (s = n, n = n.nextZ, h--), r ? r.nextZ = s : t = s, s.prevZ = r, r = s;
                }
        ...
        for (var p, g, v = t; t.prev !== t.next;) {
          if (p = t.prev, g = t.next, c ? h(t, n, s, c) : a(t)) e.push(p.i / i), e.push(t.i / i), e.push(g.i / i), S(t), t = g.next, v = g.next;else if ((t = g) === v) {
            d ? 1 === d ? o(t = u(t, e, i), e, i, n, s, c, 2) : 2 === d && l(t, e, i, n, s, c) : o(r(t), e, i, n, s, c, 1);
            break;
          }
        }
      }
    ...
    function a(t) {
      ...
      for (var s = t.next.next; s !== t.prev;) {
        if (g(e.x, e.y, i.x, i.y, n.x, n.y, s.x, s.y) && m(s.prev, s, s.next) >= 0) return !1;
        s = s.next;
      }
    ...
    function h(t, e, i, n) {
      var s = t.prev,
          r = t,
          o = t.next;
      if (m(s, r, o) >= 0) return !1;

      for (var a = s.x < r.x ? s.x < o.x ? s.x : o.x : r.x < o.x ? r.x : o.x, h = s.y < r.y ? s.y < o.y ? s.y : o.y : r.y < o.y ? r.y : o.y, u = s.x > r.x ? s.x > o.x ? s.x : o.x : r.x > o.x ? r.x : o.x, l = s.y > r.y ? s.y > o.y ? s.y : o.y : r.y > o.y ? r.y : o.y, c = f(a, h, e, i, n), d = f(u, l, e, i, n), p = t.prevZ, v = t.nextZ; p && p.z >= c && v && v.z <= d;) {
        if (p !== t.prev && p !== t.next && g(s.x, s.y, r.x, r.y, o.x, o.y, p.x, p.y) && m(p.prev, p, p.next) >= 0) return !1;
        if (p = p.prevZ, v !== t.prev && v !== t.next && g(s.x, s.y, r.x, r.y, o.x, o.y, v.x, v.y) && m(v.prev, v, v.next) >= 0) return !1;
        v = v.nextZ;
      }
      ...
      for (; v && v.z <= d;) {
        if (v !== t.prev && v !== t.next && g(s.x, s.y, r.x, r.y, o.x, o.y, v.x, v.y) && m(v.prev, v, v.next) >= 0) return !1;
        v = v.nextZ;
      }
    ...
    function u(t, e, i) {
      ...
      do {
        var s = n.prev,
            r = n.next.next;
        !y(s, r) && x(s, n, n.next, r) && T(s, r) && T(r, s) && (e.push(s.i / i), e.push(n.i / i), e.push(r.i / i), S(n), S(n.next), n = t = r), n = n.next;
      } while (n !== t);
    ...
    function l(t, e, i, n, s, a) {
      ...
      do {
        for (var u = h.next.next; u !== h.prev;) {
          if (h.i !== u.i && v(h, u)) {
            var l = w(h, u);
            return h = r(h, h.next), l = r(l, l.next), o(h, e, i, n, s, a), void o(l, e, i, n, s, a);
          }
    ...
    function d(t, e) {
      if (e = function (t, e) {
        ...
        for (; n !== u;) {
          s >= n.x && n.x >= l && s !== n.x && g(r < c ? s : o, r, l, c, r < c ? o : s, r, n.x, n.y) && ((h = Math.abs(r - n.y) / (s - n.x)) < d || h === d && n.x > i.x) && T(n, t) && (i = n, d = h), n = n.next;
        }
    ...
    function x(t, e, i, n) {
      return !!(y(t, e) && y(i, n) || y(t, n) && y(i, e)) || m(t, e, i) > 0 != m(t, e, n) > 0 && m(i, n, t) > 0 != m(i, n, e) > 0;
    }
    ...
    t.exports = function (t, e) {
      void 0 === e && (e = "none");
      return ["-webkit-", "-khtml-", "-moz-", "-ms-", ""].forEach(function (i) {
        t.style[i + "user-select"] = e;
      }), t.style["-webkit-touch-callout"] = e, t.style["-webkit-tap-highlight-color"] = "rgba(0, 0, 0, 0)", t;
    };
  }, function (t, e, i) {
    var n = i(20);
    n.ColorToRGBA = i(625), n.ComponentToHex = i(240), n.GetColor = i(98), n.GetColor32 = i(188), n.HexStringToColor = i(187), n.HSLToColor = i(626), n.HSVColorWheel = i(627), n.HSVToRGB = i(99), n.HueToComponent = i(241), n.IntegerToColor = i(190), n.IntegerToRGB = i(191), n.Interpolate = i(628), n.ObjectToColor = i(192), n.RandomRGB = i(629), n.RGBStringToColor = i(193), n.RGBToHSV = i(189), n.RGBToString = i(630), n.ValueToColor = i(97), t.exports = n;
  }, function (t, e) {
    t.exports = function (t) {
      var e = {
        r: t >> 16 & 255,
    ...
    t.exports = function (t, e, i) {
      ...
      if (0 !== e) {
        var h = i < .5 ? i * (1 + e) : i + e - i * e,
            u = 2 * i - h;
        r = s(u, h, t + 1 / 3), o = s(u, h, t), a = s(u, h, t - 1 / 3);
      }

      return new n().setGLTo(r, o, a, 1);
    };
  }, function (t, e, i) {
    var n = i(99);
    ...
    t.exports = {
      RGBWithRGB: s,
      ColorWithRGB: function ColorWithRGB(t, e, i, n, r, o) {
        return void 0 === r && (r = 100), void 0 === o && (o = 0), s(t.r, t.g, t.b, e, i, n, r, o);
      },
      ColorWithColor: function ColorWithColor(t, e, i, n) {
        return void 0 === i && (i = 100), void 0 === n && (n = 0), s(t.r, t.g, t.b, e.r, e.g, e.b, i, n);
      }
    };
  }, function (t, e, i) {
    var n = i(221),
    ...
    var n = i(106),
        ...
        O = new a({
      initialize: function initialize(t) {
        this.config = new h(t), this.renderer = null, this.domContainer = null, this.canvas = null, this.context = null, this.isBooted = !1, this.isRunning = !1, this.events = new g(), this.anims = new s(this), this.textures = new S(this), this.cache = new r(this), this.registry = new c(this), this.input = new m(this, this.config), this.scene = new w(this, this.config.sceneConfig), this.device = f, this.scale = new T(this, this.config), this.sound = null, this.sound = b.create(this), this.loop = new _(this, this.config.fps), this.plugins = new x(this, this.config), this.pendingDestroy = !1, this.removeCanvas = !1, this.noReturn = !1, this.hasFocus = !1, p(this.boot.bind(this));
      },
      boot: function boot() {
      ...
      headlessStep: function headlessStep(t, e) {
        if (this.pendingDestroy) return this.runDestroy();
        var i = this.events;
    ...
    t.exports = function (t) {
      ...
      if (e.parent && e.domCreateContainer) {
        ...
        i.style.cssText = ["display: block;", "width: " + t.scale.width + "px;", "height: " + t.scale.height + "px;", "padding: 0; margin: 0;", "position: absolute;", "overflow: hidden;", "pointer-events: none;", "transform: scale(1);", "transform-origin: left top;"].join(" "), t.domContainer = i, n(i, e.parent);
      }
    };
  }, function (t, e, i) {
    var n = i(69);
    ...
    t.exports = function (t) {
      var e;
      return "" !== t && ("string" == typeof t ? e = document.getElementById(t) : t && 1 === t.nodeType && (e = t)), e || (e = document.body), e;
    };
  }, function (t, e, i) {
    var n = i(109);
    ...
    t.exports = function (t, e) {
      ...
      return e > t ? n.ORIENTATION.PORTRAIT : n.ORIENTATION.LANDSCAPE;
    };
  }, function (t, e) {
    t.exports = "addfile";
  }, function (t, e) {
    ...
    t.exports = function (t) {
      ...
      if (e || i) {
        var r = [];
        if (e && r.push(s(e + "Physics")), i) for (var o in i) {
          o = s(o.concat("Physics")), -1 === r.indexOf(o) && r.push(o);
        }
        return r;
      }
    };
    ...
    t.exports = function (t, e, i) {
      if (i.getElementsByTagName("TextureAtlas")) {
        ...
        for (var s, r = i.getElementsByTagName("SubTexture"), o = 0; o < r.length; o++) {
          var a = r[o].attributes,
              h = a.name.value,
              u = parseInt(a.x.value, 10),
              l = parseInt(a.y.value, 10),
              c = parseInt(a.width.value, 10),
              d = parseInt(a.height.value, 10);

          if (s = t.add(h, e, u, l, c, d), a.frameX) {
            var f = Math.abs(parseInt(a.frameX.value, 10)),
                p = Math.abs(parseInt(a.frameY.value, 10)),
                g = parseInt(a.frameWidth.value, 10),
                v = parseInt(a.frameHeight.value, 10);
            s.setTrim(c, d, f, p, g, v);
          }
        }
    ...
    t.exports = function (t, e, i) {
      if (i.frames || i.textures) {
        ...
        for (var r, o = Array.isArray(i.textures) ? i.textures[e].frames : i.frames, a = 0; a < o.length; a++) {
          var h = o[a];
          r = t.add(h.filename, e, h.frame.x, h.frame.y, h.frame.w, h.frame.h), h.trimmed && r.setTrim(h.sourceSize.w, h.sourceSize.h, h.spriteSourceSize.x, h.spriteSourceSize.y, h.spriteSourceSize.w, h.spriteSourceSize.h), h.rotated && (r.rotated = !0, r.updateUVsInverted()), h.anchor && (r.customPivot = !0, r.pivotX = h.anchor.x, r.pivotY = h.anchor.y), r.customData = n(h);
        }

        for (var u in i) {
          "frames" !== u && (Array.isArray(i[u]) ? t.customData[u] = i[u].slice(0) : t.customData[u] = i[u]);
        }
    ...
    t.exports = function (t, e, i) {
      if (i.frames) {
        ...
        for (var a in o) {
          var h = o[a];
          r = t.add(a, e, h.frame.x, h.frame.y, h.frame.w, h.frame.h), h.trimmed && r.setTrim(h.sourceSize.w, h.sourceSize.h, h.spriteSourceSize.x, h.spriteSourceSize.y, h.spriteSourceSize.w, h.spriteSourceSize.h), h.rotated && (r.rotated = !0, r.updateUVsInverted()), r.customData = n(h);
        }
    ...
    t.exports = function (t, e, i, s, r, o, a) {
      ...
      0 === g && console.warn("SpriteSheet frame dimensions will result in zero frames."), (c > g || c < -g) && (c = 0), c < 0 && (c = g + c), -1 !== d && (g = c + (d + 1));

      for (var v = f, m = f, y = 0, x = 0, T = 0; T < g; T++) {
        y = 0, x = 0;
        var w = v + h,
            E = m + u;
        w > r && (y = w - r), E > o && (x = E - o), t.add(T, e, i + v, s + m, h - y, u - x), (v += h + p) + h > r && (v = f, m += u + p);
      }
    ...
    t.exports = function (t, e, i) {
      ...
      var a,
          ...
          v = e.realWidth,
          m = e.realHeight,
          y = Math.floor((v - l + c) / (s + c)),
          x = Math.floor((m - l + c) / (r + c)),
          T = y * x,
          w = e.x,
          E = s - w,
          S = s - (v - p - w),
          ...
          A = r - _,
          b = r - (m - g - _);
      (h > T || h < -T) && (h = 0), h < 0 && (h = T + h), -1 !== u && (T = h + (u + 1));

      for (var O = l, M = l, C = 0, R = e.sourceIndex, P = 0; P < x; P++) {
        for (var L = 0 === P, k = P === x - 1, D = 0; D < y; D++) {
          var F = 0 === D,
              I = D === y - 1;

          if (a = t.add(C, R, d + O, f + M, s, r), F || L || I || k) {
            var B = F ? w : 0,
                N = L ? _ : 0,
                U = 0,
                z = 0;
            F && (U += s - E), I && (U += s - S), L && (z += r - A), k && (z += r - b);
            var Y = s - U,
                X = r - z;
            a.cutWidth = Y, a.cutHeight = X, a.setTrim(s, r, B, N, Y, X);
          }
    ...
    var i = 0,
        n = function n(t, e, _n3, s) {
      var r = i - s.y - s.height;
      t.add(_n3, e, s.x, r, s.width, s.height);
    };

    t.exports = function (t, e, s) {
      var r = t.source[e];
      t.add("__BASE", e, 0, 0, r.width, r.height), i = r.height;
    ...
    var n = i(0),
      ...
      sortByDepth: function sortByDepth(t, e) {
    ...
    t.exports = {
      CheckMatrix: i(114),
      MatrixToString: i(732),
      ReverseColumns: i(733),
      ReverseRows: i(734),
      Rotate180: i(735),
      RotateLeft: i(736),
      RotateMatrix: i(79),
      RotateRight: i(737),
      TransposeMatrix: i(271)
    };
  }, function (t, e, i) {
    var n = i(96),
        s = i(114);
    ...
    t.exports = function (t, e, i, n, s, r) {
      if (void 0 === i && (i = 0), void 0 === r && (r = t), n > 0) {
        var o = n - t.length;
        if (o <= 0) return null;
      }
    ...
    t.exports = function (t, e, i, s, r) {
      if (void 0 === s && (s = 0), void 0 === r && (r = t.length), n(t, s, r)) for (var o = s; o < r; o++) {
        var a = t[o];
    ...
    t.exports = function (t, e, i, n) {
      for (var s = [], r = t; r <= e; r++) {
        if (i || n) {
          var o = i ? i + r.toString() : r.toString();
          n && (o = o.concat(n)), s.push(o);
        } else s.push(r);
      }
    ...
    t.exports = function (t, e, i) {
      ...
      for (var s = [], r = Math.max(n((e - t) / (i || 1)), 0), o = 0; o < r; o++) {
        s.push(t), t += i;
      }
    ...
    var n = i(0),
      ...
      sceneUpdate: function sceneUpdate(t, e) {
      ...
      shutdown: function shutdown() {
        for (var t = this._active.length; t--;) {
          this._active[t].destroy(!0);
        }

        for (t = this._pending.length; t--;) {
          this._pending[t].destroy(!0);
        }

        for (t = this._destroy.length; t--;) {
          this._destroy[t].destroy(!0);
        }
    ...
    t.exports = {
      PROCESS_QUEUE_ADD: i(761),
      PROCESS_QUEUE_REMOVE: i(762)
    };
  }, function (t, e) {
    t.exports = "add";
  }, function (t, e) {
    ...
    t.exports = function (t, e, i, s, r) {
      ...
      if (0 !== o.length) {
        ...
        var h = s.scrollX * e.scrollFactorX,
            ...
            l = a._tempMatrix1;
        l.copyFrom(s.matrix), r && (l.multiplyWithOffset(r, -h, -u), h = 0, u = 0);
        ...
        for (var c = e.x - h, d = e.y - u, f = -1, p = s.alpha * e.alpha, g = s.roundPixels, v = 0; v < o.length; v++) {
          ...
          if (0 !== x) {
            var T = y.width,
                ...
                E = c + m.x + y.x,
                S = d + m.y + y.y;
            m.flipX && (T *= -1, E += y.width), m.flipY && (w *= -1, S += y.height);
            ...
            var _ = E + T,
                ...
                M = l.getX(_, A),
                C = l.getY(_, A),
                R = n.getTintAppendFloatAlpha(m.tint, x);

            y.sourceIndex !== f && (a.setTexture2D(y.glTexture, 0), f = y.sourceIndex), g && (b = Math.round(b), O = Math.round(O), M = Math.round(M), C = Math.round(C)), a.batchQuad(b, O, b, C, M, C, M, O, y.u0, y.v0, y.u1, y.v1, R, R, R, R, !1, y.glTexture, 0) && (f = -1);
          }
        }
      }
    };
    ...
    var n = i(0),
      ...
      alpha: {
        ...
        set: function set(t) {
          this.parent.dirty |= this._alpha > 0 != t > 0, this._alpha = t;
        }
      }
    });
    t.exports = r;
    ...
    var n = i(5),
        s = i(5);
    n = i(771), s = i(278), s = i(278), t.exports = {
      renderWebGL: n,
      renderCanvas: s
    };
  }, function (t, e, i) {
    var n = i(119),
      ...
      this.x = t, this.y = e, this.width = i;
        ...
        o = function o(t, e, i) {
      this.points = [], this.pointsLength = 1, this.points[0] = new r(t, e, i);
    },
        a = [];
    ...
    t.exports = function (t, e, i, h, u) {
      if (0 !== e.commandBuffer.length) {
        ...
        var c = e._tempMatrix1,
            d = e._tempMatrix2,
            f = e._tempMatrix3;
        f.loadIdentity(), d.applyITRS(e.x, e.y, e.rotation, e.scaleX, e.scaleY), c.copyFrom(h.matrix), u ? (c.multiplyWithOffset(u, -h.scrollX * e.scrollFactorX, -h.scrollY * e.scrollFactorY), d.e = e.x, d.f = e.y, c.multiply(d)) : (d.e -= h.scrollX * e.scrollFactorX, d.f -= h.scrollY * e.scrollFactorY, c.multiply(d));

        for (var p = e.commandBuffer, g = h.alpha * e.alpha, v = 1, m = l.fillTint, y = l.strokeTint, x = 0, T = 0, w = 0, E = 2 * Math.PI, S = [], _ = 0, A = !1, b = null, O = s.getTintAppendFloatAlphaAndSwap, M = t.blankTexture.glTexture, C = 0; C < p.length; C++) {
          switch (p[C]) {
            case n.BEGIN_PATH:
              S.length = 0, b = null, A = !0;
              break;

            case n.CLOSE_PATH:
              A = !1, b && b.points.length && b.points.push(b.points[0]);
              break;

            case n.FILL_PATH:
              for (_ = 0; _ < S.length; _++) {
                l.setTexture2D(M), l.batchFillPath(S[_].points, f, c);
              }
            ...
            case n.STROKE_PATH:
              for (_ = 0; _ < S.length; _++) {
                l.setTexture2D(M), l.batchStrokePath(S[_].points, v, A, f, c);
              }
            ...
            case n.LINE_STYLE:
              v = p[++C];
              var R = O(p[++C], p[++C] * g);
              y.TL = R, y.TR = R, y.BL = R, y.BR = R;
              break;

            case n.FILL_STYLE:
              var P = O(p[++C], p[++C] * g);
              m.TL = P, m.TR = P, m.BL = P, m.BR = P;
              break;

            case n.GRADIENT_FILL_STYLE:
              var L = p[++C] * g;
              m.TL = O(p[++C], L), m.TR = O(p[++C], L), m.BL = O(p[++C], L), m.BR = O(p[++C], L);
              break;

            case n.GRADIENT_LINE_STYLE:
              v = p[++C];
              var k = p[++C] * g;
              y.TL = O(p[++C], k), y.TR = O(p[++C], k), y.BL = O(p[++C], k), y.BR = O(p[++C], k);
              break;
            ...
            case n.ARC:
              ...
              for (U -= N, z ? U < -E ? U = -E : U > 0 && (U = U % E - E) : U > E ? U = E : U < 0 && (U = E + U % E), null === b && (b = new o(F + Math.cos(N) * B, I + Math.sin(N) * B, v), S.push(b), D += .01); D < 1 + Y;) {
                w = U * D + N, x = F + Math.cos(w) * B, T = I + Math.sin(w) * B, b.points.push(new r(x, T, v)), D += .01;
              }

              w = U + N, x = F + Math.cos(w) * B, T = I + Math.sin(w) * B, b.points.push(new r(x, T, v));
              break;

            case n.FILL_RECT:
              l.setTexture2D(M), l.batchFillRect(p[++C], p[++C], p[++C], p[++C], f, c);
              break;

            case n.FILL_TRIANGLE:
              l.setTexture2D(M), l.batchFillTriangle(p[++C], p[++C], p[++C], p[++C], p[++C], p[++C], f, c);
              break;

            case n.STROKE_TRIANGLE:
              l.setTexture2D(M), l.batchStrokeTriangle(p[++C], p[++C], p[++C], p[++C], p[++C], p[++C], v, f, c);
              break;

            case n.LINE_TO:
              null !== b ? b.points.push(new r(p[++C], p[++C], v)) : (b = new o(p[++C], p[++C], v), S.push(b));
              break;

            case n.MOVE_TO:
              b = new o(p[++C], p[++C], v), S.push(b);
              break;
            ...
            case n.TRANSLATE:
              F = p[++C], I = p[++C], f.translate(F, I);
              break;

            case n.SCALE:
              F = p[++C], I = p[++C], f.scale(F, I);
              break;
            ...
            case n.SET_TEXTURE:
              var X = p[++C],
                  G = p[++C];
              l.currentFrame = X, l.setTexture2D(X.glTexture, 0), l.tintEffect = G, M = X.glTexture;
              break;

            case n.CLEAR_TEXTURE:
    ...
    t.exports = function (t, e, i) {
      var n = t.canvas,
          ...
          a = 0,
          h = i.length;
      r.maxLines > 0 && r.maxLines < i.length && (h = r.maxLines), r.syncFont(n, s);
    ...
    var n = i(0),
      ...
      wordWrapUseAdvanced: ["wordWrap.useAdvancedWrap", !1]
        ...
        h = new n({
      initialize: function initialize(t, e) {
        this.parent = t, this.fontFamily, this.fontSize, this.fontStyle, this.backgroundColor, this.color, this.stroke, this.strokeThickness, this.shadowOffsetX, this.shadowOffsetY, this.shadowColor, this.shadowBlur, this.shadowStroke, this.shadowFill, this.align, this.maxLines, this.fixedWidth, this.fixedHeight, this.resolution, this.rtl, this.testString, this.baselineX, this.baselineY, this._font, this.setStyle(e, !1, !0);
        var i = r(e, "metrics", !1);
        this.metrics = i ? {
          ascent: r(i, "ascent", 0),
      ...
      setStyle: function setStyle(t, e, i) {
        for (var n in void 0 === e && (e = !0), void 0 === i && (i = !1), t && t.hasOwnProperty("fontSize") && "number" == typeof t.fontSize && (t.fontSize = t.fontSize.toString() + "px"), a) {
          ...
          this[n] = "wordWrapCallback" === n || "wordWrapCallbackScope" === n ? r(t, a[n][0], o) : s(t, a[n][0], o);
        }
      ...
      syncStyle: function syncStyle(t, e) {
      ...
      setFont: function setFont(t, e) {
        void 0 === e && (e = !0);
        var i = t,
            n = "",
            s = "";
        if ("string" != typeof t) i = r(t, "fontFamily", "Courier"), n = r(t, "fontSize", "16px"), s = r(t, "fontStyle", "");else {
          var o = t.split(" "),
              a = 0;
          s = o.length > 2 ? o[a++] : "", n = o[a++] || "16px", i = o[a++] || "Courier";
        }
        return i === this.fontFamily && n === this.fontSize && s === this.fontStyle || (this.fontFamily = i, this.fontSize = n, this.fontStyle = s, e && this.update(!0)), this.parent;
      },
      setFontFamily: function setFontFamily(t) {
      ...
      setTestString: function setTestString(t) {
    ...
    t.exports = function (t) {
      ...
      var s = Math.ceil(i.measureText(t.testString).width * t.baselineX),
          r = s,
          o = 2 * r;
      r = r * t.baselineY | 0, e.width = s, e.height = o, i.fillStyle = "#f00", i.fillRect(0, 0, s, o), i.font = t._font, i.textBaseline = "alphabetic", i.fillStyle = "#000", i.fillText(t.testString, 0, r);
      var a = {
        ascent: 0,
        descent: 0,
        fontSize: 0
      };
      if (!i.getImageData(0, 0, s, o)) return a.ascent = r, a.descent = r + 6, a.fontSize = a.ascent + a.descent, n.remove(e), a;
      var h,
          u,
          l = i.getImageData(0, 0, s, o).data,
          c = l.length,
          d = 4 * s,
          f = 0,
          p = !1;
      ...
      for (a.ascent = r - h, f = c - d, p = !1, h = o; h > r; h--) {
        for (u = 0; u < d; u += 4) {
          if (255 !== l[f + u]) {
            p = !0;
            break;
      ...
      return a.descent = h - r, a.fontSize = a.ascent + a.descent, n.remove(e), a;
    };
  }, function (t, e, i) {
    var n = i(117);
    i(43).register("blitter", function (t, e, i, s) {
      return this.displayList.add(new n(this.scene, t, e, i, s));
    });
  }, function (t, e, i) {
    var n = i(118);
    i(43).register("graphics", function (t) {
      return this.displayList.add(new n(this.scene, t));
    });
  }, function (t, e, i) {
    var n = i(80);
    i(43).register("image", function (t, e, i, s) {
      return this.displayList.add(new n(this.scene, t, e, i, s));
    });
  }, function (t, e, i) {
    var n = i(43),
    ...
    var n = i(120);
    i(43).register("text", function (t, e, i, s) {
      return this.displayList.add(new n(this.scene, t, e, i, s));
    });
  }, function (t, e, i) {
    var n = i(117),
    ...
    var n = i(107),
        s = i(16),
        r = {
      CreateInteractiveObject: i(279),
      Events: i(35),
      Gamepad: i(797),
      InputManager: i(242),
      InputPlugin: i(809),
      InputPluginCache: i(81),
      Keyboard: i(814),
      Mouse: i(831),
      Pointer: i(245),
      Touch: i(832)
    ...
    var n = i(0),
      ...
      startListeners: function startListeners() {
        var t = this,
            e = this.target,
            i = function i(e) {
          !e.defaultPrevented && t.isActive() && (t.refreshPads(), t.queue.push(e));
        };

        this.onGamepadHandler = i, e.addEventListener("gamepadconnected", i, !1), e.addEventListener("gamepaddisconnected", i, !1), this.sceneInputPlugin.pluginEvents.on(u.UPDATE, this.update, this);
      },
      stopListeners: function stopListeners() {
      ...
      disconnectAll: function disconnectAll() {
        for (var t = 0; t < this.gamepads.length; t++) {
          this.gamepads.connected = !1;
        }
      },
      refreshPads: function refreshPads() {
        var t = navigator.getGamepads();
        if (t) for (var e = this.gamepads, i = 0; i < t.length; i++) {
          var n = t[i];
          ...
          if (n) {
            var s = n.id,
                r = n.index,
                a = e[r];
            if (a) a.id !== s ? (a.destroy(), e[r] = new o(this, n)) : a.update(n);else {
              var h = new o(this, n);
              e[r] = h, this._pad1 ? this._pad2 ? this._pad3 ? this._pad4 || (this._pad4 = h) : this._pad3 = h : this._pad2 = h : this._pad1 = h;
            }
          }
        } else this.disconnectAll();
      },
      getAll: function getAll() {
        for (var t = [], e = this.gamepads, i = 0; i < e.length; i++) {
          e[i] && t.push(e[i]);
        }

        return t;
      },
      getPad: function getPad(t) {
      ...
      update: function update() {
        if (this.enabled) {
          ...
          if (0 !== t) for (var e = this.queue.splice(0, t), i = 0; i < t; i++) {
            var n = e[i],
      ...
      destroy: function destroy() {
        ...
        for (var t = 0; t < this.gamepads.length; t++) {
          this.gamepads[t] && this.gamepads[t].destroy();
        }
    ...
    var n = i(87),
      ...
      onGameOver: function onGameOver(t) {
        this.isActive() && this.emit(d.GAME_OVER, t.timeStamp, t);
      },
      onGameOut: function onGameOut(t) {
      ...
      preUpdate: function preUpdate() {
        ...
        if (0 !== i || 0 !== n) {
          for (var s = this._list, r = 0; r < i; r++) {
            var o = t[r],
                a = s.indexOf(o);
            a > -1 && (s.splice(a, 1), this.clear(o, !0));
          }
      ...
      updatePoll: function updatePoll(t, e) {
        if (!this.isActive()) return !1;
        if (this.pluginEvents.emit(d.UPDATE, t, e), this._updatedThisFrame) return this._updatedThisFrame = !1, !1;
        var i,
            n = this.manager,
            s = n.pointers,
            r = n.pointersTotal;
        ...
        for (i = 0; i < r; i++) {
          var h = 0,
              u = s[i];
          this._tempZones = [], this._temp = this.hitTestPointer(u), this.sortGameObjects(this._temp), this.sortGameObjects(this._tempZones), this.topOnly && (this._temp.length && this._temp.splice(1), this._tempZones.length && this._tempZones.splice(1)), h += this.processOverOutEvents(u), 2 === this.getDragState(u) && this.processDragThresholdEvent(u, t), h > 0 && (a = !0);
        }
      ...
      clear: function clear(t, e) {
        ...
        if (i) {
          ...
          return n > -1 && this._draggable.splice(n, 1), (n = this._drag[0].indexOf(t)) > -1 && this._drag[0].splice(n, 1), (n = this._over[0].indexOf(t)) > -1 && this._over[0].splice(n, 1), t;
        }
      },
      disable: function disable(t) {
        t.input.enabled = !1;
      },
      enable: function enable(t, e, i, n) {
        return void 0 === n && (n = !1), t.input ? t.input.enabled = !0 : this.setHitArea(t, e, i), t.input && n && !t.input.dropZone && (t.input.dropZone = n), this;
      },
      hitTestPointer: function hitTestPointer(t) {
        for (var e = this.cameras.getCamerasBelowPointer(t), i = 0; i < e.length; i++) {
          ...
          if (s.length > 0) return t.camera = n, s;
        }

        return t.camera = e[0], [];
      },
      processDownEvents: function processDownEvents(t) {
        var e = 0,
            i = this._temp,
            n = this._eventData,
            s = this._eventContainer;
        n.cancelled = !1;
      ...
      getDragState: function getDragState(t) {
        return this._dragState[t.id];
      },
      setDragState: function setDragState(t, e) {
        this._dragState[t.id] = e;
      },
      processDragThresholdEvent: function processDragThresholdEvent(t, e) {
        var i = !1,
            n = this.dragTimeThreshold,
            s = this.dragDistanceThreshold;
        if (s > 0 && u(t.x, t.y, t.downX, t.downY) >= s ? i = !0 : n > 0 && e >= t.downTime + n && (i = !0), i) return this.setDragState(t, 3), this.processDragStartList(t);
      },
      processDragStartList: function processDragStartList(t) {
        if (3 !== this.getDragState(t)) return 0;

        for (var e = this._drag[t.id], i = 0; i < e.length; i++) {
          var n = e[i],
              s = n.input;
          s.dragState = 2, s.dragStartX = n.x, s.dragStartY = n.y, s.dragStartXGlobal = t.x, s.dragStartYGlobal = t.y, s.dragX = s.dragStartXGlobal - s.dragStartX, s.dragY = s.dragStartYGlobal - s.dragStartY, n.emit(d.GAMEOBJECT_DRAG_START, t, s.dragX, s.dragY), this.emit(d.DRAG_START, t, n);
        }

        return this.setDragState(t, 4), e.length;
      },
      processDragDownEvent: function processDragDownEvent(t) {
        var e = this._temp;
        ...
        return 0 === i.length ? (this.setDragState(t, 0), 0) : (i.length > 1 && (this.sortGameObjects(i), this.topOnly && i.splice(1)), this._drag[t.id] = i, 0 === this.dragDistanceThreshold && 0 === this.dragTimeThreshold ? (this.setDragState(t, 3), this.processDragStartList(t)) : (this.setDragState(t, 2), 0));
      },
      processDragMoveEvent: function processDragMoveEvent(t) {
        ...
        for (var e = this._tempZones, i = this._drag[t.id], n = 0; n < i.length; n++) {
          ...
          if (h) {
            var u = e.indexOf(h);
            0 === u ? (o.emit(d.GAMEOBJECT_DRAG_OVER, t, h), this.emit(d.DRAG_OVER, t, o, h)) : u > 0 ? (o.emit(d.GAMEOBJECT_DRAG_LEAVE, t, h), this.emit(d.DRAG_LEAVE, t, o, h), a.target = e[0], h = a.target, o.emit(d.GAMEOBJECT_DRAG_ENTER, t, h), this.emit(d.DRAG_ENTER, t, o, h)) : (o.emit(d.GAMEOBJECT_DRAG_LEAVE, t, h), this.emit(d.DRAG_LEAVE, t, o, h), e[0] ? (a.target = e[0], h = a.target, o.emit(d.GAMEOBJECT_DRAG_ENTER, t, h), this.emit(d.DRAG_ENTER, t, o, h)) : a.target = null);
          } else !h && e[0] && (a.target = e[0], h = a.target, o.emit(d.GAMEOBJECT_DRAG_ENTER, t, h), this.emit(d.DRAG_ENTER, t, o, h));

          if (o.parentContainer) {
            var l = t.x - a.dragStartXGlobal,
                c = t.y - a.dragStartYGlobal,
                f = o.getParentRotation(),
                p = l * Math.cos(f) + c * Math.sin(f),
                g = c * Math.cos(f) - l * Math.sin(f);
            p *= 1 / o.parentContainer.scaleX, g *= 1 / o.parentContainer.scaleY, s = p + a.dragStartX, r = g + a.dragStartY;
          } else s = t.x - a.dragX, r = t.y - a.dragY;

          o.emit(d.GAMEOBJECT_DRAG, t, s, r), this.emit(d.DRAG, t, o, s, r);
        }

        return i.length;
      },
      processDragUpEvent: function processDragUpEvent(t) {
        for (var e = this._drag[t.id], i = 0; i < e.length; i++) {
          var n = e[i],
              s = n.input;

          if (s && 2 === s.dragState) {
            s.dragState = 0, s.dragX = s.localX - n.displayOriginX, s.dragY = s.localY - n.displayOriginY;
            var r = !1,
                o = s.target;
            o && (n.emit(d.GAMEOBJECT_DROP, t, o), this.emit(d.DROP, t, n, o), s.target = null, r = !0), n.input && (n.emit(d.GAMEOBJECT_DRAG_END, t, s.dragX, s.dragY, r), this.emit(d.DRAG_END, t, n, r));
          }
        }

        return this.setDragState(t, 0), e.splice(0), 0;
      },
      processMoveEvents: function processMoveEvents(t) {
        var e = 0,
            i = this._temp,
            n = this._eventData,
            s = this._eventContainer;
      ...
      processWheelEvent: function processWheelEvent(t) {
        var e = 0,
            i = this._temp,
            n = this._eventData,
            s = this._eventContainer;
        ...
        for (var r = !1, o = t.deltaX, a = t.deltaY, h = t.deltaZ, u = 0; u < i.length; u++) {
          var l = i[u];
      ...
      processOverEvents: function processOverEvents(t) {
        var e = this._temp,
            i = 0,
            n = e.length,
            s = [];
      ...
      processOutEvents: function processOutEvents(t) {
      ...
      processOverOutEvents: function processOverOutEvents(t) {
        var e,
            i,
            n = this._temp,
            s = [],
        ...
        for (e = 0; e < a.length; e++) {
          i = a[e], -1 === n.indexOf(i) && -1 === h.indexOf(i) ? s.push(i) : o.push(i);
        }

        for (e = 0; e < n.length; e++) {
          i = n[e], -1 === a.indexOf(i) && r.push(i);
        }
        ...
        if (l > 0) {
          for (this.sortGameObjects(s), e = 0; e < l; e++) {
            if ((i = s[e]).input) {
              if (u.resetCursor(i.input), i.emit(d.GAMEOBJECT_POINTER_OUT, t, p), c++, f.cancelled || !i.input) {
                g = !0;
                break;
              }

              if (this.emit(d.GAMEOBJECT_OUT, t, i, p), f.cancelled || !i.input) {
                g = !0;
                break;
              }
            }
          ...
          g || this.emit(d.POINTER_OUT, t, s);
        }

        if (l = r.length, f.cancelled = !1, g = !1, l > 0) {
          for (this.sortGameObjects(r), e = 0; e < l; e++) {
            if ((i = r[e]).input) {
              if (u.setCursor(i.input), i.emit(d.GAMEOBJECT_POINTER_OVER, t, i.input.localX, i.input.localY, p), c++, f.cancelled || !i.input) {
                g = !0;
                break;
              }

              if (this.emit(d.GAMEOBJECT_OVER, t, i, p), f.cancelled || !i.input) {
                g = !0;
                break;
              }
            }
          ...
          g || this.emit(d.POINTER_OVER, t, r);
        }

        return a = o.concat(r), this._over[t.id] = this.sortGameObjects(a), c;
      },
      processUpEvents: function processUpEvents(t) {
        var e = this._temp,
            i = this._eventData,
      ...
      setDraggable: function setDraggable(t, e) {
        ...
        for (var i = 0; i < t.length; i++) {
          ...
          e && -1 === s ? this._draggable.push(n) : !e && s > -1 && this._draggable.splice(s, 1);
        }

        return this;
      },
      makePixelPerfect: function makePixelPerfect(t) {
        void 0 === t && (t = 1);
        var e = this.systems.textures;
        return h(e, t);
      },
      setHitArea: function setHitArea(t, e, i) {
        ...
        if (m(e)) {
          var l = e;
          e = p(l, "hitArea", null), i = p(l, "hitAreaCallback", null), n = p(l, "draggable", !1), s = p(l, "dropZone", !1), r = p(l, "cursor", !1), o = p(l, "useHandCursor", !1), h = p(l, "pixelPerfect", !1);
          var c = p(l, "alphaTolerance", 1);
          h && (e = {}, i = this.makePixelPerfect(c)), e && i || (this.setHitAreaFromTexture(t), u = !1);
        } else "function" != typeof e || i || (i = e, e = {});

        for (var d = 0; d < t.length; d++) {
          var f = t[d];
          if (h && "Container" === f.type) console.warn("Cannot pixelPerfect test a Container. Use a custom callback.");else {
            var g = f.input ? f.input : a(f, e, i);
            g.customHitArea = u, g.dropZone = s, g.cursor = o ? "pointer" : r, f.input = g, n && this.setDraggable(f), this.queueForInsertion(f);
          }
        }

        return this;
      },
      setHitAreaCircle: function setHitAreaCircle(t, e, i, r, o) {
        void 0 === o && (o = s);
        var a = new n(e, i, r);
        return this.setHitArea(t, a, o);
      },
      setHitAreaEllipse: function setHitAreaEllipse(t, e, i, n, s, r) {
        void 0 === r && (r = c);
        var o = new l(e, i, n, s);
        return this.setHitArea(t, o, r);
      },
      setHitAreaFromTexture: function setHitAreaFromTexture(t, e) {
      ...
      setHitAreaRectangle: function setHitAreaRectangle(t, e, i, n, s, r) {
        void 0 === r && (r = T);
        var o = new x(e, i, n, s);
        return this.setHitArea(t, o, r);
      },
      setHitAreaTriangle: function setHitAreaTriangle(t, e, i, n, s, r, o, a) {
        void 0 === a && (a = S);
        var h = new E(e, i, n, s, r, o);
        return this.setHitArea(t, h, a);
      },
      enableDebug: function enableDebug(t, e) {
        void 0 === e && (e = 65280);
        var i = t.input;
        ...
        return r && (r.isFilled = !1, r.preUpdate = function () {
          r.setStrokeStyle(1 / t.scale, e), r.setDisplayOrigin(t.displayOriginX, t.displayOriginY), r.setRotation(t.rotation), r.setScale(t.scaleX, t.scaleY), r.setPosition(t.x + h, t.y + u), r.setScrollFactor(t.scrollFactorX, t.scrollFactorY);
        }, a.add(r), i.hitAreaDebug = r), this;
      },
      removeDebug: function removeDebug(t) {
        var e = t.input;

        if (e && e.hitAreaDebug) {
          var i = e.hitAreaDebug;
          this.systems.updateList.remove(i), i.destroy(), e.hitAreaDebug = null;
        }
      ...
      setPollRate: function setPollRate(t) {
        return this.pollRate = t, this._pollTimer = 0, this;
      },
      setGlobalTopOnly: function setGlobalTopOnly(t) {
        return this.manager.globalTopOnly = t, this;
      },
      setTopOnly: function setTopOnly(t) {
      ...
      sortHandlerGO: function sortHandlerGO(t, e) {
        if (!t.parentContainer && !e.parentContainer) return this.displayList.getIndex(e) - this.displayList.getIndex(t);
      ...
      shutdown: function shutdown() {
        this.pluginEvents.emit(d.SHUTDOWN), this._temp.length = 0, this._list.length = 0, this._draggable.length = 0, this._pendingRemoval.length = 0, this._pendingInsertion.length = 0, this._dragState.length = 0;
    ...
    y.register("InputPlugin", _, "input"), t.exports = _;
  }, function (t, e) {
    t.exports = function (t, e) {
    ...
    var n = i(0),
      ...
      setTo: function setTo(t, e, i, n, s, r) {
      ...
      left: {
        ...
        set: function set(t) {
          var e = 0;
          e = this.x1 <= this.x2 && this.x1 <= this.x3 ? this.x1 - t : this.x2 <= this.x1 && this.x2 <= this.x3 ? this.x2 - t : this.x3 - t, this.x1 -= e, this.x2 -= e, this.x3 -= e;
        }
      },
      right: {
        get: function get() {
    ...
    t.exports = function (t, e, i) {
      ...
      var r = t.getLineA(),
          o = t.getLineB(),
          a = t.getLineC();
      if (e <= 0 || e >= 1) return i.x = r.x1, i.y = r.y1, i;
      var h = s(r),
          u = s(o),
          l = s(a),
          c = (h + u + l) * e,
          d = 0;
      return c < h ? (d = c / h, i.x = r.x1 + (r.x2 - r.x1) * d, i.y = r.y1 + (r.y2 - r.y1) * d) : c > h + u ? (d = (c -= h + u) / l, i.x = a.x1 + (a.x2 - a.x1) * d, i.y = a.y1 + (a.y2 - a.y1) * d) : (d = (c -= h) / u, i.x = o.x1 + (o.x2 - o.x1) * d, i.y = o.y1 + (o.y2 - o.y1) * d), i;
    };
  }, function (t, e, i) {
    var n = i(90),
        s = i(13);
    ...
    t.exports = function (t, e, i, r) {
      ...
      for (var f = 0; f < e; f++) {
        var p = d * (f / e),
            g = 0,
            v = new s();
        p < u ? (g = p / u, v.x = o.x1 + (o.x2 - o.x1) * g, v.y = o.y1 + (o.y2 - o.y1) * g) : p > u + l ? (g = (p -= u + l) / c, v.x = h.x1 + (h.x2 - h.x1) * g, v.y = h.y1 + (h.y2 - h.y1) * g) : (g = (p -= u) / l, v.x = a.x1 + (a.x2 - a.x1) * g, v.y = a.y1 + (a.y2 - a.y1) * g), r.push(v);
      }
    ...
    t.exports = {
      Events: i(82),
      KeyboardManager: i(243),
      KeyboardPlugin: i(822),
      Key: i(284),
      KeyCodes: i(74),
      KeyCombo: i(285),
      JustDown: i(827),
    ...
    var n = i(0),
      ...
      addKeys: function addKeys(t, e, i) {
        ...
        if ("string" == typeof t) {
          ...
          n[o] = this.addKey(t[o], e, i);
        }

        return n;
      },
      addKey: function addKey(t, e, i) {
        void 0 === e && (e = !0), void 0 === i && (i = !1);
        var n = this.keys;

        if (t instanceof l) {
          var s = n.indexOf(t);
          return s > -1 ? n[s] = t : n[t.keyCode] = t, e && this.addCapture(t.keyCode), t.setEmitOnRepeat(i), t;
        }

        return "string" == typeof t && (t = c[t.toUpperCase()]), n[t] || (n[t] = new l(this, t), e && this.addCapture(t), n[t].setEmitOnRepeat(i)), n[t];
      },
      removeKey: function removeKey(t, e) {
        void 0 === e && (e = !1);
        var i,
            n = this.keys;
        ...
        if (t instanceof l) {
          var s = n.indexOf(t);
          s > -1 && (i = this.keys[s], this.keys[s] = void 0);
        } else "string" == typeof t && (t = c[t.toUpperCase()]);

        return n[t] && (i = n[t], n[t] = void 0), i && (i.plugin = null, e && i.destroy()), this;
      },
      createCombo: function createCombo(t, e) {
        return new d(this, t, e);
      },
      checkDown: function checkDown(t, e) {
        if (this.enabled && t.isDown) {
      ...
      update: function update() {
        var t = this.manager.queue,
            e = t.length;
        if (this.isActive() && 0 !== e) for (var i = this.keys, n = 0; n < e; n++) {
          var s = t[n],
              o = s.keyCode,
              a = i[o],
              h = !1;
      ...
      resetKeys: function resetKeys() {
        for (var t = this.keys, e = 0; e < t.length; e++) {
          t[e] && t[e].reset();
        }
    ...
    t.exports = function (t, e) {
      ...
      var i = !1,
          s = !1;
      if (t.keyCode === e.current) if (e.index > 0 && e.maxKeyDelay > 0) {
        var r = e.timeLastMatched + e.maxKeyDelay;
        t.timeStamp <= r && (s = !0, i = n(t, e));
      } else s = !0, i = n(t, e);
      return !s && e.resetOnWrongKey && (e.index = 0, e.current = e.keyCodes[0]), i && (e.timeLastMatched = t.timeStamp, e.matched = !0, e.timeMatched = t.timeStamp), i;
    };
  }, function (t, e) {
    t.exports = function (t, e) {
    ...
    t.exports = function (t) {
      return !!t._justDown && (t._justDown = !1, !0);
    };
  }, function (t, e) {
    t.exports = function (t) {
      return !!t._justUp && (t._justUp = !1, !0);
    };
  }, function (t, e) {
    t.exports = function (t, e) {
      void 0 === e && (e = 50);
    ...
    var n = i(8),
      ...
      FileTypes: i(834),
      File: i(9),
      FileTypesManager: i(3),
      GetURL: i(83),
      LoaderPlugin: i(860),
      MergeXHRSettings: i(122),
      MultiFile: i(38),
      XHRLoader: i(286),
      XHRSettings: i(84)
    };
    ...
    t.exports = {
      AnimationJSONFile: i(835),
      AtlasJSONFile: i(836),
      AtlasXMLFile: i(837),
      AudioFile: i(287),
      AudioSpriteFile: i(839),
      BinaryFile: i(840),
      BitmapFontFile: i(841),
      CSSFile: i(843),
      GLSLFile: i(844),
      HTML5AudioFile: i(288),
      HTMLFile: i(845),
      HTMLTextureFile: i(846),
      ImageFile: i(46),
      JSONFile: i(37),
      MultiAtlasFile: i(847),
      MultiScriptFile: i(848),
      PackFile: i(849),
      PluginFile: i(850),
      SceneFile: i(851),
      ScenePluginFile: i(852),
      ScriptFile: i(289),
      SpriteSheetFile: i(853),
      SVGFile: i(854),
      TextFile: i(290),
      TilemapCSVFile: i(855),
      TilemapImpactFile: i(856),
      TilemapJSONFile: i(857),
      UnityAtlasFile: i(858),
      VideoFile: i(859),
      XMLFile: i(123)
    };
  }, function (t, e, i) {
    var n = i(0),
      ...
      onLoadComplete: function onLoadComplete() {
        this.loader.systems.anims.fromJSON(this.data), this.pendingDestroy();
      }
    });
    s.register("animation", function (t, e, i, n) {
      if (Array.isArray(t)) for (var s = 0; s < t.length; s++) {
        this.addFile(new a(this, t[s]));
    ...
    var n = i(0),
        ...
        l = new n({
      Extends: u,
      initialize: function initialize(t, e, i, n, s, l) {
        var c, d;
        ...
        if (a(e)) {
          ...
          e = r(f, "key"), c = new o(t, {
            key: e,
            url: r(f, "textureURL"),
            extension: r(f, "textureExtension", "png"),
            normalMap: r(f, "normalMap"),
            xhrSettings: r(f, "textureXhrSettings")
          }), d = new h(t, {
            key: e,
            url: r(f, "atlasURL"),
            extension: r(f, "atlasExtension", "json"),
            xhrSettings: r(f, "atlasXhrSettings")
          });
        } else c = new o(t, e, i, s), d = new h(t, e, n, l);

        c.linkFile ? u.call(this, t, "atlasjson", e, [c, d, c.linkFile]) : u.call(this, t, "atlasjson", e, [c, d]);
      },
      addToCache: function addToCache() {
    ...
    s.register("atlas", function (t, e, i, n, s) {
      ...
      if (Array.isArray(t)) for (var o = 0; o < t.length; o++) {
        r = new l(this, t[o]), this.addFile(r.files);
      ...
      initialize: function initialize(t, e, i, n, s, l) {
        ...
        if (a(e)) {
          ...
          e = r(f, "key"), c = new o(t, {
            ...
            key: e,
            url: r(f, "atlasURL"),
            extension: r(f, "atlasExtension", "xml"),
            xhrSettings: r(f, "atlasXhrSettings")
          });
        } else c = new o(t, e, i, s), d = new u(t, e, n, l);

        c.linkFile ? h.call(this, t, "atlasxml", e, [c, d, c.linkFile]) : h.call(this, t, "atlasxml", e, [c, d]);
      },
      addToCache: function addToCache() {
        if (this.isReadyToProcess()) {
          var t = this.files[0],
              e = this.files[1],
              i = this.files[2] ? this.files[2].data : null;
          this.loader.textureManager.addAtlasXML(t.key, t.data, e.data, i), e.addToCache(), this.complete = !0;
        }
      }
    });
    ...
    var n = i(287),
        ...
        l = new s({
      Extends: u,
      initialize: function initialize(t, e, i, s, r, l, c) {
        if (a(e)) {
          var d = e;
          e = o(d, "key"), i = o(d, "jsonURL"), s = o(d, "audioURL"), r = o(d, "audioConfig"), l = o(d, "audioXhrSettings"), c = o(d, "jsonXhrSettings");
        }

        var f;

        if (s) {
          var p = n.create(t, e, s, r, l);
          p && (f = new h(t, e, i, c), u.call(this, t, "audiosprite", e, [p, f]), this.config.resourceLoad = !1);
        } else f = new h(t, e, i, c), u.call(this, t, "audiosprite", e, [f]), this.config.resourceLoad = !0, this.config.audioConfig = r, this.config.audioXhrSettings = l;
      },
      onFileComplete: function onFileComplete(t) {
        if (-1 !== this.files.indexOf(t) && (this.pending--, this.config.resourceLoad && "json" === t.type && t.data.hasOwnProperty("resources"))) {
          var e = t.data.resources,
              i = o(this.config, "audioConfig"),
              s = o(this.config, "audioXhrSettings"),
              r = n.create(this.loader, t.key, e, i, s);
          r && (this.addToMultiFile(r), this.loader.addFile(r));
        }
      },
      addToCache: function addToCache() {
        if (this.isReadyToProcess()) {
    ...
    r.register("audioSprite", function (t, e, i, n, s, r) {
      ...
      if (Array.isArray(t)) for (var c = 0; c < t.length; c++) {
        (o = new l(this, t[c])).files && this.addFile(o.files);
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e, i, n, s) {
        ...
        if (h(e)) {
          var u = e;
          e = a(u, "key"), i = a(u, "url"), n = a(u, "xhrSettings"), o = a(u, "extension", o), s = a(u, "dataType", s);
        }
    ...
    var n = i(0),
        ...
        c = new n({
      Extends: h,
      initialize: function initialize(t, e, i, n, s, u) {
        var c, d;
        ...
        if (a(e)) {
          ...
          e = r(f, "key"), c = new o(t, {
            ...
            key: e,
            url: r(f, "fontDataURL"),
            extension: r(f, "fontDataExtension", "xml"),
            xhrSettings: r(f, "fontDataXhrSettings")
          });
        } else c = new o(t, e, i, s), d = new l(t, e, n, u);

        c.linkFile ? h.call(this, t, "bitmapfont", e, [c, d, c.linkFile]) : h.call(this, t, "bitmapfont", e, [c, d]);
      },
      addToCache: function addToCache() {
        if (this.isReadyToProcess()) {
          var t = this.files[0],
              e = this.files[1];
          t.addToCache(), e.addToCache(), this.loader.cacheManager.bitmapFont.add(t.key, {
            data: u(e.data),
            texture: t.key,
            frame: null
          }), this.complete = !0;
    ...
    s.register("bitmapFont", function (t, e, i, n, s) {
      var r;
      if (Array.isArray(t)) for (var o = 0; o < t.length; o++) {
        r = new c(this, t[o]), this.addFile(r.files);
    ...
    t.exports = function (t, e, n, s) {
      ...
      if (u && 0 !== l && 0 !== c) for (var x in r.chars) {
        var T = r.chars[x];
        T.x -= s.x, T.y -= s.y;
      }
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e, i, n, s) {
        ...
        if (h(e)) {
          var u = e;
          e = a(u, "key"), i = a(u, "url"), n = a(u, "shaderType", "fragment"), s = a(u, "xhrSettings"), o = a(u, "extension", o);
        } else void 0 === n && (n = "fragment");
      ...
      addToCache: function addToCache() {
        ...
        if (e) for (; e;) {
          var i = this.getShaderName(e.header),
              n = this.getShaderType(e.header),
              s = this.getShaderUniforms(e.header),
              r = e.shader;

          if (this.cache.has(i)) {
            var o = this.cache.get(i);
            "fragment" === n ? o.fragmentSrc = r : o.vertexSrc = r, o.uniforms || (o.uniforms = s);
          } else "fragment" === n ? this.cache.add(i, new u(i, r, "", s)) : this.cache.add(i, new u(i, "", r, s));
      ...
      getShaderName: function getShaderName(t) {
        for (var e = 0; e < t.length; e++) {
          var i = t[e].trim();
      ...
      getShaderType: function getShaderType(t) {
        for (var e = 0; e < t.length; e++) {
          var i = t[e].trim();
      ...
      getShaderUniforms: function getShaderUniforms(t) {
      ...
      extractBlock: function extractBlock(t, e) {
    ...
    var n = i(0),
        ...
        u = new n({
      Extends: r,
      initialize: function initialize(t, e, i, n, s, o) {
        void 0 === n && (n = 512), void 0 === s && (s = 512);
        var u = "html";

        if (h(e)) {
          var l = e;
          e = a(l, "key"), i = a(l, "url"), o = a(l, "xhrSettings"), u = a(l, "extension", u), n = a(l, "width", n), s = a(l, "height", s);
        }
    ...
    var n = i(0),
        ...
        l = new n({
      Extends: u,
      initialize: function initialize(t, e, i, n, s, o, l) {
        if (a(e)) {
          var c = e;
          e = r(c, "key"), i = r(c, "url", !1) ? r(c, "url") : r(c, "atlasURL"), o = r(c, "xhrSettings"), n = r(c, "path"), s = r(c, "baseURL"), l = r(c, "textureXhrSettings");
        }
      ...
      onFileComplete: function onFileComplete(t) {
        if (-1 !== this.files.indexOf(t) && (this.pending--, "json" === t.type && t.data.hasOwnProperty("textures"))) {
          ...
          for (var f = 0; f < e.length; f++) {
            ...
            if (this.addToMultiFile(v), n.addFile(v), e[f].normalMap) {
              var m = new o(n, g, e[f].normalMap, d);
              m.type = "normalMap", v.setLink(m), this.addToMultiFile(m), n.addFile(m);
            }
          }
      ...
      addToCache: function addToCache() {
        if (this.isReadyToProcess()) {
          for (var t = this.files[0], e = [], i = [], n = [], s = 1; s < this.files.length; s++) {
            var r = this.files[s];
            if ("normalMap" !== r.type) for (var o = r.key.indexOf("_"), a = r.key.substr(o + 1), h = r.data, u = 0; u < t.data.textures.length; u++) {
          ...
          for (0 === n.length && (n = void 0), this.loader.textureManager.addAtlasJSONArray(this.key, i, e, n), this.complete = !0, s = 0; s < this.files.length; s++) {
            this.files[s].pendingDestroy();
          }
        }
      }
    });
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e, i, n) {
        ...
        if (o(e)) {
          var l = e;
          e = r(l, "key"), i = r(l, "url"), n = r(l, "xhrSettings"), s = r(l, "extension", s);
        }
    ...
    s.register("scripts", function (t, e, i) {
      var n;
      if (Array.isArray(t)) for (var s = 0; s < t.length; s++) {
        n = new u(this, t[s]), this.addFile(n.files);
    ...
    var n = i(0),
        ...
        u = new n({
      Extends: r,
      initialize: function initialize(t, e, i, n, o, u) {
        var l = "js";

        if (h(e)) {
          var c = e;
          e = a(c, "key"), i = a(c, "url"), u = a(c, "xhrSettings"), l = a(c, "extension", l), n = a(c, "start"), o = a(c, "mapping");
        }
      ...
      onProcess: function onProcess() {
        var t = this.loader.systems.plugins,
            ...
            i = a(e, "start", !1),
            n = a(e, "mapping", null);
        if (this.state === s.FILE_POPULATED) t.install(this.key, this.data, i, n);else {
          this.state = s.FILE_PROCESSING, this.data = document.createElement("script"), this.data.language = "javascript", this.data.type = "text/javascript", this.data.defer = !1, this.data.text = this.xhrLoader.responseText, document.head.appendChild(this.data);
          var r = t.install(this.key, window[this.key], i, n);
          (i || n) && (this.loader.systems[n] = r, this.loader.scene[n] = r);
        }
        this.onProcessComplete();
      }
    });
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e, i, n, o, u) {
        ...
        if (h(e)) {
          var c = e;
          e = a(c, "key"), i = a(c, "url"), u = a(c, "xhrSettings"), l = a(c, "extension", l), n = a(c, "systemKey"), o = a(c, "sceneKey");
        }
    ...
    var n = i(0),
      ...
      initialize: function initialize(t, e, i, n, s) {
        ...
        if (h(e)) {
          var u = e;
          e = a(u, "key"), i = a(u, "url"), n = a(u, "svgConfig", {}), s = a(u, "xhrSettings"), o = a(u, "extension", o);
        }
      ...
      onProcess: function onProcess() {
        ...
        t: if (i && n || o) {
          var a = new DOMParser().parseFromString(t, "text/xml").getElementsByTagName("svg")[0],
              h = a.hasAttribute("viewBox"),
              u = parseFloat(a.getAttribute("width")),
              l = parseFloat(a.getAttribute("height"));
          if (!h && u && l) a.setAttribute("viewBox", "0  0 " + u + " " + l);else if (h && !u && !l) {
            var c = a.getAttribute("viewBox").split(/\s+|,/);
            u = c[2], l = c[3];
          }
          ...
          a.setAttribute("width", i.toString() + "px"), a.setAttribute("height", n.toString() + "px"), e = [new XMLSerializer().serializeToString(a)];
        }
      ...
      initialize: function initialize(t, e, i, n, s, l) {
        ...
        if (a(e)) {
          ...
          e = r(f, "key"), c = new o(t, {
            ...
            key: e,
            url: r(f, "atlasURL"),
            extension: r(f, "atlasExtension", "txt"),
            xhrSettings: r(f, "atlasXhrSettings")
          });
        } else c = new o(t, e, i, s), d = new u(t, e, n, l);

        c.linkFile ? h.call(this, t, "unityatlas", e, [c, d, c.linkFile]) : h.call(this, t, "unityatlas", e, [c, d]);
      },
      addToCache: function addToCache() {
        if (this.isReadyToProcess()) {
          var t = this.files[0],
              e = this.files[1],
              i = this.files[2] ? this.files[2].data : null;
          this.loader.textureManager.addUnityAtlas(t.key, t.data, e.data, i), e.addToCache(), this.complete = !0;
        }
      }
    });
    ...
    var n = i(0),
        ...
        l = new n({
      Extends: r,
      initialize: function initialize(t, e, i, n, s, o, a) {
      ...
      onProcess: function onProcess() {
        if (this.state = s.FILE_PROCESSING, this.config.asBlob) {
          var t = this.createVideoElement();
          this.data = t;
          var e = this;
          ...
          }, r.createObjectURL(t, this.xhrLoader.response, ""), t.load();
      ...
      onVideoLoadHandler: function onVideoLoadHandler(t) {
        var e = t.target;
      ...
      onVideoErrorHandler: function onVideoErrorHandler(t) {
        var e = t.target;
      ...
      load: function load() {
        var t = this.config.loadEvent;
        if (this.config.asBlob) r.prototype.load.call(this);else {
          this.percentComplete = 0;
          var e = this.createVideoElement();
          e.addEventListener(t, this.onLoadCallback, !0), e.addEventListener("error", this.onErrorCallback, !0), e.src = a(this, this.loader.baseURL), e.load();
        }
      }
    });
    l.create = function (t, e, i, n, s, r, o) {
      ...
      if (Array.isArray(t)) for (var a = 0; a < t.length; a++) {
        (o = l.create(this, t[a])) && this.addFile(o);
    ...
    var n = i(0),
      ...
      keyExists: function keyExists(t) {
        var e = t.hasCacheConflict();
        return e || this.list.iterate(function (i) {
          if (i.type === t.type && i.key === t.key) return e = !0, !1;
      ...
      addPack: function addPack(t, e) {
        ...
        return this.setBaseURL(n), this.setPath(s), this.setPrefix(r), i > 0;
      },
      ...
      update: function update() {
        this.state === s.LOADER_LOADING && this.list.size > 0 && this.inflight.size < this.maxParallelDownloads && this.checkLoadQueue();
      },
      ...
      fileProcessComplete: function fileProcessComplete(t) {
      ...
      flagForRemoval: function flagForRemoval(t) {
        this._deleteQueue.set(t);
      },
      saveJSON: function saveJSON(t, e) {
    ...
    var n = i(0),
      ...
      closest: function closest(t, e) {
        ...
        for (var i = Number.MAX_VALUE, n = null, s = t.x, r = t.y, a = e.length, h = 0; h < a; h++) {
          ...
          if (t !== u && t !== l && t !== l.gameObject && t !== l.center) {
            var c = o(s, r, l.center.x, l.center.y);
            c < i && (n = u, i = c);
          }
        }
      ...
      furthest: function furthest(t, e) {
        e || (e = this.world.bodies.entries);
      ...
      moveTo: function moveTo(t, e, i, n, s) {
        void 0 === n && (n = 60), void 0 === s && (s = 0);
        var o = Math.atan2(i - t.y, e - t.x);
        return s > 0 && (n = r(t.x, t.y, e, i) / (s / 1e3)), t.body.velocity.setToPolar(o, n), o;
      },
      moveToObject: function moveToObject(t, e, i, n) {
        return this.moveTo(t, e.x, e.y, i, n);
      },
      velocityFromAngle: function velocityFromAngle(t, e, i) {
        return void 0 === e && (e = 60), void 0 === i && (i = new p()), i.setToPolar(s(t), e);
      },
      velocityFromRotation: function velocityFromRotation(t, e, i) {
        return void 0 === e && (e = 60), void 0 === i && (i = new p()), i.setToPolar(t, e);
      },
      overlapRect: function overlapRect(t, e, i, n, s, r) {
        return c(this.world, t, e, i, n, s, r);
      },
      overlapCirc: function overlapCirc(t, e, i, n, s) {
        return l(this.world, t, e, i, n, s);
      },
      shutdown: function shutdown() {
        if (this.world) {
          var t = this.systems.events;
          t.off(f.UPDATE, this.world.update, this.world), t.off(f.POST_UPDATE, this.world.postUpdate, this.world), t.off(f.SHUTDOWN, this.shutdown, this), this.add.destroy(), this.world.destroy(), this.add = null, this.world = null;
        }
      },
      destroy: function destroy() {
    ...
    t.exports = {
      setDebug: function setDebug(t, e, i) {
    ...
    t.exports = function (t, e, i, s, r, o) {
      var a = 0,
          ...
          l = e.collideLeft,
          c = e.collideRight;
      return o || (h = !0, u = !0, l = !0, c = !0), t.deltaX() < 0 && c && t.checkCollision.left ? u && t.x < s && (a = t.x - s) < -r && (a = 0) : t.deltaX() > 0 && l && t.checkCollision.right && h && t.right > i && (a = t.right - i) > r && (a = 0), 0 !== a && (t.customSeparateX ? t.overlapX = a : n(t, a)), a;
    };
  }, function (t, e) {
    t.exports = function (t, e) {
      e < 0 ? (t.blocked.none = !1, t.blocked.left = !0) : e > 0 && (t.blocked.none = !1, t.blocked.right = !0), t.position.x -= e, 0 === t.bounce.x ? t.velocity.x = 0 : t.velocity.x = -t.velocity.x * t.bounce.x;
    };
  }, function (t, e, i) {
    var n = i(891);
    ...
    t.exports = function (t, e, i, s, r, o) {
      var a = 0,
          ...
          l = e.collideUp,
          c = e.collideDown;
      return o || (h = !0, u = !0, l = !0, c = !0), t.deltaY() < 0 && c && t.checkCollision.up ? u && t.y < s && (a = t.y - s) < -r && (a = 0) : t.deltaY() > 0 && l && t.checkCollision.down && h && t.bottom > i && (a = t.bottom - i) > r && (a = 0), 0 !== a && (t.customSeparateY ? t.overlapY = a : n(t, a)), a;
    };
  }, function (t, e) {
    t.exports = function (t, e) {
      e < 0 ? (t.blocked.none = !1, t.blocked.up = !0) : e > 0 && (t.blocked.none = !1, t.blocked.down = !0), t.position.y -= e, 0 === t.bounce.y ? t.velocity.y = 0 : t.velocity.y = -t.velocity.y * t.bounce.y;
    };
  }, function (t, e, i) {
    var n = i(300);
    ...
    t.exports = function (t, e, i, s) {
      ...
      var o = t.velocity.x,
          a = e.velocity.x;
      if (t.immovable || e.immovable) t.immovable ? (e.x += r, e.velocity.x = o - a * e.bounce.x, t.moves && (e.y += (t.y - t.prev.y) * t.friction.y)) : (t.x -= r, t.velocity.x = a - o * t.bounce.x, e.moves && (t.y += (e.y - e.prev.y) * e.friction.y));else {
        r *= .5, t.x -= r, e.x += r;
        var h = Math.sqrt(a * a * e.mass / t.mass) * (a > 0 ? 1 : -1),
            u = Math.sqrt(o * o * t.mass / e.mass) * (o > 0 ? 1 : -1),
            l = .5 * (h + u);
        h -= l, u -= l, t.velocity.x = l + h * t.bounce.x, e.velocity.x = l + u * e.bounce.x;
      }
      return !0;
    };
  }, function (t, e, i) {
    ...
    t.exports = function (t, e, i, s) {
      ...
      var o = t.velocity.y,
          a = e.velocity.y;
      if (t.immovable || e.immovable) t.immovable ? (e.y += r, e.velocity.y = o - a * e.bounce.y, t.moves && (e.x += (t.x - t.prev.x) * t.friction.x)) : (t.y -= r, t.velocity.y = a - o * t.bounce.y, e.moves && (t.x += (e.x - e.prev.x) * e.friction.x));else {
        r *= .5, t.y -= r, e.y += r;
        var h = Math.sqrt(a * a * e.mass / t.mass) * (a > 0 ? 1 : -1),
            u = Math.sqrt(o * o * t.mass / e.mass) * (o > 0 ? 1 : -1),
            l = .5 * (h + u);
        h -= l, u -= l, t.velocity.y = l + h * t.bounce.y, e.velocity.y = l + u * e.bounce.y;
      }
      return !0;
    };
  }, function (t, e, i) {
    ...
    r = n(!1, r = n(!1, r = n(!1, r = n(!1, r, s.CENTER), s.ORIENTATION), s.SCALE_MODE), s.ZOOM), t.exports = r;
  }, function (t, e, i) {
    var n = i(75),
        s = i(16),
        r = {
    ...
    var n = i(10),
      ...
      checkValidTransition: function checkValidTransition(t) {
      ...
      setActive: function setActive(t, e, i) {
        void 0 === e && (e = this.key);
        var n = this.manager.getScene(e);
        return n && n.sys.setActive(t, i), this;
      },
      setVisible: function setVisible(t, e) {
        void 0 === e && (e = this.key);
    ...
    var n = i(0),
      ...
      preUpdate: function preUpdate() {
        ...
        if (0 !== t || 0 !== e) {
          ...
          for (i = 0; i < t; i++) {
            n = this._pendingRemoval[i];

            var s = this._active.indexOf(n);

            s > -1 && this._active.splice(s, 1), n.destroy();
          }

          for (i = 0; i < e; i++) {
            n = this._pendingInsertion[i], this._active.push(n);
          }
      ...
      update: function update(t, e) {
        if (this.now = t, !this.paused) {
          ...
          for (var i = 0; i < this._active.length; i++) {
            var n = this._active[i];

            if (!n.paused && (n.elapsed += e * n.timeScale, n.elapsed >= n.delay)) {
              var s = n.elapsed - n.delay;
      ...
      shutdown: function shutdown() {
        ...
        for (t = 0; t < this._pendingInsertion.length; t++) {
    ...
    t.exports = {
      ArrayBufferToBase64: i(906),
      Base64ToArrayBuffer: i(268)
    };
  }, function (t, e) {
    var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

    t.exports = function (t, e) {
      for (var n = new Uint8Array(t), s = n.length, r = e ? "data:" + e + ";base64," : "", o = 0; o < s; o += 3) {
        r += i[n[o] >> 2], r += i[(3 & n[o]) << 4 | n[o + 1] >> 4], r += i[(15 & n[o + 1]) << 2 | n[o + 2] >> 6], r += i[63 & n[o + 2]];
      }
    ...
    t.exports = {
      Clone: i(54),
      Extend: i(16),
      GetAdvancedValue: i(36),
      GetFastValue: i(1),
      GetMinMaxValue: i(908),
      GetValue: i(4),
      HasAll: i(909),
      HasAny: i(910),
      HasValue: i(307),
    ...
    t.exports = {
      SoundManagerCreator: i(262),
      Events: i(44),
      BaseSound: i(78),
      BaseSoundManager: i(77),
      WebAudioSound: i(269),
      WebAudioSoundManager: i(267),
      HTML5AudioSound: i(264),
      HTML5AudioSoundManager: i(263),
      NoAudioSound: i(266),
      NoAudioSoundManager: i(265)
    };
  }]);
});
},{}],"assets/sounds/music/PleasantCreekLoop.mp3":[function(require,module,exports) {
module.exports = "/PleasantCreekLoop.bc2cfa30.mp3";
},{}],"assets/sounds/suelo.wav":[function(require,module,exports) {
module.exports = "/suelo.959b5c1d.wav";
},{}],"assets/sounds/suelo.mp3":[function(require,module,exports) {
module.exports = "/suelo.6fb98fa0.mp3";
},{}],"assets/sounds/gameover.mp3":[function(require,module,exports) {
module.exports = "/gameover.9cda5c07.mp3";
},{}],"assets/sounds/gameover.wav":[function(require,module,exports) {
module.exports = "/gameover.8b03799c.wav";
},{}],"assets/sounds/aleteo.wav":[function(require,module,exports) {
module.exports = "/aleteo.59ea56ad.wav";
},{}],"assets/sounds/aleteo.mp3":[function(require,module,exports) {
module.exports = "/aleteo.85274606.mp3";
},{}],"assets/sounds/punto.wav":[function(require,module,exports) {
module.exports = "/punto.b99fac2d.wav";
},{}],"assets/sounds/punto.mp3":[function(require,module,exports) {
module.exports = "/punto.652d1161.mp3";
},{}],"assets/imgs/lowres_ar133/flappy5.png":[function(require,module,exports) {
module.exports = "/flappy5.10a9692a.png";
},{}],"assets/imgs/lowres_ar133/flappy5.json":[function(require,module,exports) {
module.exports = {
  "frames": [{
    "filename": "layer1",
    "frame": {
...
},{}],"src/scenes/loadscreen.js":[function(require,module,exports) {
"use strict";
...
function (_Phaser$Scene) {
  _inherits(LoadScreen, _Phaser$Scene);

  function LoadScreen() {
    _classCallCheck(this, LoadScreen);

    return _possibleConstructorReturn(this, _getPrototypeOf(LoadScreen).call(this, 'loadScreen'));
  }
  ...
  _createClass(LoadScreen, [{
    ...
    value: function preload() {
      ...
      t.load.on('progress', this.updateLoad, this); // Load music

      t.load.audio('music', require('../../assets/sounds/music/PleasantCreekLoop.mp3')); // Load sounds
      ...
      t.load.audio('point', [require('../../assets/sounds/punto.wav'), require('../../assets/sounds/punto.mp3')]); // Load atlas

      t.load.atlas(t.gbs.key_atlas, require('../../assets/imgs/lowres_ar133/flappy5.png'), require('../../assets/imgs/lowres_ar133/flappy5.json'));
    }
  }, {
    key: "updateLoad",
    value: function updateLoad(progress) {
      document.getElementById('p_load').innerHTML = "".concat(Math.round(progress * 100), "%");
    }
  }]);
...
},{"../../assets/sounds/music/PleasantCreekLoop.mp3":"assets/sounds/music/PleasantCreekLoop.mp3","../../assets/sounds/suelo.wav":"assets/sounds/suelo.wav","../../assets/sounds/suelo.mp3":"assets/sounds/suelo.mp3","../../assets/sounds/gameover.mp3":"assets/sounds/gameover.mp3","../../assets/sounds/gameover.wav":"assets/sounds/gameover.wav","../../assets/sounds/aleteo.wav":"assets/sounds/aleteo.wav","../../assets/sounds/aleteo.mp3":"assets/sounds/aleteo.mp3","../../assets/sounds/punto.wav":"assets/sounds/punto.wav","../../assets/sounds/punto.mp3":"assets/sounds/punto.mp3","../../assets/imgs/lowres_ar133/flappy5.png":"assets/imgs/lowres_ar133/flappy5.png","../../assets/imgs/lowres_ar133/flappy5.json":"assets/imgs/lowres_ar133/flappy5.json"}],"src/prefabs/scrollinglayer.js":[function(require,module,exports) {
"use strict";
...
function () {
   ...
   */
  function ScrollingLayer(scene, speed, texture) {
    var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
        _ref$frame = _ref.frame,
        frame = _ref$frame === void 0 ? null : _ref$frame,
        _ref$y = _ref.y,
        y = _ref$y === void 0 ? null : _ref$y,
        _ref$overlap = _ref.overlap,
        overlap = _ref$overlap === void 0 ? 1 : _ref$overlap;

    _classCallCheck(this, ScrollingLayer);
  ...
  _createClass(ScrollingLayer, [{
    ...
    key: "getDistance",
    value: function getDistance(speed, deltaTime) {
      return deltaTime * speed / 1000;
    }
  }, {
    key: "setYbottom",
    value: function setYbottom() {
...
exports.default = ScrollingLayer;
},{}],"src/prefabs/helpers.js":[function(require,module,exports) {
"use strict";
...
var helpers = {
  setFlex: function setFlex(element) {
    document.getElementById(element).style.display = 'flex';
  },
  setBlock: function setBlock(element) {
    document.getElementById(element).style.display = 'block';
  },
  hide: function hide(element) {
    document.getElementById(element).style.display = 'none';
  },
  setCookie: function setCookie(c_name, c_value, c_days) {
    var d = new Date();
...
},{}],"src/scenes/ingame.js":[function(require,module,exports) {
"use strict";
...
var _scrollinglayer = _interopRequireDefault(require("../prefabs/scrollinglayer"));

var _helpers = require("../prefabs/helpers");
...
/*#__PURE__*/
function (_Phaser$Scene) {
  _inherits(InGame, _Phaser$Scene);

  function InGame() {
    _classCallCheck(this, InGame);

    return _possibleConstructorReturn(this, _getPrototypeOf(InGame).call(this, 'inGame'));
  }
  ...
  _createClass(InGame, [{
    ...
    value: function init() {
      var t = this;
      t.gbs = t.registry.get('globals'); // Game width

      t.width = t.game.config.width; // Game height

      t.height = t.game.config.height; // Game score

      t.score = 0; // True if the bird has collided
      ...
      t.birdHasScored = false; // Vertical velocity of the bird in the click event

      t.birdImpulse = -350; // Pipes with

      t.pipeWidth = t.textures.getFrame(t.gbs.key_atlas, 'tuberia').width; // Horizontal speed of pipes

      t.pipeSpeed = -180; // Horizontal space between pipes

      t.pipeDistance = 200; //Pairs of pipes

      t.pairsOfPipes = 2; // Position X for a new pair of pipes

      t.posXNewPipe = (t.pairsOfPipes - 1) * (t.pipeDistance + t.pipeWidth) + t.pipeDistance; // Initial vertical space between pipes

      t.pipesGap = Math.round(t.height * 0.409); // Height of the background sprite that represents the ground

      t.groundHeight = t.textures.getFrame(t.gbs.key_atlas, 'layer3').height; // Height of the background sprite that represents the mountains

      t.mountainsHeight = t.textures.getFrame(t.gbs.key_atlas, 'layer2').height; // For Parallax effect
    ...
    value: function create() {
      ...
      t.physics.world.bounds.height = t.game.config.height - 68; // Background music

      t.music = t.sound.add('music', {
        volume: 0.4,
        loop: true
      });
      t.music.play();
      t.music.on('stop', function () {
        t.music.play();
      }, t); // Sound Effects

      t.crash = this.sound.add('crash', {
        volume: 1
      });
      t.snd_flap = this.sound.add('flap', {
        volume: 1
      });
      t.snd_gameover = this.sound.add('gameover', {
        volume: 1
      });
      t.snd_point = this.sound.add('point', {
        volume: 1
      }); // Animations

      t.generateAnimations(); // Background

      t.add.image(0, 0, t.gbs.key_atlas, 'layer1').setOrigin(0, 0); //Mountains scrolling layer

      var mountainsY = t.game.config.height - t.groundHeight - t.mountainsHeight + 10; //t.mountains = new ScrollingLayer(t, mountainsY, t.mountainsSpeed, 2, t.gbs.key_atlas, 'layer2');

      t.mountains = new _scrollinglayer.default(t, t.mountainsSpeed, t.gbs.key_atlas, {
        frame: 'layer2',
        y: mountainsY
      }); // Pipes group

      t.pipes = t.generatePipes(); // ForeGround scrolling layer
      //t.ground = new ScrollingLayer(t, t.height - t.groundHeight, t.groundSpeed, 2, t.gbs.key_atlas, 'layer3');

      t.ground = new _scrollinglayer.default(t, t.groundSpeed, t.gbs.key_atlas, {
        frame: 'layer3'
      }); // Bird
      ...
      t.bird.setCollideWorldBounds(true, 0, 0.3); // Collider

      t.physics.add.collider(t.bird, t.pipes, t.collision, null, t); // Input events

      t.input.on('pointerdown', t.flap, t); // Shows actual scene DOM UI

      t.scoreDOM.innerHTML = '0';
      document.getElementById('inGame').style.display = 'block';
      t.physics.world.pause(); // Debug performance
    ...
    value: function update(time, delta) {
      var t = this;
      t.preUpdateBodies();
      t.physics.world.step(0.001 * delta); //Bird angle
    ...
    key: "preUpdateBodies",
    value: function preUpdateBodies() {
      var body;
      var bodies = this.physics.world.bodies.entries;
    ...
    key: "preUpdateBody",
    value: function preUpdateBody(body) {
      body.resetFlags();
      body.updateBounds();
    ...
    value: function generateAnimations() {
      var key = this.gbs.key_atlas;
      this.anims.create({
        key: 'flapping',
        frames: [{
          key: key,
    ...
    value: function generatePipes() {
      var t = this; // Pipes physics group

      var group = t.physics.add.group({
        collideWorldBounds: false,
        velocityX: t.pipeSpeed,
        gravityY: 0
      }); // Adding elements to pipes group

      for (var i = 0; i < t.pairsOfPipes; i++) {
        var ceilingPipeY = -(370 / 2 * t.height / 600) + Math.random() * 130;
        var ceilingPipeX = t.width + 50 + i * (t.pipeWidth + t.pipeDistance);
        var ceilingPipe = t.make.image({
          key: t.gbs.key_atlas,
          frame: 'tuberia',
          x: ceilingPipeX,
          y: ceilingPipeY,
        ...
        var floorPipeY = ceilingPipe.getBottomCenter().y + t.pipesGap + ceilingPipe.height / 2;
        var floorPipeX = ceilingPipeX;
        var floorPipe = t.make.image({
          key: t.gbs.key_atlas,
          frame: 'tuberia',
          x: floorPipeX,
          y: floorPipeY
    ...
    value: function flap() {
      var t = this;
      t.bird.setVelocityY(t.birdImpulse); //t.twBird.play();
    ...
    key: "checkPipes",
    value: function checkPipes() {
      var t = this;
      var ceilingPipeY;
      var floorPipeY;
      t.pipes.getChildren().forEach(function (item) {
        if (item.body.x < -t.pipeWidth) {
          var gapFactor = t.score < 41 ? 0.4043 - 0.004358 * t.score : 0.21;
          var newGap = gapFactor * t.height;
    ...
    key: "collision",
    value: function collision(bird, pipe) {
      var t = this; //If the bird has already collided before then return
    ...
    key: "checkRecord",
    value: function checkRecord() {
      var t = this;

      if (t.score > t.gbs.topScore) {
        _helpers.helpers.setCookie('best', this.score, 365);
...
},{"../prefabs/scrollinglayer":"src/prefabs/scrollinglayer.js","../prefabs/helpers":"src/prefabs/helpers.js"}],"src/scenes/menu.js":[function(require,module,exports) {
"use strict";
...
function (_Phaser$Scene) {
  ...
  _createClass(Menu, [{
    ...
    value: function init() {
      var t = this;
      t.gbs = this.registry.get('globals'); // DOM elements
    ...
    value: function create() {
      ...
      t.lyhelp.onclick = this.closeHelp; // Sky

      this.add.image(0, 0, t.gbs.key_atlas, 'layer1').setOrigin(0, 0); // Ground

      var ground = this.add.image(0, 0, t.gbs.key_atlas, 'layer3').setOrigin(0, 0);
      ground.setY(this.game.config.height - ground.height);
      this.gbs.groundHeight = ground.height; // Mountains

      var mountains = this.add.image(0, 0, t.gbs.key_atlas, 'layer2').setOrigin(0, 0);
      mountains.setY(this.game.config.height - ground.height - mountains.height + 10);
      this.gbs.mountainsHeight = mountains.height; //Global variables initialization

      this.gbs.topScore = _helpers.helpers.getCookie('best') ? parseInt(_helpers.helpers.getCookie('best')) : 0; // Hide previus DOM scene

      _helpers.helpers.hide('loading'); // Shows the DOM UI of this scene
    ...
    value: function playButton() {
      ...
      _helpers.helpers.hide('menu');

      this.scene.start('inGame');
    }
  }, {
    key: "helpButton",
    value: function helpButton() {
      _helpers.helpers.setFlex('help');
    }
  }, {
    key: "creditsButton",
    value: function creditsButton() {
      _helpers.helpers.setFlex('credits');
    }
  }, {
    key: "closeCredits",
    value: function closeCredits() {
      _helpers.helpers.hide('credits');
    }
  }, {
    key: "closeHelp",
    value: function closeHelp() {
      _helpers.helpers.hide('help');
    }
  }, {
    key: "removeListeners",
...
},{"../prefabs/helpers":"src/prefabs/helpers.js"}],"src/scenes/gameover.js":[function(require,module,exports) {
"use strict";
...
function (_Phaser$Scene) {
  ...
  _createClass(GameOver, [{
    ...
    key: "create",
    value: function create() {
      var t = this; // Game over image

      _helpers.helpers.setFlex('gameOver');
      ...
      t.input.on('pointerdown', function () {
        _helpers.helpers.hide('gameOver');
...
},{"../prefabs/helpers":"src/prefabs/helpers.js"}],"src/main.js":[function(require,module,exports) {
"use strict";

var _phaser = _interopRequireDefault(require("./libs/phaser.js"));

var _loadscreen = _interopRequireDefault(require("./scenes/loadscreen.js"));

var _ingame = _interopRequireDefault(require("./scenes/ingame.js"));

var _menu = _interopRequireDefault(require("./scenes/menu.js"));
...
function runGame(width, height) {
  var config = {
    ...
    scale: {
      mode: _phaser.default.Scale.HEIGHT_CONTROLS_WIDTH,
    ...
    scene: [_loadscreen.default, _menu.default, _ingame.default, _gameover.default]
  };
...
window.onload = function () {
  var gameWidth = 362;
  var gameHeight = 480; // Adjust height of "container divs"

  var box = document.getElementById('gamediv'); // ratio clientWidth/gameWidth

  var widthRatio = box.clientWidth / (362 * box.clientHeight / 480);

  if (document.styleSheets) {
    if (widthRatio < 0.84) {
      /* 0.84 = box.clientWidth/((362*newHeight/480)) */
      var newHeight = 480 * box.clientWidth / (0.84 * 362); // 84% of game width 

      var newTop = (box.clientHeight - newHeight) / 2;
      document.styleSheets[0].insertRule(".fullscreen, .fullscreenflex {bottom: unset; top: ".concat(newTop, "px; height: ").concat(newHeight, "px;}"), 40);
    }
  }

  runGame(gameWidth, gameHeight);
};
},{"./libs/phaser.js":"src/libs/phaser.js","./scenes/loadscreen.js":"src/scenes/loadscreen.js","./scenes/ingame.js":"src/scenes/ingame.js","./scenes/menu.js":"src/scenes/menu.js","./scenes/gameover.js":"src/scenes/gameover.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
